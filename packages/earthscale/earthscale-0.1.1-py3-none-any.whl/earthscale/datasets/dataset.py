...
class Dataset(abc.ABC):
    ...
    _DATASET_CREATION_CALLBACKS: ClassVar[list[Callable[["Dataset"], None]]] = []
    _DATASET_LOAD_CALLBACK: ClassVar[
        Callable[[str, DatasetDomain | None, str | None], "Dataset"] | None
    ] = None

    @classmethod
    def register_dataset_creation_callback(
        cls, callback: Callable[["Dataset"], None]
    ) -> None:
        cls._DATASET_CREATION_CALLBACKS.append(callback)

    @classmethod
    def register_dataset_load_callback(
        cls, callback: Callable[[str, DatasetDomain | None, str | None], "Dataset"]
    ) -> None:
...
_DATASET_CLASS_REGISTRY: dict[str, type[Dataset]] = {}
...
class _DatasetRegistry:
    ...
    def register_class(self, name: str, cls: type[Dataset]) -> None:
    ...
    def get_registry_name(self, cls: type[Dataset]) -> str:
