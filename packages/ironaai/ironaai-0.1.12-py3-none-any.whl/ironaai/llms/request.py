...
from ironaai._utils import _default_headers, convert_tool_to_openai_function
from ironaai.llms.config import LLMConfig
from ironaai.metrics.metric import Metric
from ironaai.types import ModelSelectRequestPayload
...
def model_select_prepare(
    ...
    Parameters:
        ...
        ironaai_api_key (str): API key generated via the IronaAI dashboard.
        ...
        nd_api_url (Optional[str], optional): The URL of the IronaAI API. Defaults to None.
    ...
    headers = _default_headers(ironaai_api_key, _user_agent)
...
def model_select(
    ...
    """
    This endpoint receives the prompt and routing settings, and makes a call to the IronaAI API.
    It returns the best fitting LLM to call and a session ID that can be used for feedback.
...
def report_latency(
    ...
    """
    This method makes an API call to the IronaAI server to report the latency of an LLM call.
    ...
    Parameters:
        ...
        ironaai_api_key (str): IronaAI API call used for authentication
        nd_api_url (Optional[str], optional): The URL of the IronaAI API. Defaults to None.
    Returns:
        int: status code of the API call, 200 if it's success

    Raises:
        ApiError: if the API call to the IronaAI backend fails, this error is raised
    """
