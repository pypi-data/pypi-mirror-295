...
VERSION = metadata.version("ironaai")

IRONAAI_API_KEY = os.getenv("IRONAAI_API_KEY", default="")
...
IRONAAI_API_URL = os.getenv(
    "IRONAAI_API_URL", "https://ironaai-server.onrender.com"
)
