...
from ironaai.exceptions import UnsupportedLLMProvider
...
class LLMConfig:
    """
    A IronaAI LLM provider config (or LLMConfig) is represented by a combination of provider and model.
    ...
    def from_string(cls, llm_provider: str):
        """
        We allow our users to specify LLM providers for IronaAI in the string format 'provider_name/model_name',
