...
class CeruleanThemeHook(ThemeHook):
    """
    ...
    def __init__(self) -> None:
        ThemeHook.__init__(
            ...
            html_tags={"data-theme": "cerulean"},
            css=[
                {
                    "url": "https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.3/cerulean/bootstrap.min.css",
...
def register_cerulean_hook() -> CeruleanThemeHook:
    return CeruleanThemeHook()
