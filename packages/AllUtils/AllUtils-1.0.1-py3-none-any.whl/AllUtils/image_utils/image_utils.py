...
if __name__ == '__main__':
    ...
    # 读取验证码图片
    img_path = r'D:\PycharmProjects Prefession\proj_git\py_choose_lessons-master\chooselessonassistance\cap.jpg'
    ...
    # 识别验证码
    result = pytesseract.image_to_string(Image.fromarray(binary))
