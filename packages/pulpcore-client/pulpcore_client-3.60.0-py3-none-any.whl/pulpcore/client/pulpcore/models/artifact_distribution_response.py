...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_labels=None, pulp_href=None, content_guard=None, no_content_change_since=None, name=None, base_path=None, pulp_created=None, hidden=False, base_url=None, local_vars_configuration=None):  # noqa: E501
