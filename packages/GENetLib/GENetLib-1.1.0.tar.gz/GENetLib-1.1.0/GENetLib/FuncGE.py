...
def FuncGE(y, z, location, X, ytype, btype, num_hidden_layers, nodes_hidden_layer,
    ...
    FuncGE_res = ScalerGE([y,U,z], ytype, dim_G, dim_E, False, num_hidden_layers, nodes_hidden_layer,
