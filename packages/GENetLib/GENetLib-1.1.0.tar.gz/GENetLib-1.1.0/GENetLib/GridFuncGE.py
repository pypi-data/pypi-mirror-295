...
from GENetLib.DenseToFunc import DenseToFunc
...
def GridFuncGE(y, z, location, X, ytype, btype, num_hidden_layers, nodes_hidden_layer,
    ...
    if type(X) == dict:
        ...
        funcX = DenseToFunc(location, X, btype, nbasis1, params1, Plot=False)
        if btype == "Bspline":
    ...
    GridFuncGE_res = GridScalerGE([y,U,z], ytype, dim_G, dim_E, False, num_hidden_layers, nodes_hidden_layer,
