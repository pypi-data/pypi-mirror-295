...
Fixel2ShInputSpec = specs.SpecInfo(
    name="Fixel2ShInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Fixel2ShOutputSpec = specs.SpecInfo(
    name="Fixel2ShOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Fixel2Sh(ShellCommandTask):
    ...
    executable = "fixel2sh"
    input_spec = Fixel2ShInputSpec
    output_spec = Fixel2ShOutputSpec
