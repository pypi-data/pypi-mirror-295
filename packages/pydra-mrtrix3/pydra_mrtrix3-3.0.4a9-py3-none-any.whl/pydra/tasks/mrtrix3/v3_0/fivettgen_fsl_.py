...
FivettGen_FslInputSpec = specs.SpecInfo(
    name="FivettGen_FslInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
FivettGen_FslOutputSpec = specs.SpecInfo(
    name="FivettGen_FslOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class FivettGen_Fsl(ShellCommandTask):
    ...
    input_spec = FivettGen_FslInputSpec
    output_spec = FivettGen_FslOutputSpec
