...
input_fields = [
    ...
    (
        ...
        str,
        {
            "help_string": "Provide a (space- or comma-separated) list of dwi2mask algorithms that are to be utilised",
            "argstr": "-algorithms",
        },
    ),
    (
        ...
        False,
        {
            ...
            "argstr": "-masks",
            "output_file_template": "masks.mif",
        },
    ),
    (
        "template",
...
Dwi2Mask_ConsensusInputSpec = specs.SpecInfo(
    name="Dwi2Mask_ConsensusInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Mask_ConsensusOutputSpec = specs.SpecInfo(
    name="Dwi2Mask_ConsensusOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Mask_Consensus(ShellCommandTask):
    ...
    input_spec = Dwi2Mask_ConsensusInputSpec
    output_spec = Dwi2Mask_ConsensusOutputSpec
