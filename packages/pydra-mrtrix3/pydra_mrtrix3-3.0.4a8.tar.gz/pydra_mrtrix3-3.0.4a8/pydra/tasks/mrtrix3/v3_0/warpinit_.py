...
WarpInitInputSpec = specs.SpecInfo(
    name="WarpInitInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
WarpInitOutputSpec = specs.SpecInfo(
    name="WarpInitOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
