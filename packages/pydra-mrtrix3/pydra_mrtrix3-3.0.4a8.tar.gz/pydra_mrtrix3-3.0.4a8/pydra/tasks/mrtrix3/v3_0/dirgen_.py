...
DirGenInputSpec = specs.SpecInfo(
    name="DirGenInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
DirGenOutputSpec = specs.SpecInfo(
    name="DirGenOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class DirGen(ShellCommandTask):
    ...
    executable = "dirgen"
    input_spec = DirGenInputSpec
    output_spec = DirGenOutputSpec
