...
DwiCatInputSpec = specs.SpecInfo(
    name="DwiCatInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
DwiCatOutputSpec = specs.SpecInfo(
    name="DwiCatOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class DwiCat(ShellCommandTask):
    ...
    input_spec = DwiCatInputSpec
    output_spec = DwiCatOutputSpec
    executable = "dwicat"
