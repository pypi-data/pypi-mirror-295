...
input_fields = [
    ...
    (
        ...
        False,
        {
            ...
            "argstr": "-scale",
            "output_file_template": "scale.txt",
        },
    ),
    (
        "nocleanup",
...
DwiNormalise_MtnormInputSpec = specs.SpecInfo(
    name="DwiNormalise_MtnormInput", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("out_file", ImageOut, {"help_string": "The normalised DWI series"}),
    (
        "scale",
        File,
        {
...
DwiNormalise_MtnormOutputSpec = specs.SpecInfo(
    name="DwiNormalise_MtnormOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class DwiNormalise_Mtnorm(ShellCommandTask):
    ...
    input_spec = DwiNormalise_MtnormInputSpec
    output_spec = DwiNormalise_MtnormOutputSpec
