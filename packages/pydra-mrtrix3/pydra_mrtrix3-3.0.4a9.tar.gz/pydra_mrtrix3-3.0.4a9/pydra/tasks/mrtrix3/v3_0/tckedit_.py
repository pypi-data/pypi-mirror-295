...
TckEditInputSpec = specs.SpecInfo(
    name="TckEditInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
TckEditOutputSpec = specs.SpecInfo(
    name="TckEditOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
