...
TckStatsInputSpec = specs.SpecInfo(
    name="TckStatsInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
TckStatsOutputSpec = specs.SpecInfo(
    name="TckStatsOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class TckStats(ShellCommandTask):
    ...
    executable = "tckstats"
    input_spec = TckStatsInputSpec
    output_spec = TckStatsOutputSpec
