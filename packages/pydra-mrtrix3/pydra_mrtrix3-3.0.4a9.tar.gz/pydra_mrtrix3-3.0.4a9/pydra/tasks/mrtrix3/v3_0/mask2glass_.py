...
Mask2GlassInputSpec = specs.SpecInfo(
    name="Mask2GlassInput", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("out_file", ImageOut, {"help_string": "The output glass brain image"}),
    (
        "scratch",
        Directory,
        {
...
Mask2GlassOutputSpec = specs.SpecInfo(
    name="Mask2GlassOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Mask2Glass(ShellCommandTask):
    ...
    input_spec = Mask2GlassInputSpec
    output_spec = Mask2GlassOutputSpec
