...
Dwi2Mask_TraceInputSpec = specs.SpecInfo(
    name="Dwi2Mask_TraceInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Mask_TraceOutputSpec = specs.SpecInfo(
    name="Dwi2Mask_TraceOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Mask_Trace(ShellCommandTask):
    ...
    input_spec = Dwi2Mask_TraceInputSpec
    output_spec = Dwi2Mask_TraceOutputSpec
