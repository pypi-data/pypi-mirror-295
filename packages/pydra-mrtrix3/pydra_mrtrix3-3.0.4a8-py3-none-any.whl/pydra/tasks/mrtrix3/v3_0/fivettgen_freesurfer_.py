...
FivettGen_FreesurferInputSpec = specs.SpecInfo(
    name="FivettGen_FreesurferInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
FivettGen_FreesurferOutputSpec = specs.SpecInfo(
    name="FivettGen_FreesurferOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class FivettGen_Freesurfer(ShellCommandTask):
    ...
    input_spec = FivettGen_FreesurferInputSpec
    output_spec = FivettGen_FreesurferOutputSpec
