...
Dwi2Mask_HdbetInputSpec = specs.SpecInfo(
    name="Dwi2Mask_HdbetInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Mask_HdbetOutputSpec = specs.SpecInfo(
    name="Dwi2Mask_HdbetOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Mask_Hdbet(ShellCommandTask):
    ...
    input_spec = Dwi2Mask_HdbetInputSpec
    output_spec = Dwi2Mask_HdbetOutputSpec
