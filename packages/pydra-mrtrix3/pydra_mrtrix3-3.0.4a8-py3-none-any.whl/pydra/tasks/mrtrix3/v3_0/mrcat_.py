...
MrCatInputSpec = specs.SpecInfo(
    name="MrCatInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
MrCatOutputSpec = specs.SpecInfo(
    name="MrCatOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
