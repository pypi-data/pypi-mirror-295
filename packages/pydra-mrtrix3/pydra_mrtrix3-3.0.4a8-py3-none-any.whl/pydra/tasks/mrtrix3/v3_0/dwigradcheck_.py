...
DwiGradcheckInputSpec = specs.SpecInfo(
    name="DwiGradcheckInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
DwiGradcheckOutputSpec = specs.SpecInfo(
    name="DwiGradcheckOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class DwiGradcheck(ShellCommandTask):
    ...
    output_spec = DwiGradcheckOutputSpec
