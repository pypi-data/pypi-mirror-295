...
Dwi2Mask_LegacyInputSpec = specs.SpecInfo(
    name="Dwi2Mask_LegacyInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Mask_LegacyOutputSpec = specs.SpecInfo(
    name="Dwi2Mask_LegacyOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Mask_Legacy(ShellCommandTask):
    ...
    input_spec = Dwi2Mask_LegacyInputSpec
    output_spec = Dwi2Mask_LegacyOutputSpec
