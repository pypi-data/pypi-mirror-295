...
Dwi2Response_ManualInputSpec = specs.SpecInfo(
    name="Dwi2Response_ManualInput", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("out_file", File, {"help_string": "Output response function text file"}),
    (
        "voxels",
        ImageOut,
        {"help_string": "Output an image showing the final voxel selection(s)"},
...
Dwi2Response_ManualOutputSpec = specs.SpecInfo(
    name="Dwi2Response_ManualOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Response_Manual(ShellCommandTask):
    ...
    input_spec = Dwi2Response_ManualInputSpec
    output_spec = Dwi2Response_ManualOutputSpec
