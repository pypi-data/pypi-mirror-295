...
Dwi2Mask_MeanInputSpec = specs.SpecInfo(
    name="Dwi2Mask_MeanInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Mask_MeanOutputSpec = specs.SpecInfo(
    name="Dwi2Mask_MeanOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Mask_Mean(ShellCommandTask):
    ...
    input_spec = Dwi2Mask_MeanInputSpec
    output_spec = Dwi2Mask_MeanOutputSpec
