...
FixelReorientInputSpec = specs.SpecInfo(
    name="FixelReorientInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
FixelReorientOutputSpec = specs.SpecInfo(
    name="FixelReorientOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
