...
Dwi2Response_TournierInputSpec = specs.SpecInfo(
    name="Dwi2Response_TournierInput", fields=input_fields, bases=(specs.ShellSpec,)
)
...
Dwi2Response_TournierOutputSpec = specs.SpecInfo(
    name="Dwi2Response_TournierOutput",
...
class Dwi2Response_Tournier(ShellCommandTask):
    ...
    input_spec = Dwi2Response_TournierInputSpec
    output_spec = Dwi2Response_TournierOutputSpec
