...
input_fields = [
    ...
    (
        ...
        int,
        {
            "help_string": "Maximum number of iterations (set to 0 to force convergence)",
            "argstr": "-max_iters",
        },
    ),
    (
...
Dwi2Response_TaxInputSpec = specs.SpecInfo(
    name="Dwi2Response_TaxInput", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [
    ("out_file", File, {"help_string": "The output response function text file"}),
    (
        "voxels",
        ImageOut,
        {"help_string": "Output an image showing the final voxel selection(s)"},
...
Dwi2Response_TaxOutputSpec = specs.SpecInfo(
    name="Dwi2Response_TaxOutput", fields=output_fields, bases=(specs.ShellOutSpec,)
)
...
class Dwi2Response_Tax(ShellCommandTask):
    ...
    input_spec = Dwi2Response_TaxInputSpec
    output_spec = Dwi2Response_TaxOutputSpec
