...
PYTHON_DATA_TYPES = {'ObjectID': 'esriFieldTypeOID', 'str': 'esriFieldTypeString', 'float': 'esriFieldTypeDouble', 'datetime': 'esriFieldTypeDate', 'GlobalID': 'esriFieldTypeGlobalID', 'int': 'esriFieldTypeInteger', "geometry": "esriFieldTypeGeometry"}
