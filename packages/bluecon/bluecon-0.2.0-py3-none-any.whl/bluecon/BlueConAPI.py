...
class BlueConAPI:
    ...
    def startNotificationListener(self):
        ...
        async def listener_thread(blueConAPIClient: BlueConAPI):
            ...
            await blueConAPIClient.receiver.listen(on_notification, blueConAPIClient)
        
        async def on_notification(blueConAPIClient: BlueConAPI, notification: dict, data_message):
            ...
            await blueConAPIClient.__notificationInfoStorage.storePersistentId(idstr)
