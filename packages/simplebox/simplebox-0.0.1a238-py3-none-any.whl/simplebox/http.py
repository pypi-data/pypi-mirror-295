...
class Rest(BaseRest):
    ...
    def lazy_init(self, rest: 'Rest' = None, file: str = None, server_name: str = None, host: str = None,
                  headers: dict or Serializable = None, cookies: dict or Serializable = None,
                  auth: tuple or Serializable = None, hooks: dict[str, Callable] or Serializable = None,
                  http2: bool = False, check_status: bool = False, encoding: str = "utf-8", description: str = None,
                  restful: dict or Serializable = None, retry_times: int = 10, retry_interval: int = 5,
        ...
        if isinstance(rest, Rest):
            ...
            self.__initialize(file=file, server_name=server_name, host=host, headers=headers, cookies=cookies,
                              auth=auth, hooks=hooks, check_status=check_status, encoding=encoding,
