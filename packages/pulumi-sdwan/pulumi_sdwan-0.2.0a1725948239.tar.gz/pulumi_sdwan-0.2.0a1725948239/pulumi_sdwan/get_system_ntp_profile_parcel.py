...
__all__ = [
    'GetSystemNtpProfileParcelResult',
    'AwaitableGetSystemNtpProfileParcelResult',
    'get_system_ntp_profile_parcel',
    'get_system_ntp_profile_parcel_output',
]

@pulumi.output_type
class GetSystemNtpProfileParcelResult:
    """
    ...
    def authentication_keys(self) -> Sequence['outputs.GetSystemNtpProfileParcelAuthenticationKeyResult']:
        """
    ...
    @property
    @pulumi.getter
    def servers(self) -> Sequence['outputs.GetSystemNtpProfileParcelServerResult']:
        """
...
class AwaitableGetSystemNtpProfileParcelResult(GetSystemNtpProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemNtpProfileParcelResult(
...
def get_system_ntp_profile_parcel(feature_profile_id: Optional[str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemNtpProfileParcelResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getSystemNtpProfileParcel:getSystemNtpProfileParcel', __args__, opts=opts, typ=GetSystemNtpProfileParcelResult).value

    return AwaitableGetSystemNtpProfileParcelResult(
...
@_utilities.lift_output_func(get_system_ntp_profile_parcel)
def get_system_ntp_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                         id: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemNtpProfileParcelResult]:
    """
    This data source can read the System NTP profile parcel.
