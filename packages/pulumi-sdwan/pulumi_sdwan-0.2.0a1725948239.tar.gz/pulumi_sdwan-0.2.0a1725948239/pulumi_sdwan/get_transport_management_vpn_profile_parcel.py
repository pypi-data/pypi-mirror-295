...
__all__ = [
    'GetTransportManagementVpnProfileParcelResult',
    'AwaitableGetTransportManagementVpnProfileParcelResult',
    'get_transport_management_vpn_profile_parcel',
    'get_transport_management_vpn_profile_parcel_output',
]

@pulumi.output_type
class GetTransportManagementVpnProfileParcelResult:
    """
    A collection of values returned by getTransportManagementVpnProfileParcel.
    """
    def __init__(__self__, basic_configuration_description=None, basic_configuration_description_variable=None, description=None, feature_profile_id=None, id=None, ipv4_static_routes=None, ipv6_static_routes=None, name=None, new_host_mappings=None, primary_dns_address_ipv4=None, primary_dns_address_ipv4_variable=None, primary_dns_address_ipv6=None, primary_dns_address_ipv6_variable=None, secondary_dns_address_ipv4=None, secondary_dns_address_ipv4_variable=None, secondary_dns_address_ipv6=None, secondary_dns_address_ipv6_variable=None, version=None):
    ...
    def ipv4_static_routes(self) -> Sequence['outputs.GetTransportManagementVpnProfileParcelIpv4StaticRouteResult']:
        """
        IPv4 Static Route
        """
    ...
    def ipv6_static_routes(self) -> Sequence['outputs.GetTransportManagementVpnProfileParcelIpv6StaticRouteResult']:
        """
        IPv6 Static Route
        """
    ...
    def new_host_mappings(self) -> Sequence['outputs.GetTransportManagementVpnProfileParcelNewHostMappingResult']:
...
class AwaitableGetTransportManagementVpnProfileParcelResult(GetTransportManagementVpnProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTransportManagementVpnProfileParcelResult(
...
def get_transport_management_vpn_profile_parcel(feature_profile_id: Optional[str] = None,
                                                id: Optional[str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransportManagementVpnProfileParcelResult:
    """
    ...
    example = sdwan.get_transport_management_vpn_profile_parcel(id="f6b2c44c-693c-4763-b010-895aa3d236bd",
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getTransportManagementVpnProfileParcel:getTransportManagementVpnProfileParcel', __args__, opts=opts, typ=GetTransportManagementVpnProfileParcelResult).value

    return AwaitableGetTransportManagementVpnProfileParcelResult(
...
@_utilities.lift_output_func(get_transport_management_vpn_profile_parcel)
def get_transport_management_vpn_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
