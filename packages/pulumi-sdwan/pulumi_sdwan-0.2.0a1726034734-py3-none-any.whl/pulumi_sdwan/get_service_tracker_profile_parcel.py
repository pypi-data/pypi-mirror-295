...
__all__ = [
    'GetServiceTrackerProfileParcelResult',
    'AwaitableGetServiceTrackerProfileParcelResult',
    'get_service_tracker_profile_parcel',
    'get_service_tracker_profile_parcel_output',
]

@pulumi.output_type
class GetServiceTrackerProfileParcelResult:
    """
...
class AwaitableGetServiceTrackerProfileParcelResult(GetServiceTrackerProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceTrackerProfileParcelResult(
...
def get_service_tracker_profile_parcel(feature_profile_id: Optional[str] = None,
                                       id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceTrackerProfileParcelResult:
    """
    ...
    example = sdwan.get_service_tracker_profile_parcel(id="f6b2c44c-693c-4763-b010-895aa3d236bd",
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getServiceTrackerProfileParcel:getServiceTrackerProfileParcel', __args__, opts=opts, typ=GetServiceTrackerProfileParcelResult).value

    return AwaitableGetServiceTrackerProfileParcelResult(
...
@_utilities.lift_output_func(get_service_tracker_profile_parcel)
def get_service_tracker_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                              id: Optional[pulumi.Input[str]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceTrackerProfileParcelResult]:
    """
    This data source can read the Service Tracker profile parcel.
