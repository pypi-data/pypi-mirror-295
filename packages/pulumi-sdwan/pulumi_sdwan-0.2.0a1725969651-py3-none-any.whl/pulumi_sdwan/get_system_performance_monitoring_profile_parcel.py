...
__all__ = [
    'GetSystemPerformanceMonitoringProfileParcelResult',
    'AwaitableGetSystemPerformanceMonitoringProfileParcelResult',
    'get_system_performance_monitoring_profile_parcel',
    'get_system_performance_monitoring_profile_parcel_output',
]

@pulumi.output_type
class GetSystemPerformanceMonitoringProfileParcelResult:
    """
...
class AwaitableGetSystemPerformanceMonitoringProfileParcelResult(GetSystemPerformanceMonitoringProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemPerformanceMonitoringProfileParcelResult(
...
def get_system_performance_monitoring_profile_parcel(feature_profile_id: Optional[str] = None,
                                                     id: Optional[str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemPerformanceMonitoringProfileParcelResult:
    """
    ...
    example = sdwan.get_system_performance_monitoring_profile_parcel(id="f6b2c44c-693c-4763-b010-895aa3d236bd",
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getSystemPerformanceMonitoringProfileParcel:getSystemPerformanceMonitoringProfileParcel', __args__, opts=opts, typ=GetSystemPerformanceMonitoringProfileParcelResult).value

    return AwaitableGetSystemPerformanceMonitoringProfileParcelResult(
...
@_utilities.lift_output_func(get_system_performance_monitoring_profile_parcel)
def get_system_performance_monitoring_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                                            id: Optional[pulumi.Input[str]] = None,
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemPerformanceMonitoringProfileParcelResult]:
    """
    This data source can read the System Performance Monitoring profile parcel.
