...
__all__ = [
    'GetSystemSnmpProfileParcelResult',
    'AwaitableGetSystemSnmpProfileParcelResult',
    'get_system_snmp_profile_parcel',
    'get_system_snmp_profile_parcel_output',
]

@pulumi.output_type
class GetSystemSnmpProfileParcelResult:
    """
    ...
    @property
    @pulumi.getter
    def communities(self) -> Sequence['outputs.GetSystemSnmpProfileParcelCommunityResult']:
        """
    ...
    @property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetSystemSnmpProfileParcelGroupResult']:
        """
    ...
    def trap_target_servers(self) -> Sequence['outputs.GetSystemSnmpProfileParcelTrapTargetServerResult']:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetSystemSnmpProfileParcelUserResult']:
        """
    ...
    @property
    @pulumi.getter
    def views(self) -> Sequence['outputs.GetSystemSnmpProfileParcelViewResult']:
        """
...
class AwaitableGetSystemSnmpProfileParcelResult(GetSystemSnmpProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemSnmpProfileParcelResult(
...
def get_system_snmp_profile_parcel(feature_profile_id: Optional[str] = None,
                                   id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemSnmpProfileParcelResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getSystemSnmpProfileParcel:getSystemSnmpProfileParcel', __args__, opts=opts, typ=GetSystemSnmpProfileParcelResult).value

    return AwaitableGetSystemSnmpProfileParcelResult(
...
@_utilities.lift_output_func(get_system_snmp_profile_parcel)
def get_system_snmp_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                          id: Optional[pulumi.Input[str]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemSnmpProfileParcelResult]:
    """
    This data source can read the System SNMP profile parcel.
