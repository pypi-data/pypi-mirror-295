...
__all__ = [
    'GetSystemSecurityProfileParcelResult',
    'AwaitableGetSystemSecurityProfileParcelResult',
    'get_system_security_profile_parcel',
    'get_system_security_profile_parcel_output',
]

@pulumi.output_type
class GetSystemSecurityProfileParcelResult:
    """
    ...
    @property
    @pulumi.getter
    def keychains(self) -> Sequence['outputs.GetSystemSecurityProfileParcelKeychainResult']:
        """
    ...
    @property
    @pulumi.getter
    def keys(self) -> Sequence['outputs.GetSystemSecurityProfileParcelKeyResult']:
        """
        Configure a Key
        """
...
class AwaitableGetSystemSecurityProfileParcelResult(GetSystemSecurityProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSystemSecurityProfileParcelResult(
...
def get_system_security_profile_parcel(feature_profile_id: Optional[str] = None,
                                       id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemSecurityProfileParcelResult:
    """
    ...
    example = sdwan.get_system_security_profile_parcel(id="f6b2c44c-693c-4763-b010-895aa3d236bd",
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getSystemSecurityProfileParcel:getSystemSecurityProfileParcel', __args__, opts=opts, typ=GetSystemSecurityProfileParcelResult).value

    return AwaitableGetSystemSecurityProfileParcelResult(
...
@_utilities.lift_output_func(get_system_security_profile_parcel)
def get_system_security_profile_parcel_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                              id: Optional[pulumi.Input[str]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemSecurityProfileParcelResult]:
    """
    This data source can read the System Security profile parcel.
