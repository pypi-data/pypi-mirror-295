...
__all__ = [
    'GetTransportIpv6TrackerProfileParcelResult',
    'AwaitableGetTransportIpv6TrackerProfileParcelResult',
    'get_transport_ipv6_tracker_profile_parcel',
    'get_transport_ipv6_tracker_profile_parcel_output',
]

@pulumi.output_type
class GetTransportIpv6TrackerProfileParcelResult:
    """
...
class AwaitableGetTransportIpv6TrackerProfileParcelResult(GetTransportIpv6TrackerProfileParcelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTransportIpv6TrackerProfileParcelResult(
...
def get_transport_ipv6_tracker_profile_parcel(feature_profile_id: Optional[str] = None,
                                              id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransportIpv6TrackerProfileParcelResult:
    """
    ...
    example = sdwan.get_transport_ipv6_tracker_profile_parcel(id="f6b2c44c-693c-4763-b010-895aa3d236bd",
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getTransportIpv6TrackerProfileParcel:getTransportIpv6TrackerProfileParcel', __args__, opts=opts, typ=GetTransportIpv6TrackerProfileParcelResult).value

    return AwaitableGetTransportIpv6TrackerProfileParcelResult(
...
@_utilities.lift_output_func(get_transport_ipv6_tracker_profile_parcel)
