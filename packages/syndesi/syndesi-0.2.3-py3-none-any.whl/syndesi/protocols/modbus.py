...
class Modbus(Protocol):
    ...
    def read_coils(self, start_address : int, number_of_coils : int):
        ...
        coils : list
        """
        MAX_COILS = 0x07B0 # 1968. This is to ensure the total PDU length is 255 at most.
        ...
        assert 1 <= number_of_coils <= MAX_COILS, f"Invalid number of coils : {number_of_coils}"
    ...
    def read_discrete_inputs(self, start_address : int, number_of_inputs : int):
        ...
        List of booleans
        """
        MAX_INPUTS = 0x07B0 # 1968. This is to ensure the total PDU length is 255 at most.
        # This value has been checked and going up to 1976 seems to work but sticking to the
        # spec is safer
        ...
        assert 1 <= number_of_inputs <= MAX_INPUTS, f"Invalid number of inputs : {number_of_inputs}"
