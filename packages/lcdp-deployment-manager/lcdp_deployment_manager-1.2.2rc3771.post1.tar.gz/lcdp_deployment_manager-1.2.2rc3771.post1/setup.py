...
setup(
    ...
    version='1.2.2rc-3771-1',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/LeComptoirDesPharmacies/lcdp-deployment-manager/archive/v1.2.2.tar.gz',
