...
class APIClient:
    ...
    def extract_pk_list(
        ...
        """Submit one or multiple pk-list/invoice from data extraction. This extraction is asynchronous and returns a s3_key that can be used to check the status of the background task running.
        Args:
