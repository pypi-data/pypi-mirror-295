...
class QueryRequest(BaseModel):
    ...
    chat_history: List[ChatMessage] | None = Field(default=None, description="", examples=[
        [{"content": "Hey how are you ?", "role": "user"},
         {"content": "I'm great, how can I help you ?", "role": "assistant"}]])
...
class ValidatedItem(BaseModel):
    content: str = Field(..., description="")
    role: str = Field(default="assistant", description="")
    name: str | None = Field(default=None, description="")
    meta: MetaJSON = Field(..., description="")


class SchemaValidator(BaseModel):
    validated: List[ValidatedItem] | None = Field(default=None, description="")
    validation_error: List | None = Field(default=None, description="")


class DataExtractRequest(BaseModel):
    email_content: str = Field(..., description="")


class DataExtractResponse(BaseModel):
    schema_validator: SchemaValidator = Field(..., description="")


class PkListExtractResponse(BaseModel):
    schema_validator: SchemaValidator = Field(..., description="")
...
class PkTask(BaseModel):
    ...
    s3_key: str = Field(..., description="")
    task_parameters: Dict | None = Field(default=None, description="")
    result_json: ListOfPkList | Dict | None = Field(default=None, description="")
    time_taken: float | None = Field(default=None, description="")
...
class DocInfos(BaseModel):
    ...
    group_id: str = Field(..., description="")
    document_date: datetime | None = Field(default=None, description="")
    keywords: List[str] | None = Field(default=None, description="")
    n_chunks: int = Field(..., description="")
    embedding_model: str = Field(..., description="")
    indexation_timestamp: datetime = Field(..., description="")
    is_deleted: bool = Field(..., description="")
    content_type: str = Field(..., description="")
    s3_key: str = Field(..., description="")
    pythia_document_category: str | None = Field(default=None, description="")
    language: str | None = Field(default=None, description="")
