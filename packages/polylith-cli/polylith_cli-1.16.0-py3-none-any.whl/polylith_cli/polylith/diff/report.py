...
def print_diff_details(projects_data: List[dict], bases: List[str], components: List[str]) -> None:
...
def print_detected_changes_in_bricks(changed_bases: List[str], changed_components: List[str], dependent_bricks: dict, options: dict) -> None:
