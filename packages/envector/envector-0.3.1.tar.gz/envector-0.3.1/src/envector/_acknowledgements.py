"""
The `envector package <http://pypi.python.org/pypi/envector/>`_ for
`Python <https://www.python.org/>`_ is based on the `nvector package
<http://pypi.python.org/pypi/nvector/>`_ . The original package
was written by Per A. Brodtkorb at
