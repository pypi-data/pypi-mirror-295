...
class CustomerRegistrationView(TemplateView):
    ...
    def post(self, request):
        ...
        user = Customer.objects.create_user(username=username, email=email, password=password, address=address)
...
class AdminRegistrationView(TemplateView):
    ...
    def post(self, request):
        ...
        user = AdminUser.objects.create_user(username=username, email=email, password=password, department=department)
        otp = OTP.objects.create(user=user)
        otp.generate_otp_code()
...
class PasswordChangeView(LoginRequiredMixin, TemplateView):
    ...
    def post(self, request):
        ...
        if user.check_password(old_password):
            ...
            user.save()
            print(old_password, new_password, user)
