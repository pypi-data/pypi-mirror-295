...
class OwnerChangeApp(ctk.CTk):
    def __init__(self, env='prod'):
        ...
        self.requests_cols = ['Tracking ID', 'From Owner', 'To Owner', 'Status', 'Total Tags', 'Passed', 'Failed', 'Sent At', 'Cloud Destination']
    ...
    def check_client(self):
        ...
        if self.prev_gcp_api_key != self.gcp_api_key:
            self.gcp_client = ManufacturingClient(api_key=self.gcp_api_key, env=self.env, cloud='gcp', region='us-central1')
    ...
    def send_request_file(self, from_owner, to_owner, df, cloud_destination=None):
        ...
        request_id = self.client.change_pixel_owner_by_file(from_owner, to_owner, file_path, destination_cloud=cloud_destination)
        return request_id
