...
from wiliot_tools.shipment_approval_gui.shipment_approval_utils import *
...
class MultiReelRequestPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, show_page_callback):
        ...
        self.combobox.place(x=500, y=210 + start_y)
    ...
    def verify_request(self, ex_ids):
        ...
        if len(ex_ids) > 100:
            raise Exception("Can't send more than 100 reels at once")
