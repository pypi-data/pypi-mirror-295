...
@app.command(name="connect", no_args_is_help=True, help=__("Connect to the entity by unique UID"))
def connect(
        uid: Optional[str] = typer.Argument(
            help=__("Unique ID of the entity to connect to. Must allow no ambiguity."), ),
    ...
    connect_service.connect_to_entity(uid=uid, username=username)
