...
from regscale.integrations.commercial.stig_mapper import STIGMapper
...
class ScannerIntegration(ABC):
    ...
    def get_issue_title(self, finding: IntegrationFinding) -> str:
        """
        ...
        if ScannerVariables.poamTitleType.lower() == "pluginid":
            issue_title = f"{finding.plugin_id}: {finding.plugin_name}"
