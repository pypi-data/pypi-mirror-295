...
class RentEstimateLongTerm200ResponseComparablesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "formattedAddress", "addressLine1", "addressLine2", "city", "state", "zipCode", "county", "latitude", "longitude", "propertyType", "bedrooms", "bathrooms", "squareFootage", "lotSize", "yearBuilt", "price", "listedDate", "lastSeenDate", "daysOld", "distance", "correlation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RentEstimateLongTerm200ResponseComparablesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RentEstimateLongTerm200ResponseComparablesInner from a dict"""
        if obj is None:
            return None
