...
class m:
    ...
    def set_first_password(self, invoking_function_name, request, sqlite_db_path, telegram_bot_preset_name):
        ...
        try:
            ...
            conn.commit()
            return jsonify(success=True, message="Password has been set successfully."), 200
