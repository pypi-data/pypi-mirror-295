...
class GirderPlugin(plugin.GirderPlugin):
    ...
    def _extract_zip(self, event):
        ...
        print(f"ZIP EXTRACTOR: File type: {type(file)}, File attributes: {dir(file)}")
        print(f"ZIP EXTRACTOR: Condition value: {'name' not in file}")
        if 'name' not in file:
        ...
        print(f"ZIP EXTRACTOR: file.name: {file['name']}, type: {type(file['name'])}")
        print(f"ZIP EXTRACTOR: Condition value: {not file['name'].lower().endswith('.zip')}")
