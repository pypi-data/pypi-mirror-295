...
logger.info("Zip Extractor module imported")
...
class GirderPlugin(plugin.GirderPlugin):
    ...
    def _extract_zip(self, event):
        ...
        try:
            ...
            # Uncomment this line if you want to remove the original zip file after extraction
            # File().remove(file)
...
logger.info("Zip Extractor module fully loaded")
