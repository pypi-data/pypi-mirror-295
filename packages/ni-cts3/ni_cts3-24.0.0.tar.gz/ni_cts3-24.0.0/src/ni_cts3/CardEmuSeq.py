...
def MPC_OpenScenarioPcd() -> int:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_OpenScenarioPcd(c_uint8(0), byref(scenario_id), c_uint32(0))
    )
...
class _S_emd(Structure):
    ...
    _pack_ = 1
    _fields_ = [("nb_pattern", c_uint16), ("pattern", c_uint16)]
...
class S_emd:
    ...
    def __init__(self, patterns_number: int, pattern_type: S_emd_pattern):
        ...
        if not isinstance(pattern_type, S_emd_pattern):
            raise TypeError("pattern_type must be an instance of S_emd_pattern IntEnum")
...
def MPC_AddToScenarioPcd(
    ...
    param1: Union[int, bool, float, EmdSubCarrier, VoltmeterRange],
) -> None:
...
def MPC_AddToScenarioPcd(
    ...
    param2: Union[int, bool, VicinitySubCarrier, DataRate],
) -> None:
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, param1: bool, param2: int, param3: int
) -> None:
    # TSCN_DO_NEGATIVE_MODULATION
    ...
...
def MPC_AddToScenarioPcd(
    ...
    param3: Union[int, bool, SequenceError],
) -> None:
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, tadt: int, tarfg: int, toff: int, tmute: int
) -> None:
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, param1: Union[float, NfcTrigger], param2: float
) -> None:
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, fdt: int, emd: List[S_emd]
) -> None:
    # TSCN_DO_EMD
    ...
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, param1: bool, picc_frame: bytes
) -> None:
    # TSCN_DO_WAIT_VC_EOF_ONLY
    ...
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, pcd_type: TechnologyType, mask: bytes
) -> None:
    # TSCN_SET_PCD_MASK
    ...
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, synchro: bool, pcd_frame: str, picc_frame: str
) -> None:
...
@overload
def MPC_AddToScenarioPcd(
    scenario_id: int, action: CardEmuSeqAction, vcd_crc: bool, synchro: bool, vcd_frame: bytes
) -> None:
...
def MPC_AddToScenarioPcd(scenario_id, action, *args):  # type: ignore[no-untyped-def]
    """
    ...
    if not isinstance(action, CardEmuSeqAction):
        raise TypeError("action must be an instance of CardEmuSeqAction IntEnum")
    ...
    # One parameter
    if (
        action == CardEmuSeqAction.TSCN_PARAM_SOF_LOW
        ...
        CTS3Exception._check_error(
            func_pointer(c_uint8(0), c_uint32(scenario_id), c_uint32(action), c_uint32(args[0]))
        )
    elif (
        action == CardEmuSeqAction.TSCN_PARAM_FELICA_BIT_CODING_REVERSE
    ...
    # µs
        ...
        CTS3Exception._check_error(
            func_pointer(c_uint8(0), c_uint32(scenario_id), c_uint32(action), c_uint32(tempo_us))
        )
    # ns
    elif (
        action == CardEmuSeqAction.TSCN_PARAM_TR0_NS
        ...
        CTS3Exception._check_error(
            func_pointer(c_uint8(0), c_uint32(scenario_id), c_uint32(action), c_uint32(delay_ns))
        )
        ...
        if not isinstance(args[0], EmdSubCarrier):
            raise TypeError("param1 must be an instance of EmdSubCarrier IntEnum")
        CTS3Exception._check_error(
            func_pointer(c_uint8(0), c_uint32(scenario_id), c_uint32(action), args[0])
        )
        ...
        if not isinstance(args[0], VoltmeterRange):
            raise TypeError("param1 must be an instance of VoltmeterRange IntEnum")
        CTS3Exception._check_error(
            func_pointer(c_uint8(0), c_uint32(scenario_id), c_uint32(action), c_uint32(args[0]))
        )
    elif (
        action == CardEmuSeqAction.TSCN_DO_TRIGGER_OUT_RX_ON
    ...
    # Two parameters
        ...
        action == CardEmuSeqAction.TSCN_DO_CHANGE_FELICA_DUTY_CYCLE
        ...
        CTS3Exception._check_error(
            func_pointer(
                ...
                c_uint32(action),
                c_uint32(args[0]),  # Trigger
                c_uint32(1) if args[1] else c_uint32(0),
            )
        )  # State
        ...
        if not isinstance(args[0], VicinityDataRate):
            raise TypeError("param1 must be an instance of VicinityDataRate IntEnum")
        if not isinstance(args[1], VicinitySubCarrier):
            raise TypeError("param2 must be an instance of VicinitySubCarrier IntEnum")
        CTS3Exception._check_error(
            func_pointer(
                c_uint8(0),
                c_uint32(scenario_id),
        ...
        if not isinstance(args[0], TechnologyType):
            raise TypeError("pcd_type must be an instance of TechnologyType IntEnum")
    ...
    # Three parameters
        ...
        if not isinstance(args[0], NfcTriggerId):
            raise TypeError("param1 must be an instance of int or NfcTriggerId IntFlag")
        ...
        CTS3Exception._check_error(
            func_pointer(
                ...
                c_uint32(1) if args[2] else c_uint32(0),
            )
        )  # Value
        ...
        if not isinstance(args[2], SequenceError):
            raise TypeError("param3 must be an instance of SequenceError IntEnum")
        CTS3Exception._check_error(
            func_pointer(
                c_uint8(0),
                c_uint32(scenario_id),
        ...
        warn("deprecated 'TSCN_PARAM_NFC_ACTIVE_TIMINGS' instruction", FutureWarning, 2)
        CTS3Exception._check_error(
            func_pointer(
                c_uint8(0),
                c_uint32(scenario_id),
    ...
    # Structure parameter
        ...
        for i in range(len(args[1])):
            if not isinstance(args[1][i], S_emd):
                raise TypeError("emd must be an instance of S_emd list")
            emd[i] = _S_emd(c_uint16(args[1][i].number), c_uint16(args[1][i].type.value))
...
def MPC_ExecuteScenarioPcd(scenario_id: int, timeout: float) -> None:
    ...
    CTS3Exception._check_error(
        _MPuLib.MPC_ExecuteScenarioPcd(c_uint8(0), c_uint32(scenario_id), c_uint32(timeout_ms))
    )
...
def MPC_CloseScenarioPcd(scenario_id: int) -> None:
    ...
    """
    _check_limits(c_uint32, scenario_id, "scenario_id")
    CTS3Exception._check_error(_MPuLib.MPC_CloseScenarioPcd(c_uint8(0), c_uint32(scenario_id)))
