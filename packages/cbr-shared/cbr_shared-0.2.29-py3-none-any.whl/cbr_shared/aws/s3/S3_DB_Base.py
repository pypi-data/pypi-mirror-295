...
BUCKET_NAME__SUFFIX          = "db-users"                       # todo: change this name 'db-users' to something more relevant to S3_DB_Base (since this is a legacy name from the early statges of cbr dev)
BUCKET_NAME__PREFIX          = ''
...
class S3_DB_Base(Type_Safe):
    ...
    bucket_name__suffix           : str = BUCKET_NAME__SUFFIX
    bucket_name__prefix           : str = BUCKET_NAME__PREFIX
