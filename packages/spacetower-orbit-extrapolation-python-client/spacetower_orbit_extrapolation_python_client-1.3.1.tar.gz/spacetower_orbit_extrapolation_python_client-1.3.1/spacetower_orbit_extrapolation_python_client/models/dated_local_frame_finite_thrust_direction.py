...
class DatedLocalFrameFiniteThrustDirection(BaseModel):
    ...
    thrust_direction_declination: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Angle between the thrust vector and the z-axis of the local frame. Units [rad]", alias="thrustDirectionDeclination")
