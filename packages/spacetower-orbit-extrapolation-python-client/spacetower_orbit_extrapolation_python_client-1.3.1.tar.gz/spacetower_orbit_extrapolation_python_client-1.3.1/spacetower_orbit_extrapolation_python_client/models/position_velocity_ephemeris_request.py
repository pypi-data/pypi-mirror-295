...
class PositionVelocityEphemerisRequest(EphemerisGenerationRequest):
    """
    ...
    __properties: ClassVar[List[str]] = ["ephemerisType", "step", "startDate", "endDate", "frameType", "oemRequest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionVelocityEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionVelocityEphemerisRequest from a dict"""
        if obj is None:
            return None
