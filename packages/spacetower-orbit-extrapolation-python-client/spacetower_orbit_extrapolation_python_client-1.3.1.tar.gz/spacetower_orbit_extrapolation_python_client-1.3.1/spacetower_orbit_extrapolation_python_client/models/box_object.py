...
class BoxObject(SpaceObject):
    ...
    __properties: ClassVar[List[str]] = ["mass", "solarArraySystem", "propulsionSystem", "spaceObjectType", "dragCoefficient", "xDimension", "yDimension", "zDimension", "radiationCoefficients", "solarArrayGeometry", "radiationCorrectionFactor"]
