...
class IsotropicObject(SpaceObject):
    ...
    __properties: ClassVar[List[str]] = ["mass", "solarArraySystem", "propulsionSystem", "spaceObjectType", "dragCoefficient", "dragCrossSection", "radiationCrossSection", "radiationCoefficients"]
