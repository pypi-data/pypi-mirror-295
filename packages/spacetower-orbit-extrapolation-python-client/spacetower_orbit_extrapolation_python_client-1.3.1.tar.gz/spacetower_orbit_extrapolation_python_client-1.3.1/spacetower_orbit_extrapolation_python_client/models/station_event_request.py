...
class StationEventRequest(EventGenerationRequest):
    """
    ...
    ground_stations: List[GroundStation] = Field(alias="groundStations")
    __properties: ClassVar[List[str]] = ["timeSpan", "eventType", "eventDetectionType", "minimumDuration", "groundStations"]
