...
class PositionVelocityCovarianceEphemerisRequest(EphemerisGenerationRequest):
    """
    Options for exporting position/velocity covariance ephemeris
    """ # noqa: E501
    frame_id: Optional[CartesianCovarianceAllowedFrameId] = Field(default=None, alias="frameId")
    __properties: ClassVar[List[str]] = ["ephemerisType", "step", "startDate", "endDate", "frameId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionVelocityCovarianceEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionVelocityCovarianceEphemerisRequest from a dict"""
        if obj is None:
            return None
