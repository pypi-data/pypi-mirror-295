...
class OsculatingOrbitEphemerisRequest(EphemerisGenerationRequest):
    """
    ...
    __properties: ClassVar[List[str]] = ["ephemerisType", "step", "startDate", "endDate", "anomalyType", "orbitType"]
