...
@hookspec
def check_instance_is_upgradable(instance: PostgreSQLInstance) -> None:
    """Check if specified PostgreSQL instance can be upgraded."""
    raise NotImplementedError
...
@hookspec(firstresult=True)
def postgresql_service_name(instance: PostgreSQLInstance) -> str:
