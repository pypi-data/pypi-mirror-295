...
typedef enum {
         ...
         */
        rflx_sequence_type_def = 126,
    

        /*

         */
        rflx_type_derivation_def = 127,
} rflx_node_kind_enum;
...
typedef enum {
      ...
      RFLX_RESET = 44
      ,
      RFLX_HIGH_ORDER_FIRST = 45
      ,
      RFLX_LOW_ORDER_FIRST = 46
      ,
      RFLX_CASE = 47
      ,
      RFLX_FIRST = 48
