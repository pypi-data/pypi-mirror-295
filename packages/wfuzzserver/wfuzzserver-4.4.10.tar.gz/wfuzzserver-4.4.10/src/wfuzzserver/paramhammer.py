...
class Fuzzer(Thread):
    ...
    def request(self,params_group,reqtype):
        if reqtype=="get":
            try:
                resp = requests.get(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.get(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="postquery":
            try:
                resp = requests.post(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.post(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="postform":
            try:
                resp = requests.post(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.post(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="postmultipart":
            ...
            try:
                resp = requests.post(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.post(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="postjson":
            try:
                resp = requests.post(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.post(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="postxml":
            ...
            if self.value_type == "bad":
                ...
                try:
                    resp = requests.post(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.post(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                ...
                try:
                    resp = requests.post(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.post(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
        ...
        if reqtype=="putquery":
            try:
                resp = requests.put(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.put(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="putform":
            try:
                resp = requests.put(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.put(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="putmultipart":
            ...
            for param in params_group:
                newgrp.update({param:(None,params_group[param])})
            try:
                resp = requests.put(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.put(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="putjson":
            try:
                resp = requests.put(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.put(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="putxml":
            ...
            if self.value_type == "bad":
                ...
                for param in params_group:
                    newgrp.update({param:params_group[param].replace('>','').replace('<','').replace('嘍嘊','')})
                try:
                    resp = requests.put(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.put(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                ...
                try:
                    resp = requests.put(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.put(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
        ...
        if reqtype=="patchquery":
            try:
                resp = requests.patch(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.patch(url=self.url, params=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="patchform":
            try:
                resp = requests.patch(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.patch(url=self.url, data=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="patchmultipart":
            ...
            for param in params_group:
                newgrp.update({param:(None,params_group[param])})
            try:
                resp = requests.patch(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.patch(url=self.url, files=newgrp,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="patchjson":
            try:
                resp = requests.patch(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
                return resp
            except:
                try:
                    resp = requests.patch(url=self.url, json=params_group,headers=self.typesheaders[reqtype])
        ...
        if reqtype=="patchxml":
            ...
            if self.value_type == "bad":
                ...
                for param in params_group:
                    newgrp.update({param:params_group[param].replace('>','').replace('<','').replace('嘍嘊','')})
                try:
                    resp = requests.patch(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.patch(url=self.url, data=dicttoxml(newgrp, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                ...
                try:
                    resp = requests.patch(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
                    return resp
                except:
                    try:
                        resp = requests.patch(url=self.url, data=dicttoxml(params_group, root=True, attr_type=False).decode('utf-8'),headers=self.typesheaders[reqtype])
