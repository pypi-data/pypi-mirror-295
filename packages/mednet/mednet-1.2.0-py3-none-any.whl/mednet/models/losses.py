...
class MOONBCEWithLogitsLoss(torch.nn.Module):
    """Calculates the weighted binary cross entropy loss based on [GUELER-2024]_.

    This loss implements the domain-adapted multitask loss function in Equation
    (2) on [GUELER-2024]_.  The vector of input weights must be calculated from
    ...
    weights
        ...
        at position 1, as defined in Equation (1) of [GUELER-2024]_.
    """
    ...
    def _get_weight_from_targets(cls, targets: torch.Tensor) -> torch.Tensor:
        ...
        -------
            ...
            position 1, as defined in Equation (1) of [GUELER-2024]_.
        """
    ...
    def forward(self, input_: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        ...
        Returns
        -------
            The result of Equation (2) from [GUELER-2024]_.
