# python build stubs for package pygoreadability
...
mod = Module('_pygoreadability')
mod.add_include('"libpygoreadability_impl.h"')
...
mod.add_function('Slice_html_Attribute_CTor', retval('int64_t'), [])
mod.add_function('Slice_html_Attribute_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_html_Attribute_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_html_Attribute_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_html_Attribute_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_html_Attribute_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
add_checked_function(mod, 'pygoreadability_FromURL', retval('int64_t'), [param('char*', 'pageURL'), param('int64_t', 'timeout')])
add_checked_string_function(mod, 'pygoreadability_GetContent', retval('char*'), [param('int64_t', 'article')])
add_checked_string_function(mod, 'pygoreadability_GetTextContent', retval('char*'), [param('int64_t', 'article')])
add_checked_string_function(mod, 'pygoreadability_GetTitle', retval('char*'), [param('int64_t', 'article')])
add_checked_function(mod, 'pygoreadability_Parse', retval('int64_t'), [param('char*', 'input')])

mod.generate(open('pygoreadability.c', 'w'))
