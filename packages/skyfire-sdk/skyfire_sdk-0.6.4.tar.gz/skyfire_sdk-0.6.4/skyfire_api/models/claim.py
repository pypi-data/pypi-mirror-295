...
class Claim(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "currency", "value", "sourceName", "destinationName", "sourceAddress", "destinationAddress", "network", "nonce", "signature", "referenceId", "status", "updatedAt", "txHash"]
