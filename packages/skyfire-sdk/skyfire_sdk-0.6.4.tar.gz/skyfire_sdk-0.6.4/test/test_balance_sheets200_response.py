...
class TestBalanceSheets200Response(unittest.TestCase):
    """BalanceSheets200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceSheets200Response:
        """Test BalanceSheets200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceSheets200Response`
        """
        model = BalanceSheets200Response()
        if include_optional:
            return BalanceSheets200Response(
                balance_sheets = [
                    skyfire_api.models.balance_sheet.BalanceSheet(
                        ticker = 'AAPL', 
    ...
    def testBalanceSheets200Response(self):
        """Test BalanceSheets200Response"""
