...
class ApprovalStatusEnum(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApprovalStatusEnum:
        """Create an instance of ApprovalStatusEnum from a JSON string"""
        return ApprovalStatusEnum(json.loads(json_str))
