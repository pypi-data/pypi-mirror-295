...
class VacancyAccountingCodeAllocationRequest(BaseModel):
    """
    Accounting Code Allocation
    """ # noqa: E501
    accounting_code: Int32LocatorRequest = Field(alias="accountingCode")
    allocation: Union[StrictFloat, StrictInt] = Field(description="How much is to be allocated. (0-1.0)")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "accountingCode": Int32LocatorRequest.from_dict(obj.get("accountingCode")) if obj.get("accountingCode") is not None else None,
