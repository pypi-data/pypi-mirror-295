...
class NeedsReplacementEnum(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NeedsReplacementEnum:
        """Create an instance of NeedsReplacementEnum from a JSON string"""
        return NeedsReplacementEnum(json.loads(json_str))
