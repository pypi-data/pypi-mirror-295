...
class AbsenceVacancyRequest(BaseModel):
    """
    AbsenceVacancyRequest
    """ # noqa: E501
    position: Optional[Int32LocatorRequest] = None
    details: Optional[List[AbsenceVacancyDetailRequest]] = Field(default=None, description="The Details of the Vacancy")
    ...
    __properties: ClassVar[List[str]] = ["position", "details", "notesToReplacement", "allowSubToAcceptPart", "externalId", "payCode", "holdForManualFill", "administratorComments"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "position": Int32LocatorRequest.from_dict(obj.get("position")) if obj.get("position") is not None else None,
            "details": [AbsenceVacancyDetailRequest.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None,
