...
class SubstitutePositionInfoResponse(BaseModel):
    """
    SubstitutePositionInfoResponse
    """ # noqa: E501
    position_type: Optional[Int32LocatorResponse] = Field(default=None, alias="positionType")
    pay_code: Optional[Int32LocatorResponse] = Field(default=None, alias="payCode")
    code: Optional[StrictStr] = Field(default=None, description="Position Code")
    number: Optional[StrictStr] = Field(default=None, description="Position Number")
    __properties: ClassVar[List[str]] = ["positionType", "payCode", "code", "number"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SubstitutePositionInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SubstitutePositionInfoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "positionType": Int32LocatorResponse.from_dict(obj.get("positionType")) if obj.get("positionType") is not None else None,
            "payCode": Int32LocatorResponse.from_dict(obj.get("payCode")) if obj.get("payCode") is not None else None,
            "code": obj.get("code"),
