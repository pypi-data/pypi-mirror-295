...
class AccountingCodeAllocationResponse(BaseModel):
    """
    Accounting code allocations
    """ # noqa: E501
    accounting_code: Optional[AccountingCodeLightResponse] = Field(default=None, alias="accountingCode")
    allocation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="What percentage (decimal) the Accounting code is allocated to")
    __properties: ClassVar[List[str]] = ["accountingCode", "allocation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of accounting_code
        if self.accounting_code:
            _dict['accountingCode'] = self.accounting_code.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "accountingCode": AccountingCodeLightResponse.from_dict(obj.get("accountingCode")) if obj.get("accountingCode") is not None else None,
