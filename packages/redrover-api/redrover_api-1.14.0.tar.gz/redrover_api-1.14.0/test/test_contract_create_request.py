...
class TestContractCreateRequest(unittest.TestCase):
    """ContractCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractCreateRequest:
        """Test ContractCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractCreateRequest`
        """
        model = ContractCreateRequest()
        if include_optional:
            return ContractCreateRequest(
                number_of_days = 56,
                work_day_pattern = redrover_api.models.identifier.Identifier(
                    id = 56, 
                    external_id = '', ),
                pay_cycle = redrover_api.models.identifier.Identifier(
                    id = 56, 
                    external_id = '', ),
                days_to_work = [
                    'Sunday'
    ...
    def testContractCreateRequest(self):
        """Test ContractCreateRequest"""
