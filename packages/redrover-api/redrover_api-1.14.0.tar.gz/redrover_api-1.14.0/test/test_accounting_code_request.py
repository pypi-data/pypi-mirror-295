...
class TestAccountingCodeRequest(unittest.TestCase):
    """AccountingCodeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingCodeRequest:
        """Test AccountingCodeRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingCodeRequest`
        """
        model = AccountingCodeRequest()
        if include_optional:
            return AccountingCodeRequest(
    ...
    def testAccountingCodeRequest(self):
        """Test AccountingCodeRequest"""
