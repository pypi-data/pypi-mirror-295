...
class TestAccountingCodeResponsePagedResponse(unittest.TestCase):
    """AccountingCodeResponsePagedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingCodeResponsePagedResponse:
        """Test AccountingCodeResponsePagedResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingCodeResponsePagedResponse`
        """
        model = AccountingCodeResponsePagedResponse()
        if include_optional:
            return AccountingCodeResponsePagedResponse(
                page = 56,
                page_size = 56,
                total_items = 56,
                total_pages = 56,
                data = [
                    redrover_api.models.accounting_code_light.AccountingCodeLight(
                        locations = [
                            redrover_api.models.simple_class.SimpleClass(
                                name = '', 
                                id = 56, 
                                external_id = '', )
                            ], 
    ...
    def testAccountingCodeResponsePagedResponse(self):
        """Test AccountingCodeResponsePagedResponse"""
