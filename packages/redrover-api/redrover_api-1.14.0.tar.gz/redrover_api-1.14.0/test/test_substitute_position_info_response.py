...
class TestSubstitutePositionInfoResponse(unittest.TestCase):
    """SubstitutePositionInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubstitutePositionInfoResponse:
        """Test SubstitutePositionInfoResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubstitutePositionInfoResponse`
        """
        model = SubstitutePositionInfoResponse()
        if include_optional:
            return SubstitutePositionInfoResponse(
    ...
    def testSubstitutePositionInfoResponse(self):
        """Test SubstitutePositionInfoResponse"""
