...
class TestLocationResponsePagedResponse(unittest.TestCase):
    """LocationResponsePagedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationResponsePagedResponse:
        """Test LocationResponsePagedResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationResponsePagedResponse`
        """
        model = LocationResponsePagedResponse()
        if include_optional:
            return LocationResponsePagedResponse(
                page = 56,
                page_size = 56,
                total_items = 56,
                total_pages = 56,
                data = [
                    redrover_api.models.location_light.LocationLight(
                        location_group = redrover_api.models.simple_class.SimpleClass(
                            name = '', 
                            id = 56, 
                            external_id = '', ), 
                        notes = '', 
    ...
    def testLocationResponsePagedResponse(self):
        """Test LocationResponsePagedResponse"""
