...
class TestContractUpdateRequest(unittest.TestCase):
    """ContractUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractUpdateRequest:
        """Test ContractUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractUpdateRequest`
        """
        model = ContractUpdateRequest()
        if include_optional:
    ...
    def testContractUpdateRequest(self):
        """Test ContractUpdateRequest"""
