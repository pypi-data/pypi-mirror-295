...
class TestTimeSettingsResponse(unittest.TestCase):
    """TimeSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeSettingsResponse:
        """Test TimeSettingsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSettingsResponse`
        """
        model = TimeSettingsResponse()
        if include_optional:
    ...
    def testTimeSettingsResponse(self):
        """Test TimeSettingsResponse"""
