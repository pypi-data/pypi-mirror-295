...
class TestAccountingCodeLightResponse(unittest.TestCase):
    """AccountingCodeLightResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingCodeLightResponse:
        """Test AccountingCodeLightResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingCodeLightResponse`
        """
        model = AccountingCodeLightResponse()
        if include_optional:
            return AccountingCodeLightResponse(
                code = '',
                name = '',
                id = 56,
                external_id = ''
    ...
    def testAccountingCodeLightResponse(self):
        """Test AccountingCodeLightResponse"""
