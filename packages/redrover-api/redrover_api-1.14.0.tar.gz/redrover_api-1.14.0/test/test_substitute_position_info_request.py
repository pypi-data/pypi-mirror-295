...
class TestSubstitutePositionInfoRequest(unittest.TestCase):
    """SubstitutePositionInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubstitutePositionInfoRequest:
        """Test SubstitutePositionInfoRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubstitutePositionInfoRequest`
        """
        model = SubstitutePositionInfoRequest()
        if include_optional:
            return SubstitutePositionInfoRequest(
    ...
    def testSubstitutePositionInfoRequest(self):
        """Test SubstitutePositionInfoRequest"""
