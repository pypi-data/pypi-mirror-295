...
class TestAccountingCodeUpdateRequest(unittest.TestCase):
    """AccountingCodeUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingCodeUpdateRequest:
        """Test AccountingCodeUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingCodeUpdateRequest`
        """
        model = AccountingCodeUpdateRequest()
        if include_optional:
            return AccountingCodeUpdateRequest(
    ...
    def testAccountingCodeUpdateRequest(self):
        """Test AccountingCodeUpdateRequest"""
