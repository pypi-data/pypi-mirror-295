...
class TestAccountingCodeApi(unittest.TestCase):
    """AccountingCodeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AccountingCodeApi()
    ...
    def test_get_accounting_codes(self) -> None:
        """Test case for get_accounting_codes
