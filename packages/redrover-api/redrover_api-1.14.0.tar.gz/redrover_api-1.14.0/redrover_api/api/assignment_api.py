...
class AssignmentApi:
    ...
    def get_assignment(
        ...
        identifier: Annotated[StrictStr, Field(description="The identifier of the Assignment. If this is an External Id, prepend the value with the pipe character `|` (e.g. `|ABC123`)")],
        ...
        :type org_id: int
        :param identifier: The identifier of the Assignment. If this is an External Id, prepend the value with the pipe character `|` (e.g. `|ABC123`) (required)
        :type identifier: str
    ...
    def _get_assignment_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/{orgId}/Assignment/{identifier}',
