...
class SubstitutePositionInfoRequest(BaseModel):
    """
    SubstitutePositionInfoRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["positionType", "number", "code", "payCode"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SubstitutePositionInfoRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SubstitutePositionInfoRequest from a dict"""
        if obj is None:
            return None
