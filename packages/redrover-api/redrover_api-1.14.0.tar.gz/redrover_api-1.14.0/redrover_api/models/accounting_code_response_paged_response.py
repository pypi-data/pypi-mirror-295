...
class AccountingCodeResponsePagedResponse(BaseModel):
    """
    ...
    data: Optional[List[AccountingCodeResponse]] = None
    __properties: ClassVar[List[str]] = ["page", "pageSize", "totalItems", "totalPages", "data"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AccountingCodeResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
