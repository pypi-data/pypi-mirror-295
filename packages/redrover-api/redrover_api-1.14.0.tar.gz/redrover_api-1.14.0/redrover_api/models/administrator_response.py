...
class AdministratorResponse(BaseModel):
    ...
    employees_under_supervision: Optional[List[SimplePerson]] = Field(default=None, description="The Employees that are under the supervision of the Admin", alias="employeesUnderSupervision")
    ...
    __properties: ClassVar[List[str]] = ["isSuperUser", "accessControl", "relatedOrgIds", "employeesUnderSupervision", "id", "orgId", "createdUtc", "changedUtc", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in employees_under_supervision (list)
        _items = []
        if self.employees_under_supervision:
            for _item in self.employees_under_supervision:
                if _item:
                    _items.append(_item.to_dict())
            _dict['employeesUnderSupervision'] = _items
        ...
        # set to None if employees_under_supervision (nullable) is None
        # and model_fields_set contains the field
        if self.employees_under_supervision is None and "employees_under_supervision" in self.model_fields_set:
            _dict['employeesUnderSupervision'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "employeesUnderSupervision": [SimplePerson.from_dict(_item) for _item in obj.get("employeesUnderSupervision")] if obj.get("employeesUnderSupervision") is not None else None,
            "id": obj.get("id"),
            "orgId": obj.get("orgId"),
