...
class TestZCli(BaseTest):
    ...
    def test_asset(self):
        ...
        verify_cli('list assets', [o.asset_key])
        ...
        verify_cli(f'get asset -d "{o.asset_key}"', ['"attributes"'])
        ...
        verify_cli(f'get asset "{o.asset_key}"')
    ...
    def test_risk(self):
        ...
        verify_cli('list risks', [o.risk_key])
        ...
        verify_cli(f'get risk -d "{o.risk_key}"', ['"attributes"'])
        ...
        verify_cli(f'get risk "{o.risk_key}"')
    ...
    def test_webhook(self):
        ...
        verify_cli(f'add webhook', ['amazonaws.com/chariot/hook/', 'https://'])
        verify_cli(f'get webhook', ['amazonaws.com/chariot/hook/', 'https://'])
