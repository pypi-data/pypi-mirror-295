...
def fit(
    ...
    loading_voice=False,
    decision_boundary_status=True # Loading speak may effects training time
) -> str:
    """
    ...
    if show_training == True:
        ...
        if decision_boundary_status == True:
            ...
            decision_boundary_total_progress = tqdm(total=100/val_count, leave=False, ascii="▱▰",
            bar_format= bar_format, desc="Total Decision Boundary Progress",ncols= 70)
                ...
                if int(progress) % val_count == 1 and val_old_progress != int(progress):
                    ...
                    if show_training == True:
                        ...
                        if decision_boundary_status == True:
                            ...
                            decision_boundary_total_progress.update(1)
...
def evaluate(
    ...
    try:
        ...
        if bar_status == True:
            ...
            bar_format= bar_for_acc, ncols=70)
            test_progress = tqdm(total=len(x_test),leave=False,ascii="▱▰",
            bar_format= bar_format, desc='Testing',ncols=70)
