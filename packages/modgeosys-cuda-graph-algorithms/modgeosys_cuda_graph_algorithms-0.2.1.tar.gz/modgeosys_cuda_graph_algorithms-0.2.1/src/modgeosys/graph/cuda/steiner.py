...
def compute_metric_closure(terminals, nodes, edges, distance_func, use_gpu, required_currents, cable_types):
...
def steiner_tree_approximation(nodes, terminals, edges, distance_func_gpu, distance_func_cpu, use_gpu, required_currents, cable_types):
    ...
    metric_closure = compute_metric_closure(terminals, nodes, edges, distance_func, use_gpu, required_currents, cable_types)
