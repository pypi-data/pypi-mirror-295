...
class MutateApp:
    ...
    def submit(self) -> None:
        ...
        if not self.orig_run:
            ...
            try:
                certora_run_result = self.run_certora_prover(self.conf, mutation_test_id,
    ...
    def run_mutant(self, mutant: Mutant, trg_dir: Path, orig_conf: Path,
        ...
        with Util.change_working_directory(find_cwd(trg_dir)):
            ...
            assert certora_run_result, f"run_mutant: no result {mutant.id} "
    ...
    def run_certora_prover(self, conf_file: Path, mutation_test_id: str = "", msg: str = "",
                           is_mutant:  bool = True) -> Optional[CertoraRunResult]:
    ...
    def get_results(link: Optional[str], fetcher: WebFetcher) -> Optional[List[RuleResult]]:
        ...
        if top_level_rules is None:
            raise Util.ImplementationError("Could not get tree view object")
        rule_results = []
