...
@jsii.interface(jsii_type="xpander-sdk.IXChatParams")
class IXChatParams(typing_extensions.Protocol):
...
class _IXChatParamsProxy:
    '''Interface represting chat params.'''

    __jsii_type__: typing.ClassVar[str] = "xpander-sdk.IXChatParams"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IXChatParams).__jsii_proxy_class__ = lambda : _IXChatParamsProxy
...
class XpanderClient(metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.XpanderClient"):
    ...
    def __init__(
        ...
        :param xchat_params: - Optional chat parameters for enhanced context.
        ...
        if __debug__:
            ...
            check_type(argname="argument xchat_params", value=xchat_params, expected_type=type_hints["xchat_params"])
        jsii.create(self.__class__, self, [agent_key, agent_url, llm_provider, local_tools, tools, xchat_params])
