...
class TargetMachine(llvmpym_ext.PymTargetMachineObject):
    ...
    @property
    def triple(self) -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...

    @property
    def cpu(self) -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...

    @property
    def feature_string(self) -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...
...
def get_default_target_triple() -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...

def get_host_cpu_features() -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...

def get_host_cpu_name() -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...

def normalize_target_triple(arg: str, /) -> "std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >": ...
