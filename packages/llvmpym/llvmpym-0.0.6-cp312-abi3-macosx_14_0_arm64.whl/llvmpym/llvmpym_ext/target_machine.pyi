...
class TargetMachine(llvmpym_ext.PymTargetMachineObject):
    ...
    @property
    def triple(self) -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

    @property
    def cpu(self) -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

    @property
    def feature_string(self) -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

    @property
    def data_layout(self) -> llvmpym_ext.target.TargetData: ...
...
def get_default_target_triple() -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

def get_host_cpu_features() -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

def get_host_cpu_name() -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...

def normalize_target_triple(arg: str, /) -> "std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>": ...
