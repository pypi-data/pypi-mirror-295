...
class Run(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('run_id', 'artifact_uri', 'status', 'latest_metrics', 'experiment_id', 'params', 'start_time', 'end_time', 'lifecycle_stage', 'parent_job', 'list_artifacts', 'get_conda_env', 'list_requirements', 'experiment', 'tags', 'metric_history')
    run_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='runId')
