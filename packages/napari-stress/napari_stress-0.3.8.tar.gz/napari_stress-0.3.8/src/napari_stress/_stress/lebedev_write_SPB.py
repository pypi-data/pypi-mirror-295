...
def leb14():
    return genOh_a00(0.06666666666666667) + genOh_aaa(0.07500000000000000)
...
def leb38():
    return (
        ...
        + genOh_ab0(0.2857142857142857e-1, 0.4597008433809831e0)
    )
...
def leb50():
    return (
        ...
        + genOh_aab(0.2017333553791887e-1, 0.3015113445777636e0)
    )
...
def leb74():
    return (
        ...
        + genOh_aab(0.2657620708215946e-1, 0.4803844614152614e0)
        + genOh_ab0(0.1652217099371571e-1, 0.3207726489807764e0)
    )
...
def leb86():
    return (
        ...
        + genOh_aab(0.1111055571060340e-1, 0.3696028464541502e0)
        + genOh_aab(0.1187650129453714e-1, 0.6943540066026664e0)
        + genOh_ab0(0.1181230374690448e-1, 0.3742430390903412e0)
    )
...
def leb110():
    return (
        ...
        + genOh_aab(0.8211737283191111e-2, 0.1851156353447362e0)
        + genOh_aab(0.9942814891178103e-2, 0.6904210483822922e0)
        + genOh_aab(0.9595471336070963e-2, 0.3956894730559419e0)
        + genOh_ab0(0.9694996361663028e-2, 0.4783690288121502e0)
    )
...
def leb146():
    return (
        ...
        + genOh_aab(0.7116355493117555e-2, 0.6764410400114264e0)
        + genOh_aab(0.6753829486314477e-2, 0.4174961227965453e0)
        + genOh_aab(0.7574394159054034e-2, 0.1574676672039082e0)
        + genOh_abc(0.6991087353303262e-2, 0.1403553811713183e0, 0.4493328323269557e0)
    )
...
def leb170():
    return (
        ...
        + genOh_aab(0.5183387587747790e-2, 0.2551252621114134e0)
        + genOh_aab(0.6317929009813725e-2, 0.6743601460362766e0)
        + genOh_aab(0.6201670006589077e-2, 0.4318910696719410e0)
        + genOh_ab0(0.5477143385137348e-2, 0.2613931360335988e0)
        + genOh_abc(0.5968383987681156e-2, 0.4990453161796037e0, 0.1446630744325115e0)
    )
...
def leb194():
    return (
        ...
        + genOh_aab(0.5608704082587997e-2, 0.6712973442695226e0)
        + genOh_aab(0.5158237711805383e-2, 0.2892465627575439e0)
        + genOh_aab(0.5518771467273614e-2, 0.4446933178717437e0)
        + genOh_aab(0.4106777028169394e-2, 0.1299335447650067e0)
        + genOh_ab0(0.5051846064614808e-2, 0.3457702197611283e0)
        + genOh_abc(0.5530248916233094e-2, 0.1590417105383530e0, 0.8360360154824589e0)
    )
