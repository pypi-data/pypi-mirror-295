...
class SparkRealtimeFeaturePipeline(RealtimeFeaturePipeline):
    ...
    def _feature_view_node_to_value(
        ...
        if self._pipeline_inputs is not None:
            ...
            return self._format_datetimes_for_pandas_mode(df)
        else:
    ...
    def _context_node_to_value(
        ...
        if self.is_python_mode:
            ...
            return RealtimeContext(request_timestamp)
        elif self.is_pandas_mode:
            return pandas.to_datetime(request_timestamp, utc=True).to_frame(name="request_timestamp")
        else:
