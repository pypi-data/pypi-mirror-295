...
class DataSource(base_tecton_object.BaseTectonObject):
    ...
    def select_range(
        self,
        start_time: Union[datetime, FilterDateTime, TectonTimeConstant] = TectonTimeConstant.UNBOUNDED_PAST,
        end_time: Union[datetime, FilterDateTime, TectonTimeConstant] = TectonTimeConstant.UNBOUNDED_FUTURE,
    ) -> FilteredSource:
        """
        ...
        :param start_time: The start time of the filter. Can be a datetime or TectonTimeConstant optionally offset by a timedelta. Defaults to UNBOUNDED_PAST.
        :param end_time: The end time of the filter. Can be a datetime or TectonTimeConstant optionally offset by a timedelta. Defaults to UNBOUNDED_FUTURE.
