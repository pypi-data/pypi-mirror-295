...
class Dataset(BaseModel):
    ...
    def finetune_search_model(
        ...
        """
        print('This Feature is a work in progress and will be available soon')
    ...
    def convert_dataset_to_video(
        self,
        videos_location: Union[AWSLocation, GCSLocation, AzureLocation],
        video_file_extension: str,
        image_video_metadata_csv_location: Union[AWSLocation, GCSLocation, AzureLocation]
    ):
        """
        ...
        Args:
            ...
            video_file_extension (str):
                The file extension of the videos
            image_video_metadata_csv_location (Union[AWSLocation, GCSLocation, AzureLocation]):
                The location of the image video metadata csv file 
                output by the video  processing service
        """
        upload_video_locations_endpoint = f"/workspaces/{self.workspace_name}/datasets/{self.key}/videos"
        upload_video_locations_payload = {
            "videos_location": videos_location.model_dump(),
            "video_file_extension": video_file_extension,
        }
        ...
        upload_image_video_metadata_endpoint = f"/workspaces/{self.workspace_name}/datasets/{self.key}/add_image_video_metadata"
        upload_image_video_metadata_payload = {
            "image_video_metadata_csv_location": image_video_metadata_csv_location.model_dump(),
        }

        self.client.post(
            upload_image_video_metadata_endpoint, 
            body=upload_image_video_metadata_payload
        )
