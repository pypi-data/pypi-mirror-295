...
class GetProjectSettingsResponse200Data:
    ...
    Attributes:
        ...
        response_source (Union[Unset, GetProjectSettingsResponse200DataResponseSource]): By default, we ask ChatGPT to
        ...
        enable_citations (Union[Unset, None, GetProjectSettingsResponse200DataEnableCitations]): Each chatbot response
            shows an option for the user to see the sources/citations from your content from which the response was
            generated. Default: GetProjectSettingsResponse200DataEnableCitations.VALUE_3. Example: 3.
        ...
        citations_view_type (Union[Unset, None, GetProjectSettingsResponse200DataCitationsViewType]): Control how
            citations are shown. By default, the user can initiate to see the citations. You can choose to have it "Auto
            Shown" or "Auto Hide" Default: GetProjectSettingsResponse200DataCitationsViewType.USER. Example: user.
        ...
        chatbot_model (Union[Unset, None, GetProjectSettingsResponse200DataChatbotModel]): This is the model used by the
            chatbot. You can choose a different model to suit your needs. Default:
            GetProjectSettingsResponse200DataChatbotModel.GPT_4. Example: gpt-4.
