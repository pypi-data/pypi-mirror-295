...
| __ |  _/\ V /___| |) / _ \  _/ _/ _ \ | ' \ 
|_||_|_|   \_/    |___/\___/\__\__\___/_|_||_|
+-----------------------------------------+
...
def HPV_Get_Empty_Request() -> dict:
    ...
    try:
        return {
            ...
            "Authentication_2": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/css/main.css",
                "Headers": {"User-Agent": "HPV TEAM", "Accept": "text/css,*/*;q=0.1", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "style", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_3": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/static/css/main.3a6b75bf.css",
                "Headers": {"User-Agent": "HPV TEAM", "Accept": "text/css,*/*;q=0.1", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "style", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_4": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/js/particles.min.js",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "script", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_5": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/static/js/main.419c784f.js",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "script", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_6": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/config/particles.json",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_7": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/images/bg.png",
                "Headers": {"User-Agent": "HPV TEAM", "Accept": "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "image", "referer": "https://app.dotcoin.bot/css/main.css", "accept-language": "HPV TEAM"}
            },
            "Authentication_8": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/fonts/SFRounded-Regular.woff2",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "origin": "https://app.dotcoin.bot", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "font", "referer": "https://app.dotcoin.bot/css/main.css", "accept-language": "HPV TEAM"}
            },
            "Authentication_9": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/favicon.ico",
                "Headers": {"User-Agent": "HPV TEAM", "Accept": "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "no-cors", "sec-fetch-dest": "image", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_10": {
                "Method": "options",
                "Url": "https://api.dotcoin.bot/functions/v1/getToken",
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "POST", "access-control-request-headers": "authorization,content-type", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Authentication_11": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/fonts/SFRounded-Semibold.woff2",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "origin": "https://app.dotcoin.bot", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "font", "referer": "https://app.dotcoin.bot/css/main.css", "accept-language": "HPV TEAM"}
            },
            "Authentication_12": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/fonts/SFRounded-Bold.woff2",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "origin": "https://app.dotcoin.bot", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "font", "referer": "https://app.dotcoin.bot/css/main.css", "accept-language": "HPV TEAM"}
            },
            "Authentication_13": {
                "Method": "get",
                "Url": "https://app.dotcoin.bot/fonts/SFRounded-Heavy.woff2",
                "Headers": {"User-Agent": "HPV TEAM", "sec-ch-ua": "HPV TEAM", "origin": "https://app.dotcoin.bot", "sec-ch-ua-mobile": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-dest": "font", "referer": "https://app.dotcoin.bot/css/main.css", "accept-language": "HPV TEAM"}
            },
            ...
            "Get_DTC_Balance_1": {
                "Method": "options",
                "Url": "https://api.dotcoin.bot/rest/v1/rpc/get_products",
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "GET", "access-control-request-headers": "accept-profile,apikey,authorization,x-client-info,x-telegram-user-id", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "Get_DTC_Balance_2": {
                "Method": "options",
            ...
            "Get_DTC_Balance_3": {
                "Method": "get",
                "Url": "https://api.dotcoin.bot/rest/v1/rpc/get_products",
                "Headers": {"User-Agent": "HPV TEAM", "x-client-info": "postgrest-js/0.0.0-automated", "sec-ch-ua": "HPV TEAM", "sec-ch-ua-mobile": "HPV TEAM", "authorization": "HPV TEAM", "accept-profile": "public", "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8", "x-telegram-user-id": "HPV TEAM", "sec-ch-ua-platform": "HPV TEAM", "origin": "https://app.dotcoin.bot", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-mode": "cors", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            ...
            "AutoCheckRef_1": {
                "Method": "options",
                "Url": "https://api.dotcoin.bot/rest/v1/rpc/get_referrals",
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "GET", "access-control-request-headers": "accept-profile,apikey,authorization,x-client-info,x-telegram-user-id", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            "AutoCheckRef_2": {
                "Method": "get",
            ...
            "Get_Tasks": {
                "Method": "options",
                "Url": "https://api.dotcoin.bot/rest/v1/rpc/get_filtered_tasks?platform=android&locale=ru&is_premium=true",
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "GET", "access-control-request-headers": "accept-profile,apikey,authorization,x-client-info,x-telegram-user-id", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            ...
            "Run_Tasks": {
                ...
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "POST", "access-control-request-headers": "apikey,authorization,content-profile,content-type,x-client-info,x-telegram-user-id", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
            ...
            "upgradeDTCMiner": {
                ...
                "Headers": {"User-Agent": "HPV TEAM", "access-control-request-method": "POST", "access-control-request-headers": "apikey,authorization,x-telegram-user-id", "origin": "https://app.dotcoin.bot", "sec-fetch-mode": "cors", "x-requested-with": "HPV TEAM", "sec-fetch-site": "same-site", "sec-fetch-dest": "empty", "referer": "https://app.dotcoin.bot/", "accept-language": "HPV TEAM"}
            },
...
def HPV_Upgrade_Alert(AUTO_UPDATE) -> bool:
    ...
    try:
        if AUTO_UPDATE:
            HPV = get('https://pypi.org/pypi/HPV-TEAM-Dotcoin/json').json()['info']['version']
    ...
    try:
        if HPV_Upgrade_Alert(AUTO_UPDATE):
            ...
            if AUTO_UPDATE:
                ...
                terminal([PIP, 'install', '--upgrade', 'HPV_TEAM_Dotcoin'], check=True) # Установка зависимостей

                print(Fore.MAGENTA + '[HPV]' + Fore.GREEN + ' — Перезапуск программы...')
                Popen([executable, path.join(getcwd(), 'HPV_Dotcoin.py')]); exit() # Перезапуск программы
...
def HPV_Check_Configs():
    ...
    FILES = {
        HPV_Account_json: {'ACCOUNT_1': 'https://app.dotcoin.bot/#tgWebAppData=...', 'ACCOUNT_2': 'https://app.dotcoin.bot/#tgWebAppData=...'},
        HPV_Config_json: '',
...
class HPV_Dotcoin:
    ...
    [6] - `Просмотр рекламы и отыгрыш полученных игр`
    
    [7] - `Ожидание от 9 до 12 часов`
    
    [8] - `Повторение действий через 9-12 часов`
    '''



    def __init__(self, Name: str, URL: str, Proxy: dict, Headers: dict, COINS: license[int], MAX_CLICK_LVL: int, MAX_LIMIT_LVL: int, AUTO_UPDATE: bool, Lock: Lock) -> None:
    ...
    def Authentication(self) -> str:
        ...
        URL = 'https://api.dotcoin.bot/functions/v1/getToken'
        HEADERS = {'User-Agent': self.USER_AGENT, 'Content-Type': 'application/json', 'sec-ch-ua': self.SEC_CH_UA, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}
        JSON = {'initData': self.URL, 'hash': None}
        ...
        try:
            Token = self.HPV_PRO.post(URL, headers=HEADERS, json=JSON, proxies=self.Proxy).json()['token']
    ...
    def Empty_Request(self, Empty: str) -> None:
        ...
        for header_key in list(Request['Headers'].keys()):
            ...
            elif header_key_lower == 'x-telegram-user-id':
    ...
    def Get_Info(self) -> dict:
        ...
        HEADERS = {'User-Agent': self.USER_AGENT, 'x-client-info': 'postgrest-js/0.0.0-automated', 'sec-ch-ua': self.SEC_CH_UA, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': f'Bearer {self.Token}', 'accept-profile': 'public', 'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'x-telegram-user-id': self.TG_ID, 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}
        ...
        try:
            ...
            return {'Balance': '0', 'Plays': 0, 'Click_LVL': '0', 'Limit_LVL': '0', 'DTC_LVL': 0}
    ...
    def Get_DTC_Balance(self) -> int:
        ...
        self.Empty_Request('Get_DTC_Balance_1') # Пустой запрос
        self.Empty_Request('Get_DTC_Balance_2') # Пустой запрос
        self.Empty_Request('Get_DTC_Balance_3') # Пустой запрос
    ...
    def Get_Tasks(self) -> list:
        ...
        self.Empty_Request('Get_Tasks') # Пустой запрос

        try:
            return self.HPV_PRO.get(URL, headers=HEADERS, proxies=self.Proxy).json()
        except:
            return []



    def Run_Tasks(self, ID: int) -> bool:
        '''Выполнение задания'''

        URL = 'https://api.dotcoin.bot/rest/v1/rpc/complete_task'
        HEADERS = {'User-Agent': self.USER_AGENT, 'Content-Type': 'application/json', 'x-client-info': 'postgrest-js/0.0.0-automated', 'sec-ch-ua': self.SEC_CH_UA, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': f'Bearer {self.Token}', 'content-profile': 'public', 'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'x-telegram-user-id': self.TG_ID, 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}
        JSON = {'oid': ID}

        try:
            return self.HPV_PRO.post(URL, headers=HEADERS, json=JSON, proxies=self.Proxy).json()['success']
        except:
            return False
        ...
        try:
            ...
            for Task in Tasks:
                if not Task['is_completed']:
                    if self.Run_Tasks(Task['id']):
                        self.Logging('Success', '⚡️', f'Задание `{Task["title"]}` выполнено! +{Task["reward"]:,}')
    ...
    def Update_Boosts(self, UP_Type: Literal['Click_LVL', 'Limit_LVL'], LVL: str) -> bool:
        '''Апгрейд бустов'''
        ...
        if UP_Type == 'Click_LVL':
            URL = 'https://api.dotcoin.bot/rest/v1/rpc/add_multitap'
            DATA = '{"lvl":' + LVL + '}'
            self.Empty_Request('add_multitap') # Пустой запрос
        else:
            URL = 'https://api.dotcoin.bot/rest/v1/rpc/add_attempts'
            DATA = '{"lvl":' + LVL + '}'
            self.Empty_Request('add_attempts') # Пустой запрос

        try:
            return self.HPV_PRO.post(URL, headers=HEADERS, data=DATA, proxies=self.Proxy).json()['success']
        except:
            return False
    ...
    def AutoUpdateBoosts(self, Boosts: dict) -> None:
        ...
        try:
            ...
            if Boosts['Click_LVL'] < self.MAX_CLICK_LVL:
                if self.Update_Boosts('Click_LVL', str(Boosts['Click_LVL'])):
                    self.Logging('Success', '⚡️', 'Буст `Multitap` улучшен!')
            ...
            if Boosts['Limit_LVL'] < self.MAX_LIMIT_LVL:
                if self.Update_Boosts('Limit_LVL', str(Boosts['Limit_LVL'])):
                    self.Logging('Success', '⚡️', 'Буст `Daily Attempts` улучшен!')
                    sleep(randint(2, 5)) # Промежуточное ожидание
        except:
            pass
    ...
    def AutoClaimBonus(self) -> None:
        '''Автоматическое получение бонуса'''

        URL = 'https://api.dotcoin.bot/rest/v1/rpc/try_your_luck'
        HEADERS = {'User-Agent': self.USER_AGENT, 'Content-Type': 'application/json', 'x-client-info': 'postgrest-js/0.0.0-automated', 'sec-ch-ua': self.SEC_CH_UA, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': f'Bearer {self.Token}', 'content-profile': 'public', 'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'x-telegram-user-id': self.TG_ID, 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}

        self.Empty_Request('try_your_luck') # Пустой запрос

        try:
            HPV = self.HPV_PRO.post(URL, headers=HEADERS, json={'coins': 150_000}, proxies=self.Proxy).json()['success']

            if HPV:
                self.Logging('Success', '🟢', 'Бонус получен! +150,000')
            else:
                self.Logging('Warning', '🟡', 'Бонус уже получен!')
        except:
            self.Logging('Error', '🔴', 'Бонус не получен!')
    ...
    def DTC_Update(self) -> bool:
        ...
        URL = 'https://api.dotcoin.bot/functions/v1/upgradeDTCMiner'
        HEADERS = {'User-Agent': self.USER_AGENT, 'sec-ch-ua': self.SEC_CH_UA, 'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'x-telegram-user-id': self.TG_ID, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': f'Bearer {self.Token}', 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}

        self.Empty_Request('upgradeDTCMiner') # Пустой запрос

        try:
            return self.HPV_PRO.post(URL, headers=HEADERS, proxies=self.Proxy).json()['success']
        except:
            return False



    def AutoDTCUpdate(self) -> None:
        '''Автоматическое апгрейд DTC майнинга'''

        try:
            if self.DTC_Update():
                self.Logging('Success', '⚡️', 'Апгрейд майнинга успешен!')
                sleep(randint(2, 5)) # Промежуточное ожидание
        except:
            pass
    ...
    def Play(self, _COINS) -> bool:
        '''Запуск игры'''

        URL = 'https://api.dotcoin.bot/rest/v1/rpc/save_coins'
        HEADERS = {'User-Agent': self.USER_AGENT, 'Content-Type': 'application/json', 'x-client-info': 'postgrest-js/0.0.0-automated', 'sec-ch-ua': self.SEC_CH_UA, 'sec-ch-ua-mobile': self.SEC_CH_UA_MOBILE, 'authorization': f'Bearer {self.Token}', 'content-profile': 'public', 'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impqdm5tb3luY21jZXdudXlreWlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg3MDE5ODIsImV4cCI6MjAyNDI3Nzk4Mn0.oZh_ECA6fA2NlwoUamf1TqF45lrMC0uIdJXvVitDbZ8', 'x-telegram-user-id': self.TG_ID, 'sec-ch-ua-platform': self.SEC_CH_UA_PLATFORM, 'origin': 'https://app.dotcoin.bot', 'x-requested-with': self.X_REQUESTED_WITH, 'sec-fetch-site': 'same-site', 'sec-fetch-mode': 'cors', 'sec-fetch-dest': 'empty', 'referer': 'https://app.dotcoin.bot/', 'accept-language': self.ACCEPT_LANGUAGE}

        self.Empty_Request('save_coins') # Пустой запрос

        try:
            return self.HPV_PRO.post(URL, headers=HEADERS, json={'coins': _COINS}, proxies=self.Proxy).json()['success']
        except:
            return False



    def AutoPlay(self, Plays: int) -> None:
        '''Автоматический запуск игры'''

        try:

            if Plays > 0:
                self.Logging('Success', '🎮', f'Игр доступно: {Plays}!')
                ...
                for _ in range(Plays):
                    ...
                    sleep(randint(12, 23)) # Промежуточное ожидание
        except:
            pass
    ...
    def View_Ads(self) -> bool:
        ...
        self.Empty_Request('restore_attempt') # Пустой запрос

        try:
            return self.HPV_PRO.post(URL, headers=HEADERS, json={}, proxies=self.Proxy).json()['success']
        except:
            return False



    def AutoViewAds(self) -> None:
        '''Автоматический просмотр рекламы'''

        try:
            while True:
                if self.View_Ads():
                    self.Logging('Success', '🟢', 'Реклама просмотрена! +1 игра')
        ...
        while True:
            try:
                if self.Token: # Если аутентификация успешна
                    ...
                    INFO = self.Get_Info()
                    Balance = INFO['Balance'] # Текущий баланс
                    Plays = INFO['Plays'] # Доступное кол-во игр
                    ...
                    if not Plays:
                        _Waiting = randint(9*60*60, 12*60*60) # Значение времени в секундах для ожидания
                    ...
                    sleep(randint(3, 6)) # Промежуточное ожидание
                    self.Logging('Success', '💰', f'Текущий баланс: {Balance} /// Баланс DTC: {self.Get_DTC_Balance():,} /// Уровень DTC: {DTC_LVL}')
                    sleep(randint(3, 6)) # Промежуточное ожидание


                    # Рандомное выполнение действий: просмотр рефералов, выполнение заданий, апдейт бустов, получение бонуса, апдейт DTC майнера, прохождение игр и просмотр рекламы
                    Autos = [self.AutoCheckRef, self.AutoRunTasks, lambda: self.AutoUpdateBoosts({'Click_LVL': Click_LVL, 'Limit_LVL': Limit_LVL}), self.AutoClaimBonus, self.AutoDTCUpdate, lambda: self.AutoPlay(Plays), self.AutoViewAds]
                    ...
                    _INFO = self.Get_Info()
                    Balance = _INFO['Balance'] # Текущий баланс
                    DTC_LVL = _INFO['DTC_LVL'] # Уровень фарма DTC
...
def HPV_Main(COINS: list[int], MAX_CLICK_LVL: int, MAX_LIMIT_LVL: int, AUTO_UPDATE: bool) -> None:
    '''Запуск Dotcoin'''

    if s_name() == 'Windows':
        sys(f'cls && title HPV Dotcoin - V{VERSION}')
    else:
        sys('clear')
    ...
    while True:
        ...
        def Start_Thread(Name: str, URL: str, Proxy: dict, Headers: dict) -> None:
            Dotcoin = HPV_Dotcoin(Name, URL, Proxy, Headers, COINS, MAX_CLICK_LVL, MAX_LIMIT_LVL, AUTO_UPDATE, Console_Lock)
            Dotcoin.Run()
