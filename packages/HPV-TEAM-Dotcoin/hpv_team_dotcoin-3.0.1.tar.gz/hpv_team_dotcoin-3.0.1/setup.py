...
setup(
    name='HPV_TEAM_Dotcoin',                            # Название вашего пакета
    version='3.0.1',                                    # Версия вашего пакета
    author='A_KTO_Tbl',                                 # Автор
    description='Многофункциональный, кроссплатформенный, многопоточный Dotcoin AutoBot, с поддержкой прокси и защитой от блокировок',   # Краткое описание
