...
def main():
    ...
    utils_parser_level_2_summary=utils_parser_level_2.add_parser("summary")
    utils_parser_level_2_summary.add_argument(
        "--path", type=str, help="path to view"
    )
    ...
    if x.level1 == "utils":
        ...
        elif x.level2 == "summary":
            val = x.path
            return print(thinkwareExtractor.utils.summary(val))
