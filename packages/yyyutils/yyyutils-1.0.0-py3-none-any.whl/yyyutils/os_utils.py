...
import shutil
import pandas
from data_structure_utils import StringUtils
...
if __name__ == '__main__':
    path = OSUtils.get_all_subdirectory_in_directory(r'/yyyutils')[0]
    p = [pa for pa in path if '__' not in pa]
    for item in p:
        OSUtils.add_files_to_directory(item, r'/yyyutils/__init__.py')
