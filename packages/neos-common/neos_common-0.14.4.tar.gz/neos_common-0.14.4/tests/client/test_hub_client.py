...
class TestHubClient:
    ...
    async def test_validate_token_with_return_resourse(self, httpx_mock, client):
        resources_payload = {
    ...
    async def test_validate_token_without_return_resourse(self, httpx_mock, client):
        resources_payload = {
            "principal_id": "user_id",
            "resources": [],
        }
    ...
    async def test_register_data_product(self, httpx_mock, client):
        httpx_mock.add_response(
            ...
            headers={"X-Access-Key": "core-access-key"},
            match_content=b'{"urn": "urn", "name": "name", "metadata": {"hello": "world"}, '
            b'"description": "description", "label": "ABC", "sanitized_name": "sanitized_name", '
            b'"data_product_type": "data_product_type", "engine": "engine", '
            b'"table": "table", "identifier": "identifier", "public": true}',
            json={},
        )
    ...
    async def test_register_private_data_product(self, httpx_mock, client):
        httpx_mock.add_response(
            ...
            b'"description": "description", "label": "ABC", "sanitized_name": "sanitized_name", '
            b'"data_product_type": "data_product_type", "engine": "engine", '
            b'"table": "table", "identifier": "identifier", "public": false}',
            json={},
        )
