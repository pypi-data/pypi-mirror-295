...
def lista_blocos(
    index: bool = False, formato: str = "dataframe"
...
def lista_partidos(
    inativos: bool = False, index: bool = False, formato: str = "dataframe"
) -> Union[pd.DataFrame, List[dict]]:
...
def lista_uso_palavra(
    ativos: bool = False, index: bool = False, formato: str = "dataframe"
) -> Union[pd.DataFrame, List[dict]]:
...
class Senador(DAB_Base):
    ...
    def cursos(self, formato: str = "dataframe") -> Union[pd.DataFrame, List[dict]]:
    ...
    def liderancas(self, formato: str = "dataframe") -> Union[pd.DataFrame, List[dict]]:
        """Obtém os cargos de liderança de um senador.
    ...
    def profissoes(self, formato: str = "dataframe") -> Union[pd.DataFrame, List[dict]]:
        """Obtém a(s) profissão(ões) de um senador.
