# Adapted from
# https://github.com/vllm-project/vllm/blob/e02ce498be2e11a165803d4590588ba98f129797/vllm/entrypoints/openai/protocol.py
import time
...
_LONG_INFO: Namespace = _MOCK_LONG_INFO


def random_uuid() -> str:
    """generate a random unique id from ASCII characters"""
