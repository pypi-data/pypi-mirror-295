...
_release_version: str = '0.4.32'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = '1594d2f30fdbfebf693aba4a2b264e4a3e52acc6'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.4.32'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = '1594d2f30fdbfebf693aba4a2b264e4a3e52acc6'"
