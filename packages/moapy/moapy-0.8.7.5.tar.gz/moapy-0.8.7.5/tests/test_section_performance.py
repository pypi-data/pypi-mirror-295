...
from moapy.data_pre import Material, Geometry, PMOptions, AxialForceOpt, AngleOpt, DgnCode, Lcom
...
def test_report_rc_cracked_stress():
    res = wgsd_oapi.report_rc_cracked_stress(Material(), Geometry(), DgnCode(), Lcom())
    return res
