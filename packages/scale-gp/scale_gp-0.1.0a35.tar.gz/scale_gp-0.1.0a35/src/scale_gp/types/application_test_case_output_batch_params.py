...
from .evaluation_datasets.flexible_chunks_param import FlexibleChunksParam
from .evaluation_datasets.flexible_messages_param import FlexibleMessagesParam
...
class ItemTraceSpan(TypedDict, total=False):
    ...
    operation_expected: Dict[
        str, Union[str, float, Iterable[FlexibleChunksParam], Iterable[FlexibleMessagesParam], Iterable[object], object]
    ]
