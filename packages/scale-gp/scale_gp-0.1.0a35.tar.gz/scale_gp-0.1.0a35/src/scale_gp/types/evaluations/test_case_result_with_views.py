...
from ..evaluation_datasets.flexible_chunks import FlexibleChunks
from ..evaluation_datasets.flexible_messages import FlexibleMessages
...
class FlexibleTestCaseResultResponseWithViewsTestCaseEvaluationData(BaseModel):
    generation_output: Union[
        ...
        float,
        List[FlexibleChunks],
        List[FlexibleMessages],
        List[object],
        Dict[str, Union[str, float, List[FlexibleChunks], List[FlexibleMessages], List[object], object]],
        object,
    ]
