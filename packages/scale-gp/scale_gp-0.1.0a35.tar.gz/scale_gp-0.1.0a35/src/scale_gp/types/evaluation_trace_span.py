...
class EvaluationTraceSpan(BaseModel):
    ...
    operation_input: Dict[str, Union[str, float, List[FlexibleChunks], List[FlexibleMessages], List[object], object]]
    """The JSON representation of the input that this step received."""

    operation_output: Dict[str, Union[str, float, List[FlexibleChunks], List[FlexibleMessages], List[object], object]]
