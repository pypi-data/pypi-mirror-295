...
from scale_gp.types.chat_completion_create_params import ModelParameters as ChatModelParameters
...
message = MessageEgpAPIBackendServerAPIModelsEgpModelsUserMessage(
