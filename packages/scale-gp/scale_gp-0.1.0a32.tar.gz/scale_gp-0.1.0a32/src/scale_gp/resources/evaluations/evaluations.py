...
class EvaluationsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        question_id_to_annotation_config: Dict[
            str, evaluation_create_params.EvaluationBuilderRequestQuestionIDToAnnotationConfig
        ]
        | NotGiven = NOT_GIVEN,
    ...
    def create(
        ...
        *,
        ...
        evaluation_config_id: str | NotGiven = NOT_GIVEN,
        question_id_to_annotation_config: Dict[
            str, evaluation_create_params.DefaultEvaluationRequestQuestionIDToAnnotationConfig
        ]
        | NotGiven = NOT_GIVEN,
        tags: object | NotGiven = NOT_GIVEN,
    ...
    def update(
        ...
        *,
        ...
        question_id_to_annotation_config: Dict[
            str, evaluation_update_params.PartialPatchEvaluationRequestQuestionIDToAnnotationConfig
        ]
        | NotGiven = NOT_GIVEN,
