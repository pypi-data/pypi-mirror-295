...
Added: It is now possible to extract an image by its name (ID name).

Added: Metrics now also accept NumPy arrays.

Added: Calculation of FPS in the metrics

### Changed:

Changed: New logic for utilizing the models (compatible for DataLoaders).
