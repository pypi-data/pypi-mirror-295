...
class DisplayProgressStatusTimer(object):
    __TEMPLATE = TemplateUtil.get_template('progress.html')
    ...
    def __init__(self, manager: ProgressStatusMonitorThread, interval):
        ...
        html_str = DisplayProgressStatusTimer.__TEMPLATE.render(executionId=self.manager.pal_obj.progress_indicator_id, frameId=self.frame_id)
