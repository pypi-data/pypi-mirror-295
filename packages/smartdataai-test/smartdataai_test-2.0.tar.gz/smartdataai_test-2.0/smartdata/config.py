...
class Config:
    ...
    PROMPT_CREATE_DATA_CLEAN_SUMMARY = """
        Summarize the data cleaning result in around 125 words for non-technical audience. Make sure use a friendly tone and use bullet points, and without any titles. Here is the result:
        {result}
        """
