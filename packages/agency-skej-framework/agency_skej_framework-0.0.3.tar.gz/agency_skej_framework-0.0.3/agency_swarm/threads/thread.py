...
thread_url_var = contextvars.ContextVar('thread_url_var',default=[])
...
class Thread:
    ...
    def get_completion(self,
        ...
        thread_url_array = thread_url_var.get()
        thread_url_array.append(self.thread_url)
        thread_url_var.set(thread_url_array)
