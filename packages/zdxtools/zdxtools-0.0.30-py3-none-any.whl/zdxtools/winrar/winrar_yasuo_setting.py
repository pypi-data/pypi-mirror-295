...
# 爱尚游戏库
aisData = {'comfilepath': 'F:\python\pyqt5\pypi_update\src\zdxtools\winrar\comment.txt',
           'add_file': other_add_file,
           'password': 'www.aisgame.xyz'}

CardData = {'comfilepath': 'F:\python\pyqt5\pypi_update\src\zdxtools\winrar\comment_card.txt',
