...
from vvallet import Vvallet, AsyncVvallet, APIResponseValidationError
from vvallet._models import BaseModel, FinalRequestOptions
from vvallet._constants import RAW_RESPONSE_HEADER
from vvallet._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from vvallet._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Vvallet | AsyncVvallet) -> int:
...
class TestVvallet:
    client = Vvallet(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(access_token="another Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...")
        assert copied.access_token == "another Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
        assert self.client.access_token == "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "vvallet/_legacy_response.py",
                        "vvallet/_response.py",
    ...
    def test_multipart_repeating_array(self, client: Vvallet) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(VVALLET_BASE_URL="http://localhost:5000/from/env"):
            client = Vvallet(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Vvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Vvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Vvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Vvallet(base_url=base_url, access_token=access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Vvallet(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    @mock.patch("vvallet._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/v1/createWallet").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/api/v1/createWallet",
                body=cast(object, dict(master_password="password123", network="base-sepolia")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/v1/createWallet").mock(return_value=httpx.Response(500))
    ...
    @mock.patch("vvallet._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retries_taken(self, client: Vvallet, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        respx_mock.post("/api/v1/createWallet").mock(side_effect=retry_handler)

        response = client.wallet.with_raw_response.create(master_password="password123", network="base-sepolia")

        assert response.retries_taken == failures_before_success


class TestAsyncVvallet:
    client = AsyncVvallet(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncVvallet) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(VVALLET_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncVvallet(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncVvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncVvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncVvallet) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncVvallet(base_url=base_url, access_token=access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncVvallet(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self, async_client: AsyncVvallet, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        response = await client.wallet.with_raw_response.create(master_password="password123", network="base-sepolia")
