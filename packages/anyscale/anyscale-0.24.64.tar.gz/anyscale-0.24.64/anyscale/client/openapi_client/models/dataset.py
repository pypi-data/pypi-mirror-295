...
class Dataset(object):
    ...
    def __init__(self, filename=None, description=None, name=None, project_id=None, id=None, creator_id=None, created_at=None, deleted_at=None, cloud_id=None, num_versions=None, local_vars_configuration=None):  # noqa: E501
