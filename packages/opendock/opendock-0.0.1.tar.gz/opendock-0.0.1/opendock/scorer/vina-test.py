...
class VinaSF(BaseScoringFunction):
    ...
    def scoring(self):
        ...
        vina = VinaScoreCore(self.vina_dist,
                             ...
                             self.rec_lig_is_hbond,
                             self.rec_lig_atom_vdw_sum)
        print("self.vina_dist",torch.sum(self.vina_dist))
        print("self.rec_lig_is_hydrophobic",torch.sum(self.rec_lig_is_hydrophobic))
        print("self.rec_lig_is_hbond,",torch.sum(self.rec_lig_is_hbond))
        print(" self.rec_lig_atom_vdw_sum",torch.sum( self.rec_lig_atom_vdw_sum))
        try:
