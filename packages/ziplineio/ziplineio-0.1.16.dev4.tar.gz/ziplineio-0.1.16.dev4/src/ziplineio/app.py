...
from ziplineio.utils import call_handler, parse_scope, read_body
...
class App:
    ...
    def get(self, path: str) -> Callable[[Handler], Callable]:
        def app_services_wrapper(handler: Handler) -> Callable:
    ...
    def wrap_app_services(self, handler: Handler) -> Callable:
        app_level_deps = self._injector.get_injected_services("app")
