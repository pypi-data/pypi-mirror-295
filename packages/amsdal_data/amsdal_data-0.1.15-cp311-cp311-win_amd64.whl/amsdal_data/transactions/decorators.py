...
def transaction(
    ...
    **transaction_kwargs: Any,
    ...
    def _transaction(func: Callable[P, R]) -> Transaction[P, R]:
        ...
        wrapper.submit = _submit_factory(func, transaction_kwargs)  # type: ignore[attr-defined]
...
def _submit_factory(func: Callable[P, R], transaction_kwargs: dict[str, Any]) -> Callable[P, None]:
