...
class ActiveMqBrokerEngineVersion(
    ...
    @jsii.member(jsii_name="V5_15_16")
    def V5_15_16(cls) -> "ActiveMqBrokerEngineVersion":
        '''
        :stability: experimental
        '''
        return typing.cast("ActiveMqBrokerEngineVersion", jsii.sget(cls, "V5_15_16"))
...
class BrokerDeploymentProps:
    def __init__(
        ...
        *,
        ...
        '''
        :param auto_minor_version_upgrade: (experimental) Determines whether the broker will undergo a minor version upgrade during the maintenance window. Default: - false. No minor version upgrade happens.
...
class IRabbitMqBroker(typing_extensions.Protocol):
    '''
    :stability: experimental
    '''
...
class IRabbitMqBrokerDeployment(
...
class RabbitMqBrokerDeploymentProps(BrokerDeploymentProps):
    def __init__(
        ...
        *,
        ...
        :param vpc: (experimental) The VPC in which create the communication endpoints for a private broker. Default: - undefined. A default VPC will be used
        :param vpc_subnets: (experimental) vpcSubnets and vpc are optional. But when present - publiclyAccessible attribute must equal false. Default: - undefined. If vpc is present - this attribute must be present.
        :param admin: (experimental) Sets the credentials of the broker administrative user.
    ...
    def admin(self) -> Admin:
        '''(experimental) Sets the credentials of the broker administrative user.
...
class RabbitMqBrokerEngineVersion(
    ...
    @jsii.python.classproperty
    @jsii.member(jsii_name="V3_10_20")
    def V3_10_20(cls) -> "RabbitMqBrokerEngineVersion":
        '''
        :stability: experimental
        '''
        return typing.cast("RabbitMqBrokerEngineVersion", jsii.sget(cls, "V3_10_20"))
    ...
    @jsii.python.classproperty
    @jsii.member(jsii_name="V3_8_34")
    def V3_8_34(cls) -> "RabbitMqBrokerEngineVersion":
        '''
        :stability: experimental
        '''
        return typing.cast("RabbitMqBrokerEngineVersion", jsii.sget(cls, "V3_8_34"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="V3_9_27")
    def V3_9_27(cls) -> "RabbitMqBrokerEngineVersion":
        '''
        :stability: experimental
        '''
        return typing.cast("RabbitMqBrokerEngineVersion", jsii.sget(cls, "V3_9_27"))
...
class IActiveMqBrokerDeployment(
    _aws_cdk_ceddda9d.IResource,
    IBrokerDeployment,
    typing_extensions.Protocol,
):
...
@jsii.implements(IRabbitMqBroker)
class RabbitMqBrokerInstance(
    RabbitMqBrokerDeploymentBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdklabs/cdk-amazonmq.RabbitMqBrokerInstance",
):
    '''(experimental) A representation of a single-instance broker comprised of one broker in one Availability Zone behind a Network Load Balancer (NLB).
...
@jsii.implements(IActiveMqBroker)
