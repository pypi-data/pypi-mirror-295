...
class CrashLog:
	def __init__(self, filename, bVerbose=True, sLOG_FILE=None, IGNORE=None, KNOWN_LOGGERS=None, KNOWN_APPS=None):
		...
		self.Stack_Call = _Section("Stack", None)
		self.Call = _Section("Call", None)
		self.Plugins = _Section("Plugin", None)
		#self.Plugins_XSE = _Section()	# too game specific?
		self.Registers = _Section("Register", None)
		self.Modules = _Section("Module", None)
		self.SystemSpec = _SectionSystemSpec("System", None)
