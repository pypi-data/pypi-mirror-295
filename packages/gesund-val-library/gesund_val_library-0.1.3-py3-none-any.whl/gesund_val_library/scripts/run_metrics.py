...
import json
import bson
from gesund_val_library.utils.io_utils import read_json, validate_json_format
from gesund_val_library.metrics.classification.create_validation import ValidationCreation
import os
...
def main():
    ...
    if args.output:
        try:
            ...
            print(f"Could not save validation metrics because: {e}")
