...
from ..metrics.stats_tables import StatsTables
from ....utils.validation_data_utils import ValidationUtils
...
class PlotStatsTables:
    ...
    def tp_tn_fp_fn(self, target_class=None, target_attribute_dict=None):
        ...
        :return: payload_dict
        """
        filtered_meta_pred_true = self.filter_attribute_by_dict(target_attribute_dict)
