...
from ..processing import BatchMode, concat_webtoon
from ..processing import add_viewer as add_viewer_
...
from ..processing._webtoon import platforms
    ...
    async def async_download_webtoon(
        ...
        if concat is not None:
            with self._send_context_callback_message(
                ...
                webtoon_directory = concat_webtoon(webtoon_directory, None, concat, rebuild_webtoon_viewer=False, use_progress_bar=self.use_progress_bar)
