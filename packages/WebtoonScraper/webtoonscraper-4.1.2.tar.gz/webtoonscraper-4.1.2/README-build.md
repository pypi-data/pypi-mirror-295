...
실행 파일을 이용하면 여러 웹툰을 다운로드받을 때 훨씬 빠르게 다운로드가 가능하며,
파이썬 설치나 pip를 다룰 필요 없이 다운로드한 뒤 바로 사용이 가능합니다.
또한 네이버 웹툰과 레진코믹스와 더불어 webtoons.com, 버프툰, 네이버 포스트, 네이버 게임, 카카오페이지, 네이버 블로그, 티스토리, 카카오 웹툰을 추가로 다운로드받을 수 있습니다.
...
[![](https://github.com/ilotoki0804/WebtoonScraper/blob/main/images/patron.png)](https://www.patreon.com/ilotoki0804)
