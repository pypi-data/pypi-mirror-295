...
from immunity_notifications.api.serializers import NotificationListSerializer
from immunity_notifications.signals import notify
from immunity_notifications.swapper import load_model
from immunity_notifications.tests.test_helpers import TEST_DATETIME
from immunity_notifications.websockets.consumers import NotificationConsumer
...
class TestNotificationSockets:
    ...
    async def test_retreive_object_notification_valid_till(
        ...
        with patch('immunity_notifications.tasks.delete_ignore_object_notification'):
