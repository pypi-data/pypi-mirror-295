...
- Fixed `hardcoded static image URLs
  <https://github.com/openwisp/immunity-notifications/issues/243>`_. These
...
- Fixed `"Organization.DoesNotExist" error on creating a new organization
  <https://github.com/openwisp/immunity-notifications/issues/238>`_.
...
- Fixed `handling of the "IMMUNITY_NOTIFICATIONS_SOUND" setting
  <https://github.com/openwisp/immunity-notifications/issues/239>`_. The
...
- Introduced mechanism to `clear cache on specific signals
  <https://github.com/openwisp/immunity-notifications#cache-invalidation>`_
...
- Fixed extensibility of immunity-users: removed immunity-users as a
  direct dependency from migrations file because it was creating issues
  when extending immunity-users
...
- Added possibility of `silencing notifications for specific objects \
  ...
  <https://github.com/openwisp/immunity-notifications#silencing-notifications-for-specific-objects-temporarily-or-permanently>`_
