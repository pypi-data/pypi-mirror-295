...
class BaseTestAdmin(TestMultitenantAdminMixin, TestCase):
    ...
    def _expected_output(self, count=None):
        ...
        return 'id="immunity_notifications">'
...
class TestAdmin(BaseTestAdmin):
    ...
    def test_non_zero_notifications(self):
        patched_function = 'immunity_notifications.templatetags.notification_tags._get_user_unread_count'
    ...
    def test_default_notification_setting(self):
        ...
        self.assertContains(
            res, '/static/immunity-notifications/audio/notification_bell.mp3'
        )
    ...
    def test_org_admin_view_same_org_user_notification_setting(self):
        ...
        response = self.client.get(
            reverse('admin:immunity_users_user_change', args=(org_admin.user_id,)),
        )
    ...
    def test_ignore_notification_widget_add_view(self):
        url = reverse('admin:immunity_users_organization_add')
...
class TestAdminMedia(BaseTestAdmin):
    ...
    def test_object_notification_setting_empty(self):
        ...
        self.assertNotContains(
            response, 'src="/static/immunity-notifications/js/object-notifications.js"'
        )

    @override_settings(
        IMMUNITY_NOTIFICATIONS_IGNORE_ENABLED_ADMIN=['immunity_users.admin.UserAdmin'],
    )
    def test_object_notification_setting_configured(self):
        ...
        self.assertContains(
            response,
            'src="/static/immunity-notifications/js/object-notifications.js"',
            1,
        )
