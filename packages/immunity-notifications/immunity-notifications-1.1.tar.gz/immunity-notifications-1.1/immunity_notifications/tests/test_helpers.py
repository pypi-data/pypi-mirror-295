...
from immunity_notifications.tasks import ns_register_unregister_notification_type
from immunity_notifications.types import NOTIFICATION_CHOICES, NOTIFICATION_TYPES
...
def mock_notification_types(func):
    ...
    def wrapper(*args, **kwargs):
        with patch.multiple(
            ...
            from immunity_notifications import types
