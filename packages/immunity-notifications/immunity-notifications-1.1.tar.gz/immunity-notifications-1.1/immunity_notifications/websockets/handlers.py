...
from immunity_notifications.api.serializers import NotFound, NotificationListSerializer
from immunity_notifications.utils import normalize_unread_count
...
def user_in_notification_storm(user):
    ...
    "IMMUNITY_NOTIFICATIONS_NOTIFICATION_STORM_PREVENTION" setting.
