...
def _execute_bql_str_list_async_orig(
    ...
    with bql_service.BQL_LOCK:
        ...
        logger.debug("Waiting for and processing BQL results")
...
def harmonize_and_concat_arrow_tables(tables):
...
def _to_data_arrow(response) -> DataFrame:  # type: ignore
