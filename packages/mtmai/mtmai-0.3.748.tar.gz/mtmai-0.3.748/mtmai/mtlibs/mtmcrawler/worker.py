...
from mtmai.models.mtmcrawl import MTCrawlPage
...
class CrawlWorker:
    def __init__(self, mq: AsyncPGMQueue, db: Session):
        self.mq = mq
        self.db = db
