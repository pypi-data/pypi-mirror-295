...
def asset_price_and_volume_graph(start_date: datetime, end_date: datetime, asset: str):
    price_df = srs.get_prices_assets_historical(asset=asset, start_date=start_date, end_date=end_date, time_interval=TimeInterval.MINUTE, time_format=TimeFormat.MS)
