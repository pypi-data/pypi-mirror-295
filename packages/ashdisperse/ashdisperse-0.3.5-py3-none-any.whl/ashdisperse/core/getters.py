...
@jit(float64[::1](float64[::1], float64, float64, float64, float64), nopython=True, cache=True, fastmath=True)
def Source_z_dimless(z, Suzuki_k, lower, upper, H):
...
def Source_z_dimless_value(z, Suzuki_k, lower, upper, H):
...
@jit(
    float64[::1](float64[::1], float64, float64, float64),
    nopython=True,
    cache=True,
    fastmath=True,
)
def Source_z(z, Suzuki_k, lower, upper):
...
def Source_z_value(z, Suzuki_k, lower, upper):
