import time
import re
from scrapeanything.utils.webscraper import Props, Types
from scrapeanything.utils.types import TypeUtils
from scrapeanything.utils.webscraper import Functions
...
class Scraper:
    ...
    def xPath(self, path: str, element: any=None, pos: int=0, dataType: str=None, prop: str=None, explode=None, condition=None, substring=None, transform=None, replace=None, join=None, timeout: int=0, is_error: bool=True, sleep_before: int=0, sleep_after: int=0):
        ...
        elif isinstance(el, list) == True and dataType == TypeUtils.LIST:
