...
class Scraper:
    ...
    def xPath(self, path: str, element: any=None, pos: int=0, data_type: str=None, prop: str=None, explode=None, condition=None, substring=None, transform=None, replace=None, join=None, timeout: int=0, is_error: bool=True, sleep_before: int=0, sleep_after: int=0):
        ...
        elif isinstance(el, list) == True and data_type == TypeUtils.LIST:
