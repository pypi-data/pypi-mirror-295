...
def lebanon_passport_extraction(passport_text):
        ...
        if gender_match:
            ...
            if re.search(r'ذكر', passport_text) or re.search(r'ذکر', passport_text):
                ...
                if passport_details.get('first_name_mrz'):
                    ...
                    passport_details['gender'] = 'MALE' if predicted_gender.lower() == 'male' else 'F' if predicted_gender.lower() == 'FEMALE' and predicted_gender != 'unknown' else translated_gender_identifier(passport_text)
    ...
    if passport_details.get('gender', ''):
        gender_mapping = {'M': 'MALE', 'F': 'FEMALE'}
        passport_details['gender'] = gender_mapping.get(passport_details['gender'], '')
