...
def data_comparison_check(data, country):
    ...
    if user_data and (country!='LBN' or country!='SDN'):
...
def main_details(data, country):
    ...
    try:
        ...
        if country == 'IRQ' or country == 'LBN' or country == 'QAT' or country == 'SDN':
            if country == 'IRQ':
                main_prop_data = {}
                if data.get('doc_type') == 'passport':
            ...
            if country == 'LBN':
                ...
                if data.get('doc_type') == 'passport':
                    keys = ['first_name', 'father_name', 'mother_name', 'last_name', 'id_number', 'issue_date', 'mrz', 'issuing_country']
                else:
                    ...
                    keys = ['name', 'first_name', 'father_name', 'last_name', 'gender_ar', 'place_of_birth', 'issue_date', 'issue_date_ar', 'card_number_ar', 'id_number_ar', 'issuing_country']
