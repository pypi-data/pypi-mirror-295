...
_AbroadStringInitializer = tc.AbroadInitializer[str]
_AbroadFloatyInitializer = tc.AbroadInitializer[float]
...
class _AbroadHexMode(tc.IntegerFlag):
...
class NennaiAbroads:
    ...
    def abroadLive(self, *values: _AbroadLiveType[_T]) -> _AbroadInitializer:
        ...
        return ret
    @_cm
    def abroadFloaty(self, value1: _AbroadValue1[_T1], /, value2: _AbroadValue2[_T2] = None, modifier: _AbroadModifier[_T3] = None, div: tc.FloatOrInteger = 10) -> _AbroadFloatyInitializer:
        """
        \\@since 0.3.25 \\
        \\@author Aveyzan
        ```ts \\
    ...
    def abroadEach(self, value1: _AbroadValue1[_T1], /, value2: _AbroadValue2[_T2] = None, modifier: _AbroadModifier[_T3] = None, each: _AbroadEachType[_T] = None) -> _AbroadIntFloatInitializer[_T]:
        ...
        return a
    @_cm
    def abroadHex(self, value1: _AbroadValue1[_T1], /, value2: _AbroadValue2[_T2] = None, modifier: _AbroadModifier[_T3] = None, mode: _AbroadHexModeType = ABROAD_HEX_INCLUDE) -> _AbroadStringInitializer:
        """
        \\@since 0.3.25 \\
        \\@author Aveyzan
        ```ts \\
        ...
        Modes (for 0.3.26rc2):
        - `0 / self.INCLUDE` - appends `0x` to each string. It faciliates casting to integer.
        - `1 / self.INCLUDE_HASH` - appends `#` to each string. Reference from CSS.
        - `2 / self.EXCLUDE` - nothing is appended.
        """
        a: list[str] = []
        for i in abroad(value1, value2, modifier):
...
class _SanitizeMode(tc.IntegerFlag):
...
class NennaiStringz:
    ...
    @_cm
    def sanitize(self, string: str, /, mode: _SanitizeModeType = SANITIZE_AROUND):
        """
        \\@since 0.3.25 (experimental) \\
        \\@author Aveyzan
        ```ts \\
