...
class DocumentGroupingCategory(sgqlc.types.Enum):
    __schema__ = api_schema
    __choices__ = ('account', 'accountCountry', 'documentLanguage', 'marker', 'platform', 'platformCountry', 'platformLanguage', 'platformType', 'publicationAuthor')
...
class EntityGroupingCategory(sgqlc.types.Enum):
    __schema__ = api_schema
    __choices__ = ('concept', 'conceptLinkType', 'conceptPropertyType', 'conceptPropertyValue', 'conceptType')
...
class ConceptGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('concept', 'count', 'name')
    concept = sgqlc.types.Field(sgqlc.types.non_null('Concept'), graphql_name='concept')
...
class ConceptLinkTypeGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('concept_link_type', 'count', 'name')
    concept_link_type = sgqlc.types.Field(sgqlc.types.non_null('ConceptLinkType'), graphql_name='conceptLinkType')
    count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='count')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class ConceptPropertyTypeGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('concept_property_type', 'count', 'name')
...
class ConceptPropertyValueGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('concept_property_type', 'count', 'name', 'concept_property_value')
    concept_property_type = sgqlc.types.Field(sgqlc.types.non_null('ConceptPropertyType'), graphql_name='conceptPropertyType')
    count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='count')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class ConceptTypeGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('concept_type', 'count', 'name')
...
class DocumentAccountGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('account', 'count', 'name')
...
class DocumentGroupByCategoryFacets(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('grouping_category', 'document_group_facets')
    grouping_category = sgqlc.types.Field(sgqlc.types.non_null(DocumentGroupingCategory), graphql_name='groupingCategory')
    document_group_facets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('DocumentGroupFacetUnion'))), graphql_name='documentGroupFacets')
...
class DocumentPlatformGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('platform', 'count', 'name')
    platform = sgqlc.types.Field(sgqlc.types.non_null('Platform'), graphql_name='platform')
    count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='count')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')


class DocumentPlatformTypeGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('platform_type', 'count', 'name')
    platform_type = sgqlc.types.Field(sgqlc.types.non_null(PlatformType), graphql_name='platformType')
    count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='count')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')


class DocumentPropertyGroupFacet(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('value', 'count', 'name')
    value = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='value')
    count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='count')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class EntityGroupByCategoryFacets(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('grouping_category', 'entity_group_facets')
    grouping_category = sgqlc.types.Field(sgqlc.types.non_null(EntityGroupingCategory), graphql_name='groupingCategory')
    entity_group_facets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('EntityGroupFacetUnion'))), graphql_name='entityGroupFacets')
...
class Mutation(sgqlc.types.Type):
    ...
    update_story_pagination_facets = sgqlc.types.Field(sgqlc.types.non_null('StoryPaginationFacets'), graphql_name='updateStoryPaginationFacets', args=sgqlc.types.ArgDict((
...
class StoryPagination(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('list_story', 'list_story_pagination_facets', 'total', 'show_total', 'list_named_entity_count_facet', 'list_concept_count_facet', 'list_account_count_facet', 'list_platform_count_facet', 'list_markers', 'sources', 'new_documents_today', 'precise_total')
    list_story = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Story))), graphql_name='listStory')
    list_story_pagination_facets = sgqlc.types.Field(sgqlc.types.non_null('StoryPaginationFacets'), graphql_name='listStoryPaginationFacets')
    total = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='total')
    show_total = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='showTotal')
    list_named_entity_count_facet = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Facet))), graphql_name='listNamedEntityCountFacet')
    list_concept_count_facet = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(ConceptFacet))), graphql_name='listConceptCountFacet')
...
class StoryPaginationFacets(sgqlc.types.Type):
    __schema__ = api_schema
    __field_names__ = ('document_metadata_facets', 'approved_entities_facets', 'not_approved_entities_facets', 'calculated_at')
    document_metadata_facets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(DocumentGroupByCategoryFacets))), graphql_name='documentMetadataFacets')
    approved_entities_facets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(EntityGroupByCategoryFacets))), graphql_name='approvedEntitiesFacets')
    not_approved_entities_facets = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(EntityGroupByCategoryFacets))), graphql_name='notApprovedEntitiesFacets')
    calculated_at = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='calculatedAt')
...
class DocumentGroupFacetUnion(sgqlc.types.Union):
    __schema__ = api_schema
    __types__ = (DocumentPropertyGroupFacet, DocumentPlatformGroupFacet, DocumentPlatformTypeGroupFacet, DocumentAccountGroupFacet)
...
class EntityGroupFacetUnion(sgqlc.types.Union):
    __schema__ = api_schema
    __types__ = (ConceptTypeGroupFacet, ConceptGroupFacet, ConceptPropertyTypeGroupFacet, ConceptLinkTypeGroupFacet, ConceptPropertyValueGroupFacet)
