...
about the relevant electronic structure problem
together with all the operators and performs all the necessary operations
like active space transformations etc.
"""
...
class ProblemSet:
    ...
    def __init__(
        ...
        self._two_body_exc_op_full: Union[list[list[list[list[FermionicOp]]]], None] = (
            None
        )
    ...
    def get_qubit_hamiltonian_nuclear_derivative_op(
        ...
        if None in self._qubit_ham_nuc_deriv_op[atom_moved]:
            self._construct_hamiltonian_nuc_deriv_op(atom_moved)
    ...
    def _construct_hamiltonian_nuc_deriv_op(self, atom_moved):
