...
def lazy_import():
    from pinecone_plugins.assistant.data.core.client.model.search_completions_messages import SearchCompletionsMessages
    globals()['SearchCompletionsMessages'] = SearchCompletionsMessages
...
class SearchCompletions(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'messages': ([SearchCompletionsMessages],),  # noqa: E501
    ...
    def _from_openapi_data(cls, messages, *args, **kwargs):  # noqa: E501
        ...
        Args:
            messages ([SearchCompletionsMessages]):
        ...
        Keyword Args:
            ...
            stream (bool): [optional] if omitted the server will use the default value of False  # noqa: E501
        """
