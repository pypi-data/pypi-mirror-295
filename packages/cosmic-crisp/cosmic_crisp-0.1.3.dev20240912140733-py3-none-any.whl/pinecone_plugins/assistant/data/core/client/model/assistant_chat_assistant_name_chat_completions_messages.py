...
class AssistantChatAssistantNameChatCompletionsMessages(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AssistantChatAssistantNameChatCompletionsMessages - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            role (str): The role of the entity generating the message: 'user' for a prompt to the assistant or 'assistant' for a response.. [optional]  # noqa: E501
            content (str): The contents of the message. This field must not be empty.. [optional]  # noqa: E501
        """
