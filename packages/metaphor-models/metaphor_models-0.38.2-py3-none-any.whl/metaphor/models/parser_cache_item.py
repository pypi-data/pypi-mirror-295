...
class Species17760___ToStringTag6911(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_17760: Optional['SharedArrayBuffer'] = None
    to_string_tag_6911: Optional[Species17760___ToStringTag6911] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_17760 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@17760"))
        to_string_tag_6911 = from_union([Species17760___ToStringTag6911, from_none], obj.get("__@toStringTag@6911"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_17760, to_string_tag_6911, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_17760 is not None:
            result["__@species@17760"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_17760)
        if self.to_string_tag_6911 is not None:
            result["__@toStringTag@6911"] = from_union([lambda x: to_enum(Species17760___ToStringTag6911, x), from_none], self.to_string_tag_6911)
...
class ArrayBufferLike:
    to_string_tag_6911: Optional[str] = None
    byte_length: Optional[float] = None
    species_17760: Optional[SharedArrayBuffer] = None
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        assert isinstance(obj, dict)
        to_string_tag_6911 = from_union([from_str, from_none], obj.get("__@toStringTag@6911"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_17760 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@17760"))
        return ArrayBufferLike(to_string_tag_6911, byte_length, species_17760)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_6911 is not None:
            result["__@toStringTag@6911"] = from_union([from_str, from_none], self.to_string_tag_6911)
        if self.byte_length is not None:
            result["byteLength"] = from_union([to_float, from_none], self.byte_length)
        if self.species_17760 is not None:
            result["__@species@17760"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_17760)
...
class ID:
    ...
    to_string_tag_6911: Optional[IDToStringTag6911] = None
    ...
    def from_dict(obj: Any) -> 'ID':
        assert isinstance(obj, dict)
        to_string_tag_6911 = from_union([IDToStringTag6911, from_none], obj.get("__@toStringTag@6911"))
        ...
        return ID(to_string_tag_6911, buffer, byte_length, byte_offset, bytes_per_element, length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_6911 is not None:
            result["__@toStringTag@6911"] = from_union([lambda x: to_enum(IDToStringTag6911, x), from_none], self.to_string_tag_6911)
...
class MapStringString:
    ...
    def from_dict(obj: Any) -> 'MapStringString':
        ...
        to_string_tag_6911 = from_union([from_str, from_none], obj.get("__@toStringTag@6911"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_6911, size)
