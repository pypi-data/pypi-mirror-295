...
class Test_generate:
    ...
    def test_generate_in_file_with_n_option(self) -> None:
        ...
        result = runner.invoke(
            api_key_factory.cli, ["generate", "-d", "tmp_test", "-n", "3"]
        )
        assert result.exit_code == 0
        out = result.stdout
        output = out.splitlines()
    ...
    def test_generate_file_with_num_option(self) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(
            api_key_factory.cli, ["generate", "-d", "tmp_test", "--num", "3"]
        )
        assert result.exit_code == 0
        out = result.stdout
        output = out.splitlines()
    ...
    def test_generate_file_with_p_option(self) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(
            api_key_factory.cli, ["generate", "-d", "tmp_test", "-p", "test"]
        )
        assert result.exit_code == 0
        out = result.stdout
        output = out.splitlines()
    ...
    def test_generate_file_with_prefix_option(self) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(
            api_key_factory.cli, ["generate", "-d", "tmp_test", "--prefix", "test"]
        )
        assert result.exit_code == 0
        out = result.stdout
        output = out.splitlines()
    ...
    def test_generate_file_with_blank_prefix_option(self) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(
            api_key_factory.cli, ["generate", "-d", "tmp_test", "--prefix", ""]
        )
        assert result.exit_code == 0
        out = result.stdout
        output = out.splitlines()
