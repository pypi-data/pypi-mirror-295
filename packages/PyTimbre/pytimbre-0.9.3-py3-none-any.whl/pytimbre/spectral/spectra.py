...
class SpectrumByCochleagram(Spectrum):
    """
    This class encapsulates the calculation and use of the cochleagram as found in the McDermott lab at MIT. It will
    inherit from the Spectrum object to assist with the continuity across the PyTimbre classes.
    """

    def __init__(self, a: Waveform):
        super().__init__(a)

    def _calculate_spectrum(self):
        """
        This creates the cochleagram function and determines the spectral shape based on this set of filters.
        """

        filter_bank = cgram.human_cochleagram(
            signal=self.waveform.samples,
            sr=self.sample_rate,
            ret_mode='all',
            n=10
        )
