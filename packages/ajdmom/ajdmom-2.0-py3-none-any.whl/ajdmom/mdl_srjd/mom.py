"""
Conditional moments for SRJD model
"""
import math
...
def int_e_poly(i, poly):
    """integral of :math:`\int_0^t e^{iks} poly ds`
...
def int_e_IE(i, m, IE):
    """Integral of :math:`\int_0^t e^{iks} I\!E_s^m ds`
...
def int_e_IEZ_IE(m, IE):
    """Integral of :math:`\int_0^t e^{ks} I\!E\!Z_s I\!E_s^m ds`
...
def recursive_IE(m, IE):
    """Recursive step in equation :eq:`srjd-IE-moment`
...
def moment_IE(m):
    """:math:`\mathbb{E}[I\!E_t^m|v_0, z(s), 0\le s\le t]`
...
def moment_v(m):
    """conditional moment :math:`\mathbb{E}[v_t^m|v_0, z(s), 0\le s\le t]`
...
##########
def fZ(l, o, k, s, J):
    """function :math:`f_{Z_t}(l_{1:n},o_{1:n})` as defined in :eq:`fZ_IE`
