...
########################################
    ...
    def __get_descriptions(self):
        ...
        response = self.api_client._TenantAPI__run_get("/episteme-svcs/descriptions", params=params)
        return response.json()
    ...
    def __get_questions(self):
        ...
        response = self.api_client._TenantAPI__run_get("/episteme-svcs/questions")
