...
class Bow:
    ...
    def upsert_jobs(self, jobs: List[Dict[str, Any]], upsert_batch_size: Optional[int] = None) -> Dict[str, str]:
        return self._make_request("POST", "upsert_jobs", data={"jobs": jobs, "upsert_batch_size": upsert_batch_size})
