...
def custom_json_loads(json_str: str) -> dict:
    return json.loads(json_str, object_hook=_json_deserializer) if json_str else json_str

def custom_json_dumps(json_obj: dict) -> str:
    return json.dumps(json_obj, default=_json_serializer)
