...
from iikoserver_api.schemas.inventory import Inventory
...
class IikoServerApi:
    ...
    def export_incoming_service(self, from_date: datetime = datetime.now() - timedelta(days=30), to_date: datetime = datetime.now()):
        params = {
            'key': self.token,
            'reportType': 'TRANSACTIONS'
        }
    ...
    def export_outgoing_service(self, from_date: datetime = datetime.now() - timedelta(days=30), to_date: datetime = datetime.now() + timedelta(days=1)):
        params = {
            'key': self.token,
            'reportType': 'TRANSACTIONS'
        }
...
if __name__ == '__main__':
    with IikoServerApi('https://tutto.iiko.it/resto/api/', 'rsinfo', '5E6MYvS2KO') as api:
        data = api.export_incoming_service()
        print(data)
        # data = api.export_incoming_service()
        # print(json.dumps(data))

    # with IikoServerApi('https://corex-demo.iiko.it/resto/api/', 'rsinfo', 'dVs4PBaoqu') as api:
