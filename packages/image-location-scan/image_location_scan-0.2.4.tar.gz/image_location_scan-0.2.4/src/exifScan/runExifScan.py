...
class ExifScanner:
    ...
    def __init__(self, WorkDirectory=None, MetashapeDirectory=None, KartDirectory=None, KartRemote=None,
                 ...
                 groupByTags=["Make", "Model"], xyTagNames=['GPSLongitude', 'GPSLatitude'], zTagName='GPSAltitude',
                 imageFileExtensions=['JPG'], metashapeCacheTime=120, stats={'Scan Started at': "", }, linzAPIKey=None
                 ):
        ...
        self.stats = stats
        self.kart_writer = KartWriter(self.KartDirectory, self.OutputGeopackagePath, self.KartRemote)
