...
def getArgs():
    ...
    parser.add_argument("--groupByTags", nargs='+', help="List of tags to group by", default=["Make", "Model"])
...
def main():
    ...
    if enable_dualLogging:
        ...
        dualLogging.set_up_logging(console_log_output="stdout", console_log_level="info", console_log_color=True,
