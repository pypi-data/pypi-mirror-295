...
def test_updateHTML(html_writer, setup_test_environment, caplog):
    ...
    assert headers[5].string == 'index'
    # Each row had a th for some reason?
    assert headers[6].string == '0'
    assert headers[7].string == '1'
    ...
    assert rows[1].find_all('td')[4].string == '0'
    ...
    assert rows[2].find_all('td')[4].string == '1'
    ...
    assert rows[3].find_all('td')[4].string == '2'
    ...
    script_content_5 = soup.findAll('script')[13].string
    ...
    script_content_6 = soup.findAll('script')[14].string
    ...
    assert rows[1].find_all('td')[2].string == 'EOS'
    assert rows[1].find_all('td')[3].string == '1'
    assert rows[1].find_all('td')[4].string == 'None'
    assert rows[1].find_all('td')[5].string == '0'
    assert rows[2].find_all('td')[0].string == 'dir2'
    assert rows[2].find_all('td')[1].string == 'Nikon'
    assert rows[2].find_all('td')[2].string == 'D850'
    assert rows[2].find_all('td')[3].string == '2'
    assert rows[2].find_all('td')[4].string == 'None'
    ...
    assert rows[1].find_all('td')[4].string == 'Historical Aerial Imagery'
    assert rows[1].find_all('td')[5].string == '2'
