...
def add_default_workspace_responder(api_endpoint="http://api-lb:8080", workspace_name="345fr"):
    responses.add(
        responses.POST,
...
def add_get_workspace_by_id_responder(api_endpoint="http://api-lb:8080"):
    responses.add(
        responses.POST,
        f"{api_endpoint}/v1/graphql",
        status=200,
...
def add_get_pipeline_by_id_responder(api_endpoint="http://api-lb:8080"):
    responses.add(
        responses.POST,
        f"{api_endpoint}/v1/graphql",
        status=200,
...
def add_pipeline_variant_by_id_responder(api_endpoint="http://api-lb:8080"):
    responses.add(
        responses.POST,
        f"{api_endpoint}/v1/graphql",
        status=200,
...
def add_deployment_status_responder(
    api_endpoint="http://api-lb:8080", deployment_name="test_deployment", status=status_samples.RUNNING
):
...
def add_deployment_by_id_responder(api_endpoint="http://api-lb:8080", deployment_id=1, deployment_name="some-pipeline"):
    responses.add(
        responses.POST,
        f"{api_endpoint}/v1/graphql",
        status=200,
...
def add_get_workspace_by_id_responder(api_endpoint="http://api-lb:8080", workspace_id=1):
    responses.add(
        responses.POST,
        f"{api_endpoint}/v1/graphql",
        status=200,
...
def add_list_models_responder(respx_mock, api_endpoint, request_dict, response_dict):
    respx_mock.post(f"{api_endpoint}/v1/api/models/list",
                    json=request_dict).mock(
