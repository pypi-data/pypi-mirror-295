...
class TestPipelineConfig:
    ...
    def mlflow_model(self, input_schema, output_schema, variant="primary", runtime="mlflow"):
    ...
    def test_fixed_tensor(self, snapshot):
        ...
        output_schema = pa.schema([pa.field("tensor_o", pa.fixed_shape_tensor(pa.float32(), [4, 4]))])
