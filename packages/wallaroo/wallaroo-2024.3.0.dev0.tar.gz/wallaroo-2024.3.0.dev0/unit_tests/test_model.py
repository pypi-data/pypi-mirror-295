...
from .reusable_responders import (
    add_default_workspace_responder, add_list_models_responder,
)
...
class TestModel(unittest.TestCase):
    ...
    def test_list_models(self, respx_mock):
        ...
        self.assertEqual(models[0].name(), model_dict_1["name"])
        self.assertEqual(models[0].id(), model_dict_1["id"])
        self.assertEqual(models[0].owner_id(), model_dict_1["owner_id"])
