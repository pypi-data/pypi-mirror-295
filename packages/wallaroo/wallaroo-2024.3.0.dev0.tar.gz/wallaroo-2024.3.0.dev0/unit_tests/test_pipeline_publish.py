...
class TestPipelinePublish(unittest.TestCase):
    ...
    def test_wait_for_status_published(self, respx_mock):
        ...
        self.assertEqual(result.status, PipelinePublishStatus.PUBLISHED)
    ...
    def test_wait_for_status_error(self, respx_mock):
        ...
        with self.assertRaises(Exception):
            ...
            self.assertEqual(result.status, PipelinePublishStatus.ERROR)
            self.assertEqual(expected_string, res)
