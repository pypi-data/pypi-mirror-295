...
class Detector:
    ...
    noise_level: Optional[float] = 0.05  # Noise level (in volts)
    baseline_shift: Optional[float] = 0.01  # Baseline shift (in volts)
    saturation_level: Optional[float] = 1e3  # Saturation level (in volts)
