...
class Minkowski(Distance):
	...
	def compute(self,point1, point2, p):
		"""
...
class KendallTau(Distance):
	...
	def compute(self,permutation1, permutation2):
		"""
...
class Yule(Distance):
	...
	def compute(self,binary_vector1, binary_vector2):
		"""
...
class Gower(Distance):
	...
	def __init__(self):
		super().__init__(self,ranges=None)
		self.ranges=ranges
	def compute(self, vec1, vec2):
		...
		"""
		if len(vec1) != len(vec2) or len(vec1) != len(self.ranges):
...
class Wasserstein(Distance):
    ...
    def compute(self, distribution1, distribution2):
        """
