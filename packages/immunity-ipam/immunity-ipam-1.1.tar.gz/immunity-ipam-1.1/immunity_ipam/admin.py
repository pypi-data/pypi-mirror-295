...
class SubnetAdmin(
    ...
    app_label = 'immunity_ipam'
    change_form_template = 'admin/immunity-ipam/subnet/change_form.html'
    change_list_template = 'admin/immunity-ipam/subnet/change_list.html'
    list_display = [
        'name',
        'organization',
        'subnet',
    ...
    def import_view(self, request):
        ...
        form_template = 'admin/immunity-ipam/subnet/import.html'
    ...
    class Media:
        js = (
            ...
            'immunity-ipam/js/subnet.js',
            'immunity-ipam/js/minified/jstree.min.js',
            'immunity-ipam/js/minified/plotly.min.js',
        )
        css = {
            'all': (
                'immunity-ipam/css/admin.css',
                'immunity-ipam/css/minified/jstree.min.css',
            )
        }
...
class IpAddressAdmin(
    ...
    change_form_template = 'admin/immunity-ipam/ip_address/change_form.html'
    ...
    class Media:
        js = (
            'admin/js/jquery.init.js',
            'immunity-ipam/js/ip-request.js',
        )
