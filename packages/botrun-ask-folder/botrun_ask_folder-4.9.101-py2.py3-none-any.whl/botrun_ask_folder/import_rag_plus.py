...
def import_rag_plus(
    ...
    def query_vector_search(json_block):
        custom_log(
            "INFO", f"import_rag_plus.py, query_vector_search, json_block: {json_block}"
        )
    ...
    def query_keyword_search(json_block):
        custom_log(
            "INFO",
            f"import_rag_plus.py, query_keyword_search, json_block: {json_block}",
        )
    ...
    for json_block in json_blocks:
        ...
        try:
            ...
            custom_log(
                "INFO",
                f"import_rag_plus.py, append knowledge_base: {str_knowledge_base}",
            )
