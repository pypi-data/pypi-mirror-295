...
class _ScanIterator(ABC, metaclass=abc.ABCMeta):
    ...
    blacklist: Incomplete
    is_first_scan: bool
    def __init__(self, scan_urls: list[_ScanUrl], extensions: list[str], tag: str, blacklist_config: list[_BlacklistExceptionHandler] | None) -> None: ...
