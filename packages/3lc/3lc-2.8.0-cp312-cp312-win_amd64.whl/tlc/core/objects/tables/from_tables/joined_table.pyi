...
class JoinedTable(_InMemoryRowsTable):
    ...
    def __init__(self, url: Url | None = None, created: str | None = None, description: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, input_table_urls: Sequence[Url | Table] | None = None, init_parameters: Any = None) -> None: ...
