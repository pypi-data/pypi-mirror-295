...
class _UrlIndexingWorker(ABC, metaclass=abc.ABCMeta):
    def __init__(self, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler] | None, tag: str = '') -> None: ...
    @property
...
class _CrawlUrlIndexer(threading.Thread, _UrlIndexingWorker):
    ...
    """
    def __init__(self, interval: float, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler], tag: str = '') -> None: ...
    def add_scan_url(self, url_config: _ScanUrl) -> None: ...
    def remove_scan_url(self, url_config: _ScanUrl) -> None: ...
...
class _FileSystemObserverUrlIndexer(_UrlIndexingWorker):
    ...
    """
    def __init__(self, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler], tag: str = '') -> None: ...
    def add_scan_url(self, url_config: _ScanUrl) -> None: ...
    def remove_scan_url(self, url_config: _ScanUrl) -> None: ...
    def get_scan_urls(self) -> list[_ScanUrl]: ...
    def handle_scan(self, new_scan: Iterator[_UrlIndex]) -> dict[Url, _UrlIndex] | None:
