...
class TableWriter:
    ...
    url: Incomplete
    def __init__(self, table_name: str = ..., dataset_name: str = ..., project_name: str = ..., description: str = '', column_schemas: Mapping[str, _SampleTypeStructure] | None = None, if_exists: Literal['overwrite', 'rename', 'raise'] = 'rename', *, table_url: Url | str | None = None) -> None:
