...
from litestar import Litestar, Request as Request, Response
...
from litestar.types.asgi_types import ASGIApp as ASGIApp, Receive as Receive, Scope as Scope
...
class ObjectRoutesController(Controller):
    ...
    async def get_encoded_url(self, encoded_url: str) -> Response[TLCObject]: ...
