    ...
    def do_init(self):
        ...
        if self.config.get('ocr'):
            ...
            if self.config.get('ocr').get('lib') == 'paddleocr':
                ...
                self.ocr = PaddleOCR(det_model_dir=paddle_model_dir, cls_model_dir=paddle_model_dir,
                                     rec_model_dir=paddle_model_dir, use_angle_cls=False, lang=lang, use_gpu=True)
                import logging
