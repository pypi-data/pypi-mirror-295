...
def read_exp(expdata_loc: str):
    ...
    try : 
        ...
        exp_file_bool = False
    return dataExp
def print_ss(case, exp=False, llista= False, end_ss = 0, lenght = 60):
    """ Prints a table for steady state values
    TODO: 
    - Print the result in a text file
    - add the possibility to print the exerimental values

    :case: specific case for which you want to make the table
    :exp: (optional) If False, no experimental is to be printed
