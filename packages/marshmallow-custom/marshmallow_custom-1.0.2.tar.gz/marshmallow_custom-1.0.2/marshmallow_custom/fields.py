...
from marshmallow_custom import validate, utils, class_registry
from marshmallow_custom.base import FieldABC, SchemaABC
from marshmallow_custom.utils import missing as missing_
from marshmallow_custom.compat import text_type, basestring
from marshmallow_custom.exceptions import ValidationError
from marshmallow_custom.validate import Validator
...
class Field(FieldABC):
    ...
    #: :exc:`marshmallow_custom.ValidationError`.
    ...
    def _add_to_schema(self, field_name, schema):
        """Update field with values from its parent schema. Called by
            :meth:`__set_field_attrs <marshmallow_custom.Schema.__set_field_attrs>`.
...
class Nested(Field):
    """Allows you to nest a :class:`Schema <marshmallow_custom.Schema>`
    inside a field.
    ...
    When passing a `Schema <marshmallow_custom.Schema>` instance as the first argument,
    ...
    you should pass a `Schema <marshmallow_custom.Schema>` class (not an instance) as the first argument.
        ...
        if isinstance(cls_or_instance, type):
            if not issubclass(cls_or_instance, FieldABC):
                raise ValueError('The type of the list elements '
                                           ...
                                           'marshmallow_custom.base.FieldABC')
...
class UUID(String):
    ...
    default_error_messages = {
        ...
        'invalid_guid': 'Not a valid UUID.'  # TODO: Remove this in marshmallow_custom 3.0
    }
...
class DateTime(Field):
    ...
    UTC (+00:00) by :meth:`Schema.dump <marshmallow_custom.Schema.dump>`.
    :meth:`Schema.load <marshmallow_custom.Schema.load>` returns `datetime`
...
class LocalDateTime(DateTime):
    ...
    Takes the same arguments as :class:`DateTime <marshmallow_custom.fields.DateTime>`.
    """
    localtime = True
