# -*- coding: utf-8 -*-
"""A registry of :class:`Schema <marshmallow_custom.Schema>` classes. This allows for string
lookup of schemas, which may be used with
class:`fields.Nested <marshmallow_custom.fields.Nested>`.
...
from marshmallow_custom.exceptions import RegistryError
...
def get_class(classname, all=False):
    ...
    :raises: marshmallow_custom.exceptions.RegistryError if the class cannot be found
