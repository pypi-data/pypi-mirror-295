# CDKTF prebuilt bindings for hashicorp/vsphere provider version 2.9.1

This repo builds and publishes the [Terraform vsphere provider](https://registry.terraform.io/providers/hashicorp/vsphere/2.9.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform vsphere provider](https://registry.terraform.io/providers/hashicorp/vsphere/2.9.1)
