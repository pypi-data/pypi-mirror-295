...
@app.command('log-multi', rich_help_panel='POST')
def cmd_multilog(ctx: typer.Context, entries: Annotated[str, typer.Argument()]):
    ...
    for entry in entries.split(','):
        ...
        try:
            ...
            ctx.invoke(log_time, duration=duration, issue=issue)
        except ValueError:
