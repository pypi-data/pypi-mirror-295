...
class CycleCutter(Base):
    ...
    def get_raw_cycle_data(self, start_uuids: list, stop_uuids: list = None, 
        ...
        normalizes time by seconds after the cycle start, and returns a DataFrame where values
        (e.g., temperature, pressure) are identified by UUIDs and stored in a single value column
        (e.g., 'value_integer').
    ...
    def get_cycle_statistics(self, start_uuids: list, stop_uuids: list = None, value_mappings: dict) -> pd.DataFrame:
        """
