...
def play_remote_game(game_id: str, host: str, player: GameAgentBase, player_index: int = 0, agent_name:str = "default", force_new_credentials: bool = False): 
    """
    ...
    GamePlayerBase.start_game(RemoteGamePlayer, player, game_id, host, player_index=player_index, agent_name=agent_name, force_new_credentials=force_new_credentials)
