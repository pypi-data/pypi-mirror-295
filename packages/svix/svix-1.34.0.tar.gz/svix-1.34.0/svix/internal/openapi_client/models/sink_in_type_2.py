...
from ..models.sink_in_type_2_type import SinkInType2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SinkInType2")
...
class SinkInType2:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = SinkInType2Type(d.pop("type"))
        ...
        sink_in_type_2.additional_properties = d
        return sink_in_type_2
