...
T = TypeVar("T", bound="AggregateEventTypesOut")
...
class AggregateEventTypesOut:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aggregate_event_types_out = cls(
            id=id,
            status=status,
            task=task,
        )

        aggregate_event_types_out.additional_properties = d
        return aggregate_event_types_out
