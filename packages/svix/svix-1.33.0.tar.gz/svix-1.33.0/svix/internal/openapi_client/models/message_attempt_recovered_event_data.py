...
T = TypeVar("T", bound="MessageAttemptRecoveredEventData")
...
class MessageAttemptRecoveredEventData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        message_attempt_recovered_event_data = cls(
            app_id=app_id,
        ...
        message_attempt_recovered_event_data.additional_properties = d
        return message_attempt_recovered_event_data
