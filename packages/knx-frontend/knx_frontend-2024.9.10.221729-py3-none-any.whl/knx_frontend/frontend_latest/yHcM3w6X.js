/*! For license information please see yHcM3w6X.js.LICENSE.txt */
export const id=2882;export const ids=[2882];export const modules={3935:(t,i,e)=>{e.d(i,{A:()=>n});const o=t=>t<10?`0${t}`:t;function n(t){const i=Math.floor(t/3600),e=Math.floor(t%3600/60),n=Math.floor(t%3600%60);return i>0?`${i}:${o(e)}:${o(n)}`:e>0?`${e}:${o(n)}`:n>0?""+n:null}},9371:(t,i,e)=>{e.d(i,{PN:()=>a,jm:()=>s,sR:()=>r,t1:()=>n,yu:()=>l});e(1238);const o={"HA-Frontend-Base":`${location.protocol}//${location.host}`},n=(t,i,e)=>t.callApi("POST","config/config_entries/flow",{handler:i,show_advanced_options:Boolean(t.userData?.showAdvanced),entry_id:e},o),a=(t,i)=>t.callApi("GET",`config/config_entries/flow/${i}`,void 0,o),s=(t,i,e)=>t.callApi("POST",`config/config_entries/flow/${i}`,e,o),r=(t,i)=>t.callApi("DELETE",`config/config_entries/flow/${i}`),l=(t,i)=>t.callApi("GET","config/config_entries/flow_handlers"+(i?`?type=${i}`:""))},1399:(t,i,e)=>{e.d(i,{mx:()=>o,sF:()=>n});const o=["sunday","monday","tuesday","wednesday","thursday","friday","saturday"],n=(t,i)=>t.callWS({type:"schedule/create",...i})},5705:(t,i,e)=>{e.d(i,{PF:()=>s,CR:()=>n,ls:()=>a});var o=e(3935);const n=(t,i)=>t.callWS({type:"timer/create",...i}),a=t=>{if(!t.attributes.remaining)return;let i=function(t){const i=t.split(":").map(Number);return 3600*i[0]+60*i[1]+i[2]}(t.attributes.remaining);if("active"===t.state){const e=(new Date).getTime(),o=new Date(t.last_changed).getTime();i=Math.max(i-(e-o)/1e3,0)}return i},s=(t,i,e)=>{if(!i)return null;if("idle"===i.state||0===e)return t.formatEntityState(i);let n=(0,o.A)(e||0)||"0";return"paused"===i.state&&(n=`${n} (${t.formatEntityState(i)})`),n}},3283:(t,i,e)=>{e.d(i,{W:()=>r});var o=e(8597),n=e(9371),a=e(1238),s=e(6);const r=(t,i)=>(0,s.g)(t,i,{flowType:"config_flow",loadDevicesAndAreas:!0,createFlow:async(t,e)=>{const[o]=await Promise.all([(0,n.t1)(t,e,i.entryId),t.loadFragmentTranslation("config"),t.loadBackendTranslation("config",e),t.loadBackendTranslation("selector",e),t.loadBackendTranslation("title",e)]);return o},fetchFlow:async(t,i)=>{const e=await(0,n.PN)(t,i);return await t.loadFragmentTranslation("config"),await t.loadBackendTranslation("config",e.handler),await t.loadBackendTranslation("selector",e.handler),e},handleFlowStep:n.jm,deleteFlow:n.sR,renderAbortDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.abort.${i.reason}`,i.description_placeholders);return e?o.qy`
    ...
    `}},{kind:"method",key:"_valueChanged",value:function(t){this._item=t.detail.value}},{kind:"method",key:"_createItem",value:async function(){if(this._domain&&this._item){this._submitting=!0,this._error="";try{const t=await _[this._domain].create(this.hass,this._item);this._params?.dialogClosedCallback&&t.id&&this._params.dialogClosedCallback({flowFinished:!0,entityId:`${this._domain}.${t.id}`}),this.closeDialog()}catch(t){this._error=t.message||"Unknown error"}finally{this._submitting=!1}}}},{kind:"method",key:"_domainPicked",value:async function(t){if(!(t=>!(!t.detail.selected||"property"!==t.detail.source||(t.currentTarget.selected=!1,0)))(t))return;const i=t.currentTarget.domain;if(i in _){this._loading=!0;try{await _[i].import(),this._domain=i}finally{this._loading=!1}this._focusForm()}else(0,u.W)(this,{startFlowHandler:i,manifest:await(0,h.QC)(this.hass,i),dialogClosedCallback:this._params.dialogClosedCallback}),this.closeDialog()}},{kind:"method",key:"_focusForm",value:async function(){await this.updateComplete,(this._form?.lastElementChild).focus()}},{kind:"method",key:"_goBack",value:function(){this._domain=void 0,this._item=void 0,this._error=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[g.nA,n.AH`
      ...
      `]}}]}}),n.WF)},7424:(t,i,e)=>{e.d(i,{MR:()=>o,a_:()=>n,bg:()=>a});const o=t=>`https://brands.home-assistant.io/${t.brand?"brands/":""}${t.useFallback?"_/":""}${t.domain}/${t.darkOptimized?"dark_":""}${t.type}.png`,n=t=>t.split("/")[4],a=t=>t.startsWith("https://brands.home-assistant.io/")},7777:(t,i,e)=>{var o=e(8597);class n extends o.WF{static get styles(){return[o.AH`
        :host {
          display: block;
          position: absolute;
          outline: none;
...
//# sourceMappingURL=yHcM3w6X.js.map