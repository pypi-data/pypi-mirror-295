...
def load_config() -> Dict[str, str]:
    ...
    if 'sh' not in config:
        config['sh'] = "You are a shell script expert, create terminal command for user's request. It is critical that you send a response without any prefix or suffix like ```ssh or ```bash."
        save_config(config)
