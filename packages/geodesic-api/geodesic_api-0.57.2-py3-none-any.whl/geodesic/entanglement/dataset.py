    ...
    def from_bucket(
        ...
        **kwargs,
        ...
        Args:
            ...
            start_datetime_filename_pattern: a regex pattern to extract a start datetime from the filename
            end_datetime_filename_pattern: a regex pattern to extract an end datetime from the filename
            feature_limit: the max number of features to return in a single page from a search. Defaults to 2000
