...
def init():
    ...
    typer.echo(
        "AgentQL is now installed and ready to use! Get started with your first script by running `python3 first_step.py`. For more examples and detailed documentation, visit our website at https://docs.agentql.com/getting-started/first-steps."
    )
