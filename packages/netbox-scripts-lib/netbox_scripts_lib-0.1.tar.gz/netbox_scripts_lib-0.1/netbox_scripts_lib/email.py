...
def prepare_and_send_email(
    ...
    script_file_name, script_class = script.full_name.split(".")
    jobs_url = f"{configuration.HOST_URL}/extras/scripts/{script_file_name}/{script_class}/jobs)" if object else ""
