...
class APIClient(BaseAPIClient):
    ...
    def make_api_call(self, endpoint_name, call_type, url_extension="", params=None, data=None, headers=None):
        ...
        if token:
            MediLink_ConfigLoader.log("[Make API Call] Token gotten for {}".format(endpoint_name))
        else:
            MediLink_ConfigLoader.log("[Make API Call] No token gotten for {}".format(endpoint_name))
