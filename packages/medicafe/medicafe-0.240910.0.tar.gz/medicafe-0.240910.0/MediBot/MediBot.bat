...
if not "!current_csv!"=="%target_folder%\!latest_csv!" (
    echo WARNING: Config file CSV path differs from the latest CSV.
    echo Config file CSV path: !current_csv!
    echo Latest CSV: %target_folder%\!latest_csv!
    set /p update_choice="Do you want to update the config file with the latest CSV? (Y/N): "
