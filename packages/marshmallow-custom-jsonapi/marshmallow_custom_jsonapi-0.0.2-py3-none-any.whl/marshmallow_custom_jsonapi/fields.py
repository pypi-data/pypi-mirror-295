# -*- coding: utf-8 -*-
"""Includes all the fields classes from `marshmallow_custom.fields` as well as
fields for serializing JSON API-formatted hyperlinks.
"""
import collections
import warnings

from marshmallow_custom.compat import basestring

from marshmallow_custom import ValidationError, class_registry, missing
from marshmallow_custom.fields import Field
# Make core fields importable from marshmallow_custom_jsonapi
from marshmallow_custom.fields import *  # noqa
from marshmallow_custom.base import SchemaABC
from marshmallow_custom.utils import is_collection

from .utils import get_value, resolve_params, iteritems, _MARSHMALLOW_CUSTOM_VERSION_INFO
...
class BaseRelationship(Field):
    ...
    This is used by `marshmallow_custom_jsonapi.Schema` to determine which
...
class Relationship(BaseRelationship):
    ...
    def extract_value(self, data):
        ...
        if 'attributes' in data and self.__schema:
            ...
            return result.data if _MARSHMALLOW_CUSTOM_VERSION_INFO[0] < 3 else result
    ...
    def _serialize_included(self, value):
        ...
        if _MARSHMALLOW_CUSTOM_VERSION_INFO[0] < 3:
            data = result.data
        else:
            data = result
...
class DocumentMeta(Field):
    ...
    Examples: ::
        ...
        from marshmallow_custom_jsonapi import Schema, fields
