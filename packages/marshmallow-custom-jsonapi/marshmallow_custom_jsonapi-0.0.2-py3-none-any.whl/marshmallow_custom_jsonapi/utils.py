...
import marshmallow_custom
from marshmallow_custom.compat import iteritems
from marshmallow_custom.utils import get_value as _get_value, missing

_MARSHMALLOW_CUSTOM_VERSION_INFO = tuple(
    [int(part) for part in marshmallow_custom.__version__.split('.') if part.isdigit()]
)
