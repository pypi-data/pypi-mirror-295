...
from multiBacktesting2 import Backtest, Strategy
from multiBacktesting2._stats import compute_drawdown_duration_peaks
from multiBacktesting2._util import _Array, _as_str, _Indicator, try_
from multiBacktesting2.lib import (
    OHLCV_AGG,
    SignalStrategy,
    TrailingStrategy,
    barssince,
...
from multiBacktesting2.test import EURUSD, GOOG, SMA
...
class TestPlot(TestCase):
    ...
    def test_resample(self):
        bt = Backtest(GOOG, SmaCross)
        bt.run()
        import multiBacktesting2._plotting
        with _tempfile() as f,\
                patch.object(multiBacktesting2._plotting, '_MAX_CANDLES', 10),\
