	...
	def get_tax_details(self):
		...
		for order in executed_orders:
			...
			if exchange == 'NSE' and trade_type == 'DELIVERY':
				...
				transaction_charges = 0.05 / 100 * order_value
				stamp_charges = 0.003 / 100 * order_value if order['action'] == 'Buy' else 0
...
if __name__ == '__main__':
	obj = OMS({'sub': 'fead912e-a03b-4fc9-b988-2bb0ce65f694', 'email': 'kaustubh.29.dixit@gmail.com', 'name': '', 'api_key': '3uggvz253hhhfjnp', 'api_secret': '2hbojy40dyu4itx8rbzpvkm353xu3dp3', 'access_token': '7W42pgbIvLJ2dE04Rk6e7vrYp6sicafG', 'iat': 1725927992, 'exp': 1725992792})
