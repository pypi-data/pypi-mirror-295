...
from delta.cli.drive.build import build
from delta.cli.drive.check import check
from delta.cli.drive.init import init
from delta.cli.drive.publish import publish_dt
...
drive.add_command(init)
# drive.add_command(check)
# drive.add_command(dependency)
drive.add_command(resource)
drive.add_command(publish_dt)
drive.add_command(artifact)
drive.add_command(build)
