...
from delta.cli.get import get_deltatwin_info
from delta.cli.list import list_deltatwins
...
delta_cli.add_command(list_deltatwins)
delta_cli.add_command(get_deltatwin_info)
...
# DeltaTwin Artifact
# delta_cli.add_command(artifact)
