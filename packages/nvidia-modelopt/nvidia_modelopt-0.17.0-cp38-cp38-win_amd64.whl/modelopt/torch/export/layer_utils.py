...
def build_qkv(
    ...
    if all(
        ...
        q_weight, q_weight_scaling_factor, _, _ = resmooth_and_get_scale_and_amax(
        ...
        k_weight, k_weight_scaling_factor, _, _ = resmooth_and_get_scale_and_amax(
        ...
        v_weight, v_weight_scaling_factor, _, _ = resmooth_and_get_scale_and_amax(
