...
def quantize(
    ...
    Args:
        ...
        calibration_method:
            ...
            fp8: 'max' (default) and int4: 'awq_clip' (default) and 'rtn_dq'.
    ...
    default_high_precision_dtype = "fp32" if quantize_mode == "int8" else "fp16"
    high_precision_dtype = high_precision_dtype or default_high_precision_dtype

    if disable_mha_qdq or quantize_mode == "fp8" and high_precision_dtype == "fp16":
        nodes_to_exclude = find_nodes_from_mha_to_exclude(
            onnx_path,
            use_external_data_format,
            nodes_to_exclude,
            disable_mha_qdq,
            quantize_mode == "fp8" and high_precision_dtype == "fp16",
            intermediate_generated_files,
        )
