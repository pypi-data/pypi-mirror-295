...
def resmooth_and_get_scale_and_amax(
    ...
    for i, p_scaling_factor in enumerate(pre_quant_scales):
        ...
        scale, amax = get_weights_scaling_factor_and_amax(weight, group_size)
        scales.append(scale)
        amaxes.append(amax)
...
def convert_state_dict_amax_to_scales(quantized_state_dict, maxbound):
