...
from typing import Union, List, Any, Iterator, Optional, Literal, Tuple, AsyncIterator
...
class ProtocolStepReagents(BaseModel):
    typename: Optional[Literal["Reagent"]] = Field(alias="__typename", exclude=True)
    id: ID
...
class CreateExpressionMutation(BaseModel):
    ...
    class Arguments(BaseModel):
        ...
        data_kind: Optional[MetricDataType] = Field(alias="dataKind", default=None)
        kind: ExpressionKind

    class Meta:
        document = "fragment Expression on Expression {\n  id\n  label\n  ontology {\n    id\n    name\n  }\n}\n\nmutation CreateExpression($label: String!, $ontology: ID, $purl: String, $description: String, $color: [Int!], $dataKind: MetricDataType, $kind: ExpressionKind!) {\n  createExpression(\n    input: {label: $label, ontology: $ontology, description: $description, purl: $purl, color: $color, kind: $kind, dataKind: $dataKind}\n  ) {\n    ...Expression\n  }\n}"
...
async def acreate_expression(
    ...
    data_kind: Optional[MetricDataType] = None,
    rath: Optional[MikroNextRath] = None,
) -> Expression:
    """CreateExpression
    ...
    Arguments:
        ...
        data_kind (Optional[MetricDataType], optional): dataKind.
        rath (mikro_next.rath.MikroNextRath, optional): The mikro rath client
