...
import click
from openapi_client import SecretUpsertGenericSecretAPIInput
from openapi_client.models import ResponseModelServiceRevision, ResponseModelServiceInfo, ModelserviceModelServiceRevisionListResponse
...
from vessl.util.prompt import prompt_text, prompt_choices
...
def service_set_access_token(
    ...
    if not secret:
        ...
        if opt == "By linking an existing secret":
            ...
            secret_obj = vessl_api.secret_upsert_generic_secret_api(
                organization_name=vessl_api.organization.name,
                secret_upsert_generic_secret_api_input=SecretUpsertGenericSecretAPIInput(
