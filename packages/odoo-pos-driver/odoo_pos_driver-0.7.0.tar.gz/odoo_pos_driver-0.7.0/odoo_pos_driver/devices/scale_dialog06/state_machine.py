...
class Dialog06Machine(StateMachine):
    ...
    def on_enter_state_weight_recovered(self):
        self.weight = float(self.last_scale_answer.weight) / 1000
        self.error_number = False
        self.error_description = False

    def on_enter_state_error(self):
        self.weight = False
        self.error_number = self.last_scale_answer.error_number
        self.error_description = self.last_scale_answer.error_description

    def on_enter_state_unknown_error(self):
        self.weight = False
        self.error_number = self.last_scale_answer.error_number
        self.error_description = self.last_scale_answer.error_description
