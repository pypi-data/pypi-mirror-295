...
def get_output_dir(
    mouse_id,
    data_dir="/ceph/margrie/slenzi/2023/probe/raw/ts_experiments/derivatives/spikewrap/",
):
...
def get_brain_path(
    mouse_id,
    brain_dir="/ceph/margrie/slenzi/winstor_copy/serial2p/whole_brains/raw/",
    channel_id="2",
):
    path = (
...
def brainreg_command(mouse_id, mouse_dir, root_dir, function="brainreg", atlas="allen_mouse_10um", additional=None):
    input_path = get_brain_path(mouse_id)
...
def brainreg_commandline(
    mouse_id, mouse_dir, root_dir, function="brainreg", atlas="kim_mouse_10um", logs_path=None, additional=None
):
    command = brainreg_command(mouse_id, mouse_dir, root_dir, function=function, atlas=atlas, additional=additional)
