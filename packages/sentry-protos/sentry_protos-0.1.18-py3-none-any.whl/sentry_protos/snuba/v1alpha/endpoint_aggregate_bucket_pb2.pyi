...
class AggregateBucketRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_attribute_key_transform_context", b"_attribute_key_transform_context", "attribute_key_transform_context", b"attribute_key_transform_context", "filter", b"filter", "key", b"key", "meta", b"meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_attribute_key_transform_context", b"_attribute_key_transform_context", "aggregate", b"aggregate", "attribute_key_transform_context", b"attribute_key_transform_context", "filter", b"filter", "granularity_secs", b"granularity_secs", "key", b"key", "meta", b"meta"]) -> None: ...
