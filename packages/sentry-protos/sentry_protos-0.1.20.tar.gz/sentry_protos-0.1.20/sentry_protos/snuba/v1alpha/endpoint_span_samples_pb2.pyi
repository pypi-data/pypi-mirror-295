...
class SpanSamplesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["filter", b"filter", "keys", b"keys", "limit", b"limit", "meta", b"meta", "order_by", b"order_by", "virtual_column_context", b"virtual_column_context"]) -> None: ...
