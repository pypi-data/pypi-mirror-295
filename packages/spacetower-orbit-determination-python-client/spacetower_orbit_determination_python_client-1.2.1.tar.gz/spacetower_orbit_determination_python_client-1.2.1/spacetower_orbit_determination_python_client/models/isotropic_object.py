...
class IsotropicObject(SpaceObject):
    ...
    """ # noqa: E501
    drag_cross_section: Union[StrictFloat, StrictInt] = Field(description="Cross section area for drag computation. Units [m^2]", alias="dragCrossSection")
    radiation_cross_section: Union[StrictFloat, StrictInt] = Field(description="Cross section area for radiation pressure computation. Units [m^2]", alias="radiationCrossSection")
