...
class CartesianCovarianceMatrix(OrbitalCovarianceMatrix):
    """
    Covariance matrix for Cartesian coordinates, i.e., position and velocity
    """ # noqa: E501
    frame_id: CartesianCovarianceAllowedFrameId = Field(alias="frameId")
    var_px: Union[StrictFloat, StrictInt] = Field(description="Position x-component variance. Units [m^2]", alias="varPx")
    var_py: Union[StrictFloat, StrictInt] = Field(description="Position y-component variance. Units [m^2]", alias="varPy")
    var_pz: Union[StrictFloat, StrictInt] = Field(description="Position z-component variance. Units [m^2]", alias="varPz")
    var_vx: Union[StrictFloat, StrictInt] = Field(description="Velocity x-component variance. Units [m^2/s^2]", alias="varVx")
    var_vy: Union[StrictFloat, StrictInt] = Field(description="Velocity y-component variance. Units [m^2/s^2]", alias="varVy")
    var_vz: Union[StrictFloat, StrictInt] = Field(description="Velocity z-component variance. Units [m^2/s^2]", alias="varVz")
