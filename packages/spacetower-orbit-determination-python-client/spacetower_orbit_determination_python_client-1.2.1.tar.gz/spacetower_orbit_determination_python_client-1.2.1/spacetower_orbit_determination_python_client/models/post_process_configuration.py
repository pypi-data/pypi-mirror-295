...
class PostProcessConfiguration(BaseModel):
    ...
    mean_theory: Optional[OsculatingToMeanConfiguration] = Field(default=None, alias="meanTheory")
    ...
    __properties: ClassVar[List[str]] = ["outputOsculatingOrbitType", "meanTheory", "finalCovarianceConfiguration", "residualComputationConfiguration"]
