...
class PositionMeasurements(Measurements):
    ...
    standard_deviations: List[Union[StrictFloat, StrictInt]] = Field(description="Standard deviations for the entire set of measurements. The data contains a standard deviation for each of the following ordered content: position (applied to all directions) ", alias="standardDeviations")
