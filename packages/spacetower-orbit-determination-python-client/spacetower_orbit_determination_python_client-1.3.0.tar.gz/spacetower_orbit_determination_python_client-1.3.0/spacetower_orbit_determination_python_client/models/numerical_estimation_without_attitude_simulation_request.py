...
class NumericalEstimationWithoutAttitudeSimulationRequest(BaseModel):
    ...
    measurements_set: List[Measurements] = Field(description="Mixed set of generic dated-weighted measurement series with field descriptions", alias="measurementsSet")
