...
class BoxObject(SpaceObject):
    ...
    Box-shaped object
    """ # noqa: E501
    x_dimension: Union[StrictFloat, StrictInt] = Field(description="Box dimension along X axis. Units [m]", alias="xDimension")
    y_dimension: Union[StrictFloat, StrictInt] = Field(description="Box dimension along Y axis. Units [m]", alias="yDimension")
    z_dimension: Union[StrictFloat, StrictInt] = Field(description="Box dimension along Z axis. Units [m]", alias="zDimension")
    radiation_coefficients: Optional[ReflectionAbsorptionCoefficients] = Field(default=None, alias="radiationCoefficients")
    radiation_correction_factor: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=1, description="Correction factor for the radiation pressure acceleration. Units [-]", alias="radiationCorrectionFactor")
