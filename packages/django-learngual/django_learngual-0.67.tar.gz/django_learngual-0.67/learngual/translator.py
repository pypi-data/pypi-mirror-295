...
LEARNGUAL_CACHE_MODEL = settings.LEARNGUAL_CACHE_MODEL
...
class Translator:
    ...
    def translations(self):
        return self.get_cache_model().get_default_cache_model().translations
    ...
    def get_cache_model(self):
        assert (
            LEARNGUAL_CACHE_MODEL
        ), "LEARNGUAL_CACHE_MODEL does not exists in the enviroment variable"
        return load_callable(LEARNGUAL_CACHE_MODEL)
