...
class MechanicalTestFittingLinear():
    ...
    def __general_machine_Data_aquisition(self,  archive_name :  str, linearRegionSearchMethod, generalMachineData : GeneralMachine):
        '''
    ...
    def __MarcoPvMachine_Data_Aquisition(self, archive_name :  str, linearRegionSearchMethod):
        '''
        Method to analyse data of the older machine (the one used before instron arrived)
        '''
    ...
    def dataExtract(self, machineName : str, archive_name : str, linearRegionSearchMethod : str,
                     generalMachineData : GeneralMachine = None)->pd.DataFrame:
        '''
        ...
        if machineName == 'MarcoPvMachine':
            return self.__MarcoPvMachine_Data_Aquisition(archive_name, linearRegionSearchMethod)
        
        if machineName == 'generalMachine':
            return self.__general_machine_Data_aquisition(archive_name, linearRegionSearchMethod, generalMachineData)
