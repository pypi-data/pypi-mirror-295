...
for l in range (1,(3+1)):
    ...
    for i in range(len(rx)):
        ...
        if (l == 1):
           if (Si_ud[i] > 0.0): 
              pSx_u[i] = abs(Si_u[i])/Si_ud[i]
              pSx_d[i] = abs(Si_d[i])/Si_ud[i]
        if (l == 2):
           if (Si_ud[i] > 0.0): 
              pSy_u[i] = abs(Si_u[i])/Si_ud[i]
              pSy_d[i] = abs(Si_d[i])/Si_ud[i]
        if (l == 3):
           if (Si_ud[i] > 0.0): 
              pSz_u[i] = abs(Si_u[i])/Si_ud[i]
              pSz_d[i] = abs(Si_d[i])/Si_ud[i]
    #-------------------------------------------
    ...
    # Inserting legend's spheres: =========================================
    ax.scatter([-1000.0], [-1000.0], s = [0.0],  color = cRGB[c_spin_up], alpha = 0.0, edgecolors = 'none', label = palavra + r'$\uparrow$')
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[c_spin_up], alpha = 1.0, edgecolors = 'none', label = palavra + r'$\uparrow$')
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[c_spin_down], alpha = 1.0, edgecolors = 'none', label = palavra + r'$\downarrow$')
    ...
    plt.xlim((x[0], x[(n_procar*nk)-1]))
    plt.ylim((E_min, E_max))
    plt.title(palavra + ' = ' + palavra + r'$\uparrow$' + ' + ' + palavra + r'$\downarrow$')
    ...
    ax.set_box_aspect(1.25/1)
    ax.legend(title = palavra + ' = ' + palavra + r'$\uparrow$' + ' + ' + palavra + r'$\downarrow$')
...
for l in range (1,(3+1)):
    ...
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[c_spin_up], alpha = 1.0, edgecolors = 'none', label = palavra + r'$\uparrow$')
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[c_spin_down], alpha = 1.0, edgecolors = 'none', label = palavra + r'$\downarrow$')
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[0], alpha = 1.0, edgecolors = 'none', label = 'overlap (' r'$\uparrow$' + '+' + r'$\downarrow$' ')')
    ax.scatter([-1000.0], [-1000.0], s = [40.0], color = cRGB[1], alpha = 1.0, edgecolors = 'none', label = 'overlap (' r'$\uparrow$' + '+' + r'$\downarrow$' ')')
