...
class Client:
    ...
    def __init__(self, api_token: str = None):
        ...
        # Dev
        self.predict_url = "https://api-dev.rockai.online:9090/v1/predictions"
        self.get_url = "https://api-dev.rockai.online:9090/v1/predictions/{}"
        self.cancel_url = "https://api-dev.rockai.online:9090/v1/predictions/{}/cancel"
    ...
    def create(
        ...
        payload = {"version": version, "input": input, "model": model}
    ...
    def stream(
        self, model: str, version: str = None, input: Optional[Dict[str, Any]] = None
    ) -> Iterator:
        url = self.predict_url

        payload = {"version": version, "input": input, "stream": True, "model": model}
