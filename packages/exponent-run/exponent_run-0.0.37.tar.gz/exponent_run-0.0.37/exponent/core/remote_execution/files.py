...
def get_file_content(
    ...
    exists = True
    content = read_file(str(path.absolute()))
...
def get_file_attachments(
    ...
    for file in get_file_attachments_request.files:
        content, _ = get_file_content(file.file_path, file.working_directory)
...
def get_file_attachment(
    ...
    file_path = get_file_attachment_request.file.file_path
    working_directory = get_file_attachment_request.file.working_directory

    content, exists = get_file_content(file_path, working_directory)
