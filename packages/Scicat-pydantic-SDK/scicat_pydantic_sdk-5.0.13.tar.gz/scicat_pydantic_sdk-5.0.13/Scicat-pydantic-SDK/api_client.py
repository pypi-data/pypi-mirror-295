...
import Scicat-pydantic-SDK.models
from Scicat-pydantic-SDK import rest
from Scicat-pydantic-SDK.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(Scicat-pydantic-SDK.models, klass)
