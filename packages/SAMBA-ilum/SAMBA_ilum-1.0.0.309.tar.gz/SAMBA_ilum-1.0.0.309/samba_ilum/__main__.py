...
if (tarefa == 1):
   ...
   if (loop_ht == 1):
      ...
      for nloop in range(len(bilayer_materials)):
          ...
          run = 1
          #-------------------------------------
          if (temp_check == 0): nloop = nloop +1
          if (temp_check == 1): nloop = nloop +1 +int(n_ht[-1])
          #---------------------------------------------------------------
          ...
          if (temp_check == 1):
             for mnt in range(len(mat1)):
                 ...
                 print(temp0_mat1, temp0_mat2)
                 print(temp1_mat1, temp1_mat2)
                 if ( (temp0_mat1 == 'temp1_mat1' and temp0_mat2 == 'temp1_mat2') or (temp0_mat1 == 'temp1_mat2' and temp0_mat2 == 'temp1_mat1') ):
                    run = 0
                    print("OK")
          #------------------------------------------------------------------------------------------------------------------------------------------------
