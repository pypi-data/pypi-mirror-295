...
def send_lark(content='test_result', executors=None, channel="cb513bbf-9121-4674-bebc-036124033284"):
...
def exec_record(**kwargs):
    ...
    # exec_url = 'http://172.23.74.62:8080/msg/sendTestResult'
...
def pytest_sessionfinish(session):
    ...
    if 'macos' in platform.platform().lower():
        ...
        exec_record(business_type=test_result["business"], executor=test_result['tester'], exec_env=test_result['test_env'],
                    begin_time=test_result['begin_time'], exec_time=test_result['run_time'],
                    all_case=test_result['all'], success_case=test_result['passed'], fail_case=test_result['failed'],
