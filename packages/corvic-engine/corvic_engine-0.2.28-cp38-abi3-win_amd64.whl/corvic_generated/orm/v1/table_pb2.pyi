...
class TruncateListOp(_message.Message):
    __slots__ = ("source", "list_column_name", "target_column_length", "padding_value")
    SOURCE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, source: _Optional[_Union[TableComputeOp, _Mapping]] = ..., list_column_name: _Optional[str] = ..., target_column_length: _Optional[int] = ..., padding_value: _Optional[_Union[_struct_pb2.Value, _Mapping]] = ...) -> None: ...
