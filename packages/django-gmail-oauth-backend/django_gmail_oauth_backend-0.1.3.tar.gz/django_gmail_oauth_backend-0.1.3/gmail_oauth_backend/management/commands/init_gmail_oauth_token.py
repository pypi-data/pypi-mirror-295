...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--client-id', type=str, required=False, help='Your Google OAuth 2.0 Client ID', default=default_client_id)
        parser.add_argument('--client-secret', type=str, required=False, help='Your Google OAuth 2.0 Client Secret', default=default_client_secret)
