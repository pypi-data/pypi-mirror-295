...
class DataCloudinitConfig(
    ...
    def __init__(
        ...
        *,
        ...
        :param base64_encode: Specify whether or not to base64 encode the ``rendered`` output. Defaults to ``true``, and cannot be disabled if gzip is ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#base64_encode DataCloudinitConfig#base64_encode}
        :param boundary: Specify the Writer's default boundary separator. Defaults to ``MIMEBOUNDARY``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#boundary DataCloudinitConfig#boundary}
        :param gzip: Specify whether or not to gzip the ``rendered`` output. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#gzip DataCloudinitConfig#gzip}
        :param part: part block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#part DataCloudinitConfig#part}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudinitConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#import import section} in the documentation of this resource for the id to use
...
class DataCloudinitConfigConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def base64_encode(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#base64_encode DataCloudinitConfig#base64_encode}
        '''
    ...
    def boundary(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#boundary DataCloudinitConfig#boundary}
        '''
    ...
    def gzip(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#gzip DataCloudinitConfig#gzip}
        '''
    ...
    def part(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#part DataCloudinitConfig#part}
        '''
...
class DataCloudinitConfigPart:
    def __init__(
        ...
        *,
        ...
        '''
        :param content: Body content for the part. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#content DataCloudinitConfig#content}
        :param content_type: A MIME-style content type to report in the header for the part. Defaults to ``text/plain``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#content_type DataCloudinitConfig#content_type}
        :param filename: A filename to report in the header for the part. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#filename DataCloudinitConfig#filename}
        :param merge_type: A value for the ``X-Merge-Type`` header of the part, to control `cloud-init merging behavior <https://cloudinit.readthedocs.io/en/latest/reference/merging.html>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#merge_type DataCloudinitConfig#merge_type}
        '''
        if __debug__:
    ...
    def content(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#content DataCloudinitConfig#content}
        '''
    ...
    def content_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#content_type DataCloudinitConfig#content_type}
        '''
    ...
    def filename(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#filename DataCloudinitConfig#filename}
        '''
    ...
    def merge_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.5/docs/data-sources/config#merge_type DataCloudinitConfig#merge_type}
        '''
