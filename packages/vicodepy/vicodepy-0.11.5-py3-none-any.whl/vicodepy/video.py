...
class Video(QWidget):
    ...
    def media_status_changed(self, state):
        if state == QMediaPlayer.MediaStatus.LoadedMedia:
            ...
            if metadata:
                ...
                # FIXME: This should be float, not int (see issue #145))
    ...
    def position_changed(self, position):
        ...
        self.window.position_changed(position)
    ...
    # The argument "checked" is necessary, in order to have this function used
    # via functools.partial in the triggered option of QAction
