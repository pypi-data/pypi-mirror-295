...
class Utils:
    ...
    @staticmethod
    def create_delimiter_field(f_v, t_v):
        return f_v + ":" + t_v
    ...
    def parse_user_agent(ua_string):
        try:
            ...
            #     device = "mobile"
            agent_info = {
                "env:browser": user_agent.browser.family,
                "env:os": user_agent.os.family,
    ...
    def get_info_jwt():
        try:
            ...
            raise ValueError("get_info_jwt err: {}".format(err))
