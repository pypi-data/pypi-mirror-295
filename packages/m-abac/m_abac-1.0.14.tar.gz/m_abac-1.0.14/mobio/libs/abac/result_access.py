from .config import JSONEncoder, KafkaHelper, Mobio
...
class ResultAccess:
    ...
    def get_data_deny(self):
        return self.data_deny

    def add_data_deny(self, value):
        self.data_deny.append(value)
