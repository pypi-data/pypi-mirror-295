...
class CustomIndexTestCase(TestCase):
    ...
    def test_validate(self):
        expected_data = compress({'class_name': 'CustomIndex', 'method_name': 'validate', 'self_obj': self.custom_index.to_dict(add_class_path=True), 'params': {}}, protocol='gzip', serialize='json')
