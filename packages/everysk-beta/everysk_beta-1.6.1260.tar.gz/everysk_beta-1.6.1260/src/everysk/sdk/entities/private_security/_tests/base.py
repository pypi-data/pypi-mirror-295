...
class PrivateSecurityTestCase(TestCase):
    ...
    def test_validate(self):
        expected_data = compress({'class_name': 'PrivateSecurity', 'method_name': 'validate', 'self_obj': self.private_security.to_dict(add_class_path=True), 'params': {}}, protocol='gzip', serialize='json')
