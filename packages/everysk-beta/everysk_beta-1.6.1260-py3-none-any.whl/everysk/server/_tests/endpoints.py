...
from everysk.server.endpoints import BaseEndpoint, JSONEndpoint
        ...
        log.assert_called_once_with(
            ...
            extra={
                ...
                'traceback': (
                    ...
                    '  File "/var/app/src/everysk/server/endpoints.py", line 114, in dispatch\n'
                    '    response = await self.get_http_response()\n'
                    '               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/endpoints.py", line 154, in get_http_response\n'
                    '    return await method_function()\n'
                    '           ^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/_tests/endpoints.py", line 37, in post\n'
                    '    raise HttpError(status_code=500, msg=\'Server error\')\n'
        ...
        log.assert_called_once_with(
            ...
            extra={
                ...
                'traceback': (
                    ...
                    '    response = await self.get_http_response()\n'
                    '               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/endpoints.py", line 243, in get_http_response\n'
                    '    response = await super().get_http_response()\n'
                    '               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/endpoints.py", line 154, in get_http_response\n'
                    '    return await method_function()\n'
                    '           ^^^^^^^^^^^^^^^^^^^^^^^\n'
                    '  File "/var/app/src/everysk/server/_tests/endpoints.py", line 172, in post\n'
                    '    raise HttpError(status_code=500, msg=\'Server error\')\n'
                    'everysk.core.exceptions.HttpError: 500 -> Server error\n'
                ),
            },
