...
from .types.list_request_file_format_item import ListRequestFileFormatItem
...
class AssetLibraryClient:
    ...
    def list(
        ...
        *,
        ...
        file_format: typing.Optional[
            typing.Union[ListRequestFileFormatItem, typing.Sequence[ListRequestFileFormatItem]]
        ] = None,
        ...
        file_format : typing.Optional[typing.Union[ListRequestFileFormatItem, typing.Sequence[ListRequestFileFormatItem]]]
