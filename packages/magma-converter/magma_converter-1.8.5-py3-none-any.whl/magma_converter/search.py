...
class Search:
    ...
    def check_integrity(self,
                        seismic_dir: str,
                        seismic_files: List[str] = None,
                        prefix: str = 'ERROR',
                        input_dir: str = None,
                        channel: str = None) -> None:
        """Check file integrity. Fix some error.

        Args:
            seismic_files: List of seismic files
    ...
    def search(self, date_str: str) -> Stream:
        ...
        if directory_structure in directory_structures_group['ijen']:
            stream = self.ijen(date_str)

        if directory_structure in directory_structures_group['dieng']:
