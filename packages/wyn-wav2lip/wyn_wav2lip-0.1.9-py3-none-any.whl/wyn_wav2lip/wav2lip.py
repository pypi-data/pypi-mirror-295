...
class Wav2Lip:
    ...
    def run(self, video_file: str, vocal_file: str = "", quality: str = "Enhanced",
            ...
            output_file_path: str = "output.mp4"):
        """Run the Wav2Lip model with a specified output file path."""
        ...
        # Display the result using the specified output file path
        if preview_settings:
            ...
            if os.path.isfile(output_file_path):
                print(f"Loading video preview from: {output_file_path}")
                autoplay_video(output_file_path)
            else:
                print(f"Output video not found at: {output_file_path}")
