...
def TLS_Analysis_Main( ip ):
    ...
    # Data of form [[Time], [Displacement], [Force], [Compressive Displacement], [Compressive Stress], [Force]].
    ...
    # Data still of form [[Time], [Displacement], [Force], [Compressive Displacement], [Compressive Stress], [Force]].
    ...
    if ip.plot_data:
        ...
        TLS_plotting.plot_data( ip.directory, ip.output_directory, file_data, data, first_derivative_data, second_derivative_data )
