...
def HPV_Get_Empty_Request() -> dict:
    ...
    PATH = path.join(getcwd(), 'Core', 'Config', 'HPV_Empty_Request.json')
...
class HPV_1win:
    ...
    def __init__(self, Name: str, URL: str, Proxy: dict, Headers: dict, COINS: list[int], MAX_LVL: int, MAX_ENERGY_LIMIT: int, MAX_ENERGY_REGEN: int, Lock: Lock) -> None:
...
def HPV_Main(COINS: list[int], MAX_LVL: int, MAX_ENERGY_LIMIT: int, MAX_ENERGY_REGEN: int, AUTO_UPDATE: bool) -> None:
    ...
    while True:
        ...
        def Start_Thread(Name: str, URL: str, Proxy: dict, Headers: dict) -> None:
            _1win = HPV_1win(Name, URL, Proxy, Headers, COINS, MAX_LVL, MAX_ENERGY_LIMIT, MAX_ENERGY_REGEN, Console_Lock)
            _1win.Run()
