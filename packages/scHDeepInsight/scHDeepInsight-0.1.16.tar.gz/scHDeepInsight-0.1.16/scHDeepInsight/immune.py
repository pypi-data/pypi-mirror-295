...
class Immune:
    ...
    def _create_pred_label(self, barcode_path, out_base, out_detailed, out_base_probs, out_detailed_probs):
        ...
        labels_prob_analysis = pd.DataFrame({
            "predicted_base_type": pred_label_base,
            "predicted_detailed_type": pred_label_detailed,
        ...
        return pd.concat([barcode, labels_prob_analysis], axis=1)
