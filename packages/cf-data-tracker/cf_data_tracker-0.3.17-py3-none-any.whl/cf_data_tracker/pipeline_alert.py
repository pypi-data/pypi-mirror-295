...
class PipelineAlert:
    ...
    Environment Variables:
        ...
        RECIPIENT_EMAILS: Comma-separated list of email addresses to receive alerts
    ...
    def __init__(self):
        ...
        if recipient_emails:
            self.recipient_emails = [email.strip() for email in recipient_emails.split(',') if email.strip()]
        else:
            logger.warning("No recipient emails provided. Using default email.")
            self.recipient_emails = ['rami.reddy@carnallfarrar.com']

        if not self.recipient_emails:
            logger.warning("No valid recipient emails after parsing. Using default email.")
            self.recipient_emails = ['rami.reddy@carnallfarrar.com']

        logger.info(f"Recipient emails: {self.recipient_emails}")
...
# - AWS_REGION
# - SENDER_EMAIL
# - RECIPIENT_EMAILS (as a comma-separated list)
# - PIPELINE_NAME