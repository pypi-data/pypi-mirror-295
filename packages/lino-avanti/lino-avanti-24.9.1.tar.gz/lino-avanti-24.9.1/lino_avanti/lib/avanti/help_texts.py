...
help_texts = {
    ...
    'lino_avanti.lib.avanti.TranslatorTypes' : _("""List of choices for the Client.translator_type field of a client."""),
    ...
    'lino_avanti.lib.avanti.Client.unemployed_since' : _("""The date when this client got unemployed and stopped to have a regular work."""),
    'lino_avanti.lib.avanti.Client.seeking_since' : _("""The date when this client registered as unemployed and started to look for a new job."""),
    'lino_avanti.lib.avanti.Client.city' : _("""The place (village or municipality) where this client lives."""),
    'lino_avanti.lib.avanti.Client.municipality' : _("""The municipality where this client lives. This is basically equal to city, except when city is a village and has a parent which is a municipality (which causes that place to be returned)."""),
    'lino_avanti.lib.avanti.Clients' : _("""Base class for most lists of clients."""),
    'lino_avanti.lib.avanti.Clients.client_state' : _("""If not empty, show only Clients whose client_state equals the specified value."""),
    ...
    'lino_avanti.lib.avanti.ProfessionalStates' : _("""List of choices for the Client.professional_state field of a client."""),
    'lino_avanti.lib.cal.Guest.absence_reason' : _("""Why the pupil was absent. Choices for this field are defined in AbsenceReasons."""),
    'lino_avanti.lib.cal.AbsenceReasons' : _("""The table of possible absence reasons."""),
    'lino_avanti.lib.courses.EnrolmentsByCourse' : _("""Same as lino_xl.lib.courses.EnrolmentsByCourse, but shows additional information about the pupil and the enrolment."""),
    'lino_avanti.lib.courses.Enrolment' : _("""Inherits from lino_xl.lib.courses.Enrolment but adds four specific “enrolment options”:"""),
    ...
    'lino_avanti.lib.courses.Enrolment.missing_rate' : _("""How many times the pupil was missing when a lesson took place. In percent."""),
    'lino_avanti.lib.courses.PresencesByEnrolment' : _("""Shows the presences of this pupil for this course."""),
    'lino_avanti.lib.courses.Reminder' : _("""A reminder is when a coaching worker sends a written letter to a client reminding him or her that they have a problem with their presences."""),
    ...
    'lino_avanti.lib.courses.Course' : _("""Adds an action to update the missing rates of all enrolments. Otherwise same as lino_xl.lib.courses.Course."""),
    'lino_avanti.lib.courses.Course.update_missing_rates' : _("""Calculate the missing rates for all enrolments of this course."""),
    'lino_avanti.lib.courses.DitchingEnrolments' : _("""List of enrolments with high absence rate for review by their coach."""),
