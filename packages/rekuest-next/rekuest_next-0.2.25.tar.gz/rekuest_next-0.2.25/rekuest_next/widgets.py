...
def StateChoiceWidget(stateChoices: str, followValue: Optional[str] = None, **kwargs) -> AssignWidgetInput:
    ...
    """
    return AssignWidgetInput(
        kind=AssignWidgetKind.STATE_CHOICE, stateChoices=stateChoices, followValue=followValue, **kwargs
    )