    ...
    if request.method == 'POST':
        ...
        mocked_data = {"fileSystems": [
            {"name": "workspaces/public/filesystems/defaultfs", "localName": "defaultfs", "displayName": "",
             "description": "", "isDisabled": False, "kind": "s3", "parentName": "", "host": "10.27.240.49:8077",
             "endpoint": "windmill/store/68b4691df5fd48a7a23742fed8d39c36",
             "credential": {"accessKey": "AKIAIOSFODNN7EXAMPLE", "secretKey": "HKcD1CmYJvMfuzao9Xt2VgsdwZhLkyq0",
                            "token": ""}, "mountPath": "/home/paddleflow/storage/mnt",
             "config": {"ak": "AKIAIOSFODNN7EXAMPLE", "allowcors": "false", "disableSSL": "true", "provider": "Minio",
                        "region": "bj", "s3ForcePathStyle": "true", "sk": "HKcD1CmYJvMfuzao9Xt2VgsdwZhLkyq0",
...
def get_filesystem(workspace_id, local_name):
    ...
    if request.method == 'GET':
        ...
        mocked_data = {"name": "workspaces/public/filesystems/defaultfs", "localName": "defaultfs", "displayName": "",
                       ...
                       "host": "10.27.240.49:8077",
                       "endpoint": "windmill/store/68b4691df5fd48a7a23742fed8d39c36",
                       "credential": {"accessKey": "AKIAIOSFODNN7EXAMPLE",
                                      "secretKey": "HKcD1CmYJvMfuzao9Xt2VgsdwZhLkyq0",
                                      "token": ""}, "mountPath": "/home/paddleflow/storage/mnt",
                       "config": {"ak": "AKIAIOSFODNN7EXAMPLE", "allowcors": "false", "disableSSL": "true",
                                  "provider": "Minio",
                                  "region": "bj", "s3ForcePathStyle": "true", "sk": "HKcD1CmYJvMfuzao9Xt2VgsdwZhLkyq0",
                                  "token": ""}, "tags": {}, "userID": "", "orgID": "public", "workspaceID": "public",
                       "createdAt": "2024-02-23T14:42:13.871Z", "updatedAt": "2024-02-23T14:42:13.871Z"}
