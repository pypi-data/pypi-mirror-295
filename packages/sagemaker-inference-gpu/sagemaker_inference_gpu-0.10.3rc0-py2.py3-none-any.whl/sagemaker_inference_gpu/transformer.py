...
from sagemaker_inference_gpu import content_types, environment, utils
from sagemaker_inference_gpu.default_inference_handler import DefaultInferenceHandler
from sagemaker_inference_gpu.errors import BaseInferenceToolkitError, GenericInferenceToolkitError
...
class Transformer(object):
    ...
    def handle_error(context, inference_exception, trace):
        ...
        Args:
            ...
            inference_exception (sagemaker_inference_gpu.errors.BaseInferenceToolkitError): An exception
