...
class CreateOrderTermsAndConditions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["autoRenew", "billToContactId", "clearingExistingBillToContact", "clearingExistingInvoiceTemplate", "clearingExistingPaymentTerm", "clearingExistingSequenceSet", "clearingExistingSoldToContact", "invoiceSeparately", "invoiceTemplateId", "lastTerm", "termIncreaseToNewContractLine", "paymentTerm", "renewalSetting", "renewalTerms", "sequenceSetId", "soldToContactId"]
