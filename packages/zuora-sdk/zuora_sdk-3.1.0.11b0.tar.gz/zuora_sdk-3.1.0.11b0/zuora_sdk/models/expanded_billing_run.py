...
class ExpandedBillingRun(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "billingRunNumber", "billingRunType", "endDate", "errorMessage", "executedDate", "invoiceDate", "name", "numberOfAccounts", "numberOfInvoices", "numberOfCreditMemos", "postedDate", "startDate", "status", "targetDate", "targetType", "totalTime", "accountId", "billCycleDay", "batches", "noEmailForZeroAmountInvoice", "autoPost", "autoEmail", "autoRenewal", "invoicesEmailed", "lastEmailSentTime", "targetDateOffSet", "invoiceDateOffSet", "chargeTypeToExclude", "scheduledExecutionTime", "targetDateMonthOffset", "targetDateDayOfMonth", "invoiceDateMonthOffset", "invoiceDateDayOfMonth", "repeatType", "repeatFrom", "repeatTo", "runTime", "timeZone", "monthlyOnDay", "weeklyOnDay"]
