...
class DataQueryJobCancelled(BaseModel):
    ...
    created_by: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="The query job creator's Id. ", alias="createdBy")
    id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Internal identifier of the query job. ")
