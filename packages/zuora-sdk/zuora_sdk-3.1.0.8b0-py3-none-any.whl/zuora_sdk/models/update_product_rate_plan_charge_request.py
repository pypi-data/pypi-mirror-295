    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.product_rate_plan_charge_tier_data:
            for _item_product_rate_plan_charge_tier_data in self.product_rate_plan_charge_tier_data:
                if _item_product_rate_plan_charge_tier_data:
                    _items.append(_item_product_rate_plan_charge_tier_data.to_dict())
