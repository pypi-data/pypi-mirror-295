...
def sync_files(srcDir: str, tarDir: str) -> tuple[dict[str, str], int]:
    """
    ...
    :return backupFiles, len(backupFiles.keys()) (tuple[dict[str, str], int]): The synced files with their source paths as keys and their destination paths as values. Also the length of the dictionary.
    """
    global fileCounter
    ...
    return backupFiles, len(backupFiles.keys())