...
thematic_usecase_bands = {
    'S1': {  # Type de donnée S
        ...
        'flooding': {  # Thématique flooding
            'valid_band': ['vv', 'vh'],  # Bandes valides pour S et flooding
            'bands_needing_resampling': [([], 2)]  # Bandes à rééchantillonner pour S et flooding
        }
    },
    'S2': {  # Type de donnée S2
        ...
        'flooding': {  # Thématique flooding pour S2
            'valid_band': ['02', '03', '04', '05', '06', '07', '08', '11', '12'],  # Bandes valides pour S2 et flooding
            'bands_needing_resampling': {
                "bands": ['05', '06', '07', '11', '12'],
                "factor": 2
            }  # Bandes à rééchantillonner pour S2 et flooding et le facteur a appliquer
...
def load_multispectral_images(directory, valid_bands, resample_bands, resample_factor):
    """
            ...
            if band_num in valid_bands:
                ...
                if band_num in resample_bands:
                    ...
                    if not os.path.exists(resampled_path):
                        utils.resample_band(file_path, resampled_path, resample_factor)
...
def compute_kmeans_score_for_multiband(original_folder_path, decompressed_folder_path, satellite_type: str,
    ...
    data = {
        ...
        "resampled_bands_factor":resample_factor,
        "metrics": {
            "overall_accuracy": {
                "results": {
    ...
    # Retourne le nom du modèle K-means et les métriques de similarité.
    return "kmeans++"+satellite_type+"-" + str(sample_interval) + "-" + str(n_clusters) + "-" + str(random_state), data
