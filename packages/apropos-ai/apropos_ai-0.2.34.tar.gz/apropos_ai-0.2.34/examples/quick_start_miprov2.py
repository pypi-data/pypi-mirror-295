...
from apropos.src.core.optimizers.baselines.miprov2.algorithm import MIPrOV2
import asyncio
...
if __name__ == "__main__":
    ...
    asyncio.run(main(messages_examples, metric, input_names, name_for_prompt, grounding_llm, program_llm, bffsrs_config))
