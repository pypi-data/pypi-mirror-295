...
class PromptTemplate(BaseModel):
    ...
    def run(
        ...
        if response_model:
            response = lm.sync_respond(system_prompt=system, user_prompt=user, response_model=response_model)
        else:
            response = lm.sync_respond(system_prompt=system, user_prompt=user)
        return response
