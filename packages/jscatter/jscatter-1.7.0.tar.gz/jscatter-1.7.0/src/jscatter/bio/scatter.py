...
def scatIntUniv(objekt, qlist=None, **kwargs):
    ...
    and for solvent using (values are defaults [5]_, [6]_, [7]_):
     - *universe.xDelocalisation=0.045* as default for heavy atoms.
     - `universe.hDelocalisation=0.045` as default for H atoms
     - `universe.hDelocalisation='default'` use above defaults.
     - `universe.solventDelocalisation=0.045` for solvent.
     - `universe.atoms.rmsd = [0.045, 0.044]` for [heavy atoms, H atoms]
