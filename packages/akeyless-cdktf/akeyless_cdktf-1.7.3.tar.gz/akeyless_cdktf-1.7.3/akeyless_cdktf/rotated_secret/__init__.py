...
Refer to the Terraform Registry for docs: [`akeyless_rotated_secret`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret).
'''
import abc
import builtins
import datetime
...
class RotatedSecret(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret akeyless_rotated_secret}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret akeyless_rotated_secret} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#name RotatedSecret#name}
        :param rotator_type: The rotator type password/target/api-key/ldap/custom. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotator_type RotatedSecret#rotator_type}
        :param target_name: The target name to associate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#target_name RotatedSecret#target_name}
        :param api_id: API ID to rotate (relevant only for rotator-type=api-key). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#api_id RotatedSecret#api_id}
        :param api_key: API key to rotate (relevant only for rotator-type=api-key). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#api_key RotatedSecret#api_key}
        :param authentication_credentials: The credentials to connect with use-user-creds/use-target-creds. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#authentication_credentials RotatedSecret#authentication_credentials}
        :param auto_rotate: Whether to automatically rotate every --rotation-interval days, or disable existing automatic rotation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#auto_rotate RotatedSecret#auto_rotate}
        :param custom_payload: Secret payload to be sent with rotation request (relevant only for rotator-type=custom). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#custom_payload RotatedSecret#custom_payload}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#description RotatedSecret#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#id RotatedSecret#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: The name of a key that is used to encrypt the secret value (if empty, the account default protectionKey key will be used). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#key RotatedSecret#key}
        :param rotated_password: rotated-username password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotated_password RotatedSecret#rotated_password}
        :param rotated_username: username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotated_username RotatedSecret#rotated_username}
        :param rotation_hour: The Hour of the rotation in UTC. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotation_hour RotatedSecret#rotation_hour}
        :param rotation_interval: The number of days to wait between every automatic rotation (1-365),custom rotator interval will be set in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotation_interval RotatedSecret#rotation_interval}
        :param rotator_custom_cmd: Custom rotation command (relevant only for ssh target). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotator_custom_cmd RotatedSecret#rotator_custom_cmd}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#tags RotatedSecret#tags}
        :param user_attribute: LDAP User Attribute. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#user_attribute RotatedSecret#user_attribute}
        :param user_dn: Base DN to Perform User Search. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#user_dn RotatedSecret#user_dn}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RotatedSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#import import section} in the documentation of this resource for the id to use
...
class RotatedSecretConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#name RotatedSecret#name}
        '''
    ...
    def rotator_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotator_type RotatedSecret#rotator_type}
        '''
    ...
    def target_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#target_name RotatedSecret#target_name}
        '''
    ...
    def api_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#api_id RotatedSecret#api_id}
        '''
    ...
    def api_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#api_key RotatedSecret#api_key}
        '''
    ...
    def authentication_credentials(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#authentication_credentials RotatedSecret#authentication_credentials}
        '''
    ...
    def auto_rotate(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#auto_rotate RotatedSecret#auto_rotate}
        '''
    ...
    def custom_payload(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#custom_payload RotatedSecret#custom_payload}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#description RotatedSecret#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#id RotatedSecret#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#key RotatedSecret#key}
        '''
    ...
    def rotated_password(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotated_password RotatedSecret#rotated_password}
        '''
    ...
    def rotated_username(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotated_username RotatedSecret#rotated_username}
        '''
    ...
    def rotation_hour(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotation_hour RotatedSecret#rotation_hour}
        '''
    ...
    def rotation_interval(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotation_interval RotatedSecret#rotation_interval}
        '''
    ...
    def rotator_custom_cmd(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#rotator_custom_cmd RotatedSecret#rotator_custom_cmd}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#tags RotatedSecret#tags}
        '''
    ...
    def user_attribute(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#user_attribute RotatedSecret#user_attribute}
        '''
    ...
    def user_dn(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/rotated_secret#user_dn RotatedSecret#user_dn}
        '''
