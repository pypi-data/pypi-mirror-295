...
Refer to the Terraform Registry for docs: [`akeyless_dynamic_secret_github`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github).
'''
import abc
import builtins
import datetime
...
class DynamicSecretGithub(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github akeyless_dynamic_secret_github}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github akeyless_dynamic_secret_github} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Dynamic secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#name DynamicSecretGithub#name}
        :param github_app_id: Github application id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_app_id DynamicSecretGithub#github_app_id}
        :param github_app_private_key: Github application private key (base64 encoded key). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_app_private_key DynamicSecretGithub#github_app_private_key}
        :param github_base_url: Github base url. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_base_url DynamicSecretGithub#github_base_url}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#id DynamicSecretGithub#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param installation_id: Github application installation id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_id DynamicSecretGithub#installation_id}
        :param installation_organization: Instead of installation id, set a GitHub organization name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_organization DynamicSecretGithub#installation_organization}
        :param installation_repository: Instead of installation id, set a GitHub repository '/'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_repository DynamicSecretGithub#installation_repository}
        :param target_name: Name of existing target to use in dynamic secret creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#target_name DynamicSecretGithub#target_name}
        :param token_permissions: Tokens' allowed permissions. By default use installation allowed permissions. Input format: key=value pairs or JSON strings, e.g - -p contents=read -p issues=write or -p '{content:read}' Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#token_permissions DynamicSecretGithub#token_permissions}
        :param token_repositories: Tokens' allowed repositories. By default use installation allowed repositories. To specify multiple repositories use argument multiple times: -r RepoName1 -r RepoName2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#token_repositories DynamicSecretGithub#token_repositories}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DynamicSecretGithub that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#import import section} in the documentation of this resource for the id to use
...
class DynamicSecretGithubConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#name DynamicSecretGithub#name}
        '''
    ...
    def github_app_id(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_app_id DynamicSecretGithub#github_app_id}
        '''
    ...
    def github_app_private_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_app_private_key DynamicSecretGithub#github_app_private_key}
        '''
    ...
    def github_base_url(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#github_base_url DynamicSecretGithub#github_base_url}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#id DynamicSecretGithub#id}.
    ...
    def installation_id(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_id DynamicSecretGithub#installation_id}
        '''
    ...
    def installation_organization(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_organization DynamicSecretGithub#installation_organization}
        '''
    ...
    def installation_repository(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#installation_repository DynamicSecretGithub#installation_repository}
        '''
    ...
    def target_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#target_name DynamicSecretGithub#target_name}
        '''
    ...
    def token_permissions(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#token_permissions DynamicSecretGithub#token_permissions}
        '''
    ...
    def token_repositories(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.3/docs/resources/dynamic_secret_github#token_repositories DynamicSecretGithub#token_repositories}
        '''
