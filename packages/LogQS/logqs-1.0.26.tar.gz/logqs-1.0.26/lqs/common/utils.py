...
def get_record_image_ros(record_data, renormalize=True) -> ImagePIL.Image:
    ...
    if record_image_format is None:
        ...
        if encoding in ["mono16", "16UC1", "32FC1"] and renormalize:
            ...
            if encoding == "mono16" and pixel_max <= 4096:
                # TODO: This is a hack to handle the case where the image is a depth image
                # Disparity images should only have a max value up to 4096
                pixels = pixels / 16
            else:
