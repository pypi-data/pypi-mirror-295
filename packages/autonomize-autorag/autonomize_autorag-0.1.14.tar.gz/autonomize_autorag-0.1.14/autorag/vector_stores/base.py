...
class VectorStore(ABC):
    ...
    def query(
        ...
        **kwargs: Any,
        ...
        Returns:
            List[Dict[str, Any]]: A list of dictionaries containing the embeddings and their corresponding metadatas.
    ...
    def _validate_embeddings_and_metadata(
        ...
        Raises:
            ValueError: If the number of embeddings and metadatas do not match.
        """
