...
class PromptTemplate(OptionalNotNullableModel):
    ...
    system: PromptTextSnippet = Field(description='System part of the prompt')
    ...
    question: PromptSection = Field(description='Prompt template for the user question')
    seperator: str = '\n\n'
...
def prompt_template_from_json(path_prompt_template: Path) -> PromptTemplate:
    with open(path_prompt_template, 'r') as fp:
