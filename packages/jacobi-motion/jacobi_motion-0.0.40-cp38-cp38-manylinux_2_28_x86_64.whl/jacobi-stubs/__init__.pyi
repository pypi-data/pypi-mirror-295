...
class PathType:
    ...
    of paths. It includes methods for calculating the path waypoints,
    converting the path data to/from JSON, and utility functions for
    geometric calculations.
    """
    def calculate_path(self, velocity: float, delta_time: float) -> list[Frame]:
        """
        Calculate the path waypoints based on velocity and delta time.
...
class Planner:
    ...
    def set_seed(self, seed: int | None) -> None:
        ...
        """
    def transfer_trajectory(self, trajectory: Trajectory, robot_from: RobotArm, robot_to: RobotArm, offset: Frame = ...) -> Trajectory | None:
        """
