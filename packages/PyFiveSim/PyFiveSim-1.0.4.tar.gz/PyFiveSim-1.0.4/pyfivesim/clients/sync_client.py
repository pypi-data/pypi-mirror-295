...
from ..enums.actions import OrderAction
...
class PyFiveSimSync(FiveSimBaseClient, HttpxRequestClient):
    def __init__(
        ...
        """
        Sync client for interact with 5sim API.
    ...
    @overload
    def get_prices(self, country: str) -> CountryWithProducts:
        ...

    @overload
    def get_prices(self, country: str, product: str) -> list[OperatorWithPrice]:
        ...

    @overload
    def get_prices(self, product: str) -> ProductWithCountries:
        ...

    @overload
    def get_prices(self) -> list[CountryWithProducts]:
        ...
    ...
    def action_with_order(
        ...
        if action == OrderAction.FINISH:
            current_order = self.get_order_info(order_id)
