...
# Create the workflow
youtube_workflow = (
    WorkflowBuilder("YouTube Comment Reply")
    .add_step(YouTubeStep("get_latest_comments", YouTubeMethods.GET_LATEST_COMMENTS, channel_id="UC1234567890", num_comments=5))
    .add_step(LLMStep("initialize_llm", LLMMethods.INITIALIZE, provider=LLMProvider.ANTHROPIC, model_name="claude-3-haiku-20240307"))
    .add_step(LoopStep("process_comments", "get_latest_comments", [
        LLMStep("generate_reply", LLMMethods.GENERATE_REPLY, llm="initialize_llm"),
        YouTubeStep("post_reply", YouTubeMethods.POST_REPLY, 
