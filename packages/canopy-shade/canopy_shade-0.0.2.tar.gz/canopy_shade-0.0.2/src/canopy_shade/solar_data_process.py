...
def calc_solar_irradiance_under_tree_map(df_solar, array_transmittance, sky_view_factor, azimuth_offset = 180, model = "tcm"):
    trans_w = len(array_transmittance[0])
    trans_h = len(array_transmittance)
...
def calc_walk_accumulated_ghi(walk_base_dir, map_base_dir, walk_id, time_start, walk_speed, interval_d, time_zone, azimuth_offset, model="tcm"):
...
def load_walk_accumulated_ghi(walk_base_dir, map_base_dir, walk_id, time_start, walk_speed, interval_d, time_zone, azimuth_offset, model="tcm"):
