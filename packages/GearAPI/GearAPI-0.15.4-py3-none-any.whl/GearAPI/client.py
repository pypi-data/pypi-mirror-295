...
class Client:
    ...
    def download(
        ...
        args:
            output_file_path - the path to the output dataframe. Save as .csv format.
        ...
        return:
            (Optional) pd.DataFrame - the dataframe of the downloaded data.
    ...
    def stream_data(self, device_params:dict, resource:str)->list:
