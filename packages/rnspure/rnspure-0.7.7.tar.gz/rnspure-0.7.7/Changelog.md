...
This release adds support for automatic encryption key ratcheting for all packets, not just those sent over established Reticulum links. In practical terms, this adds forward secrecy to packets sent with the `Packet` API.
