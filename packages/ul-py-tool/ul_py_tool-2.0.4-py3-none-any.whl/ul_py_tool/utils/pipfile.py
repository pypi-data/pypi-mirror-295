...
class Pipfile:
    ...
    @cached_property
    def python_version(self) -> Optional[SemVer]:
...
name = "nero_gitlab"
verify_ssl = false
url = "https://__token__:xYT1Nay1U6JNa9vKceun@gitlab.neroelectronics.by/api/v4/projects/996/packages/pypi/simple"
