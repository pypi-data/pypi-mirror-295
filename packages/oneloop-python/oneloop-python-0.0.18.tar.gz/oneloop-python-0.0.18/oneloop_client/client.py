...
from .types.create_customer_billing_response import CreateCustomerBillingResponse
...
from .types.get_customer_billing_response import GetCustomerBillingResponse
from .types.refill_customer_billing_response import RefillCustomerBillingResponse
...
class Oneloop:
    ...
    def generate_link_token(
        self, *, customer_id: str, workspace_id: str, request_options: typing.Optional[RequestOptions] = None
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            if request_options is None or request_options.get("additional_body_parameters") is None
                ...
                **jsonable_encoder({"customerId": customer_id, "workspaceId": workspace_id}),
                **(jsonable_encoder(remove_none_from_dict(request_options.get("additional_body_parameters", {})))),
            },
            headers=jsonable_encoder(
                remove_none_from_dict(
    ...
    def get_customer_billing(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetCustomerBillingResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
    ...
    def create_customer_billing(
        self,
        *,
        enable_free_limit: bool,
        free_limit: int,
        block_after_free_limit_usage: bool,
        external_meter_id: str,
        workspace_id: str,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        client.create_customer_billing(
            enable_free_limit=True,
            free_limit=1,
            block_after_free_limit_usage=True,
            external_meter_id="externalMeterId",
            workspace_id="workspaceId",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=jsonable_encoder(
                {
                    "enableFreeLimit": enable_free_limit,
                    "freeLimit": free_limit,
                    "blockAfterFreeLimitUsage": block_after_free_limit_usage,
                    "externalMeterId": external_meter_id,
                    "workspaceId": workspace_id,
                }
            )
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CreateCustomerBillingResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
    ...
    def refill_billing_limit(
        ...
        *,
        workspace_id: str,
        external_meter_id: str,
        free_limit: typing.Optional[int] = OMIT,
        enable_free_limit: typing.Optional[bool] = OMIT,
        block_after_free_limit_usage: typing.Optional[bool] = OMIT,
        refill_used_limit: typing.Optional[int] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        Parameters:
            ...
            - free_limit: typing.Optional[int].

            - enable_free_limit: typing.Optional[bool].

            - block_after_free_limit_usage: typing.Optional[bool].

            - refill_used_limit: typing.Optional[int].
        ...
        if free_limit is not OMIT:
            _request["freeLimit"] = free_limit
        if enable_free_limit is not OMIT:
            _request["enableFreeLimit"] = enable_free_limit
        if block_after_free_limit_usage is not OMIT:
            _request["blockAfterFreeLimitUsage"] = block_after_free_limit_usage
        if refill_used_limit is not OMIT:
            _request["refillUsedLimit"] = refill_used_limit
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"api/v1/customer-billing/{id}/refill"),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
            json=jsonable_encoder(_request)
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(RefillCustomerBillingResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(ErrorResponse, _response.json()))  # type: ignore
