...
def ipfmc_discretize(datasets, pathwayinfo, k=5, fusetime=6, proportion=0.6, snfk=15, seed=None, mirtarinfo=1,
    ...
    def calgeneral(dataset, pathways, k, fusetime, proportion, seed, preselect, km_iter, km_init):
        BP_data = pathways
        Omic_data = dataset
    ...
    for i in range(Dataset_Len - 1):
        ...
        represent, pathways = calgeneral(Omic_data, pathwayinfo, k, fusetime, proportion, seed, preselect, km_iter,
                                         km_init)
        Rept_list.append(represent)
        Pathways_list.append(pathways)
    if mirna:
        print(f'Calculating last dataset.')
        represent, pathways = calgeneral(datasets[Dataset_Len - 1], mirtarinfo, k, fusetime, proportion, seed)
        Rept_list.append(represent)
        Pathways_list.append(pathways)
    else:
        print(f'Calculating last dataset.')
        represent, pathways = calgeneral(datasets[Dataset_Len - 1], pathwayinfo, k, fusetime, proportion, seed)
        Rept_list.append(represent)
        Pathways_list.append(pathways)
