...
class DataMatrixEncodeMode(Enum):
      """!
       ...
       #Auto mode
		...
		generator = Generation.BarcodeGenerator(Generation.EncodeTypes.DATA_MATRIX, encodedArr)
		generator.getParameters().getBarcode().getDataMatrix().setDataMatrixEncodeMode(Generation.DataMatrixEncodeMode.BINARY)
		generator.save(self.image_path_to_save5, Generation.BarCodeImageFormat.PNG)
		# Extended codetext mode
		# create codetext
		codetextBuilder = Generation.DataMatrixExtCodetextBuilder()
...
class DotCodeEncodeMode(Enum):
      ...
      \code
              ...
              for bval in encodedArr:
                  codetext += bval
              generator = BarcodeGenerator(EncodeTypes.DOT_CODE, None)
