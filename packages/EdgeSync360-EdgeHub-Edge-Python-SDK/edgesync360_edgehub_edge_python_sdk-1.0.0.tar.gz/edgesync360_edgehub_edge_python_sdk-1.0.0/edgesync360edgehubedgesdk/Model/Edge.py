...
class BlockConfig():
  def __init__(self, blockType: str, analogTagList: list[AnalogTagConfig], discreteTagList: list[DiscreteTagConfig], textTagList: list[TextTagConfig]):
