...
def main():
    ...
    while True:
        ...
        if 'predict' in user_input:
            current_price, predicted_price_1h_ahead = make_prediction_and_suggest_stop_loss()
            if current_price and predicted_price_1h_ahead:
                print(f"Lucy: ETH is valued at ${round(current_price, 2)} right now. In one hour, my prediction says it will be \033[92m${round(predicted_price_1h_ahead, 2)}\033[0m.")
        ...
        elif user_input in ['hello', 'yo', 'hi']:
