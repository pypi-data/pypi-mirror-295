...
# %% auto 0
__all__ = ['get_device', 'show_image', 'subplots', 'get_grid', 'show_images', 'init_ddpm', 'load_image', 'image_grid',
           'plot_scheduler', 'plot_noise_and_denoise', 'spectrogram_from_image', 'waveform_from_spectrogram',
           'wav_bytes_from_spectrogram_image', 'measure_latency_and_memory_use', 'generate_long_audio',
           'get_speaker_embeddings', 'SampleURL']
...
# %% ../nbs/99_core.ipynb 17
import numpy as np
from datasets import load_dataset


def generate_long_audio():
    """Generates a long audio by concatenating the audio samples from the first 60 seconds of the LibriSpeech 100h dataset."""
    ds = load_dataset(
        "librispeech_asr",
    ...
    target_length_in_samples = 1 * 60 * 16000
    long_audio = []
    for sample in ds:
        long_audio.extend(sample["audio"]["array"])
        if len(long_audio) > target_length_in_samples:
            break
    return np.asarray(long_audio)

# %% ../nbs/99_core.ipynb 18
def get_speaker_embeddings(id=7440):
    """Returns a speaker embedding from the CMU Arctic dataset."""
    embeddings_dataset = load_dataset(
        "Matthijs/cmu-arctic-xvectors", split="validation"
    )
    return embeddings_dataset[id]["xvector"]

# %% ../nbs/99_core.ipynb 19
class SampleURL:
    ToyAstronauts = "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/img2img-sdxl-init.png"
    DogBenchImage = "https://raw.githubusercontent.com/CompVis/latent-diffusion/main/data/inpainting_examples/overture-creations-5sI6fQgYIuo.png"
    DogBenchMask = "https://raw.githubusercontent.com/CompVis/latent-diffusion/main/data/inpainting_examples/overture-creations-5sI6fQgYIuo_mask.png"
    ManInGlasses = "https://huggingface.co/datasets/multimodalart/genai-book-images/resolve/main/man_with_glasses.png"
    Mountain = "https://huggingface.co/datasets/multimodalart/genai-book-images/resolve/main/mountain.png"
    WomanSpeaking = "https://huggingface.co/datasets/multimodalart/genai-book-images/resolve/main/woman_speaking.png"
    ItemsVariation = "https://huggingface.co/datasets/multimodalart/genai-book-images/resolve/main/items_variation.png"
    Mamoeiro = "https://huggingface.co/datasets/multimodalart/genai-book-images/resolve/main/mamoeiro.jpeg"
    CatExample = "https://huggingface.co/datasets/huggingfacejs/tasks/resolve/main/zero-shot-image-classification/image-classification-input.jpeg"
    LionExample = (
        "https://cdn.pixabay.com/photo/2014/12/12/19/45/lion-565820_1280.jpg"
    )
    LlamaExample = "https://huggingface.co/datasets/genaibook/images/resolve/main/llama.jpeg"
