...
from coreplatpy.storage import get_list, get_form, post_dataset, get_status, get_available
...
class Copernicus:
    ...
    @ensure_token
    def check_request_status(self, service: str, task_id:str) -> Union[CopernicusTask, None]:
        complete_task = get_status(self.api_url, service, task_id, self.api_key)
